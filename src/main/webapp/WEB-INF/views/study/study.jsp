                    ...
                    <div class="job-filter-container">
                        ...
                        <div class="job-filter-search">
                            <div class="study_email_deadline">
                                <input type="search" name="query" id="search-field" class="styling2"
                                       placeholder="검색어" value=""/>
                                <input type="button" onclick="sortSubmit()" value="go"class="styling2">
                            </div>
                        </div>
                    </div>
                    <!---->
                ...
                <div class="avatar clearfix avatar-list ">
                    ...
                    <div class="avatar-info">
                        ...
                        <div class="date-created"><span class="timeago"
                                                        title="2021-09-27T21:13:36">${board.writedate}</span></div>
                    </div>
                </div>
            </div>
        </li>
