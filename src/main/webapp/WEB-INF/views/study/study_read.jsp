                  ...
                  <div class="panel panel-default clearfix fa-">
                        <div class="panel-heading clearfix">
                              ...
                              <div class="content-identity pull-right">
                                    <div class="content-identity-count">
                                          <i class="fa fa-comment"></i>${requestScope.replyCount}</div>
                        ...
                        <div class="content-container clearfix">
                              ...
                              <div class="content-function-cog share-btn-wrapper">
                                    ...
                                    <a href="javascript:void(0)" data-placement="bottom" id="boardsetting" data-html="true" data-toggle="popover" data-container="body" type="button">
                                          <i class="fa fa-cog" title="게시물 설정"></i>
                                    </a>
                                    
                                    <%--팝오버창--%>
                                    <div id="popover-content3" class="hide" role="tooltip">
                                          <div class="arrow" style="right: 50%"></div>
                                          <h3 class="popover-title">설정</h3>
                                          <div class="popover-footer clearfix" id="user-func-popover">
                                                <a href="StudyEdit.so?no=${sb.no}" class="popover-btn"><i class="fa fa-edit fa-fw"></i> 수정</a>
                                                <a href="StudyDelete.so?no=${sb.no}" class="popover-btn"><i class="fa fa-trash-o fa-fw"></i> 정보수정</a>
                                          </div>
                                    </div>
                              </div>
                        </div>
                  ...
                  <div class="panel panel-default clearfix">
                        ...
                        <ul class="list-group">
                              <li id="note-title" class="list-group-item note-title">
                                    <h3 class="panel-title">답변 <span id="note-count">${requestScope.replyCount}</span>
                                    </h3>
                              </li>
                                          ...
                                          <div class="content-function pull-right text-center">
                                                <div class="content-function-group">
                                                      <div class="note-evaluate-wrapper">
                                                            <!--옆칸에 톱니바퀴-->
                                                            <a href="#" data-placement="bottom" id="boardsetting" data-html="true" data-toggle="popover" data-container="body" type="button">
                                                                  <i class="fa fa-cog" title="게시물 설정"></i>
                                                            </a>
                                                            ...
                                                            <div id="popover-content3" class="hide" role="tooltip">
                                                                  ...
                                                                  <h3 class="popover-title">설정</h3>
                                                                  <div class="popover-footer clearfix" id="user-func-popover">
                                                                        <a href="StudyEdit.so?no=${sb.no}" class="edit"><i
                                                                                class="fa fa-edit fa-fw"></i> 수정
                                                                        </a>
                                                                        <a href="StudyDelete.so?no=${sb.no}"
                                                                           id="reply-delete-btn"><i
                                                                                class="fa fa-trash-o fa-fw"></i> 삭제
                                                                        </a>
                                                                  </div>
                                                            </div>
                                                            <!--톱니바퀴 끝---------------------------->
                              ...
                              <li class="list-group-item note-form clearfix">
                                    <form action="" onsubmit="replyAdd();" method="post" class="note-create-form">
                                          ...
                                          <div class="content-function-cog note-submit-buttons clearfix">
                                                <p>
                                                      <a href="#" id="note-create-cancel-btn" class="btn btn-default btn-wide"
                                                      >취소</a></p>
...
<script>
                    ...
                    if (data.length == 0) {
                         ...
                         $.each(data, function(index, obj) {
                              $('#replylist').append(
                                   ...
                                   <a href="javascript:void(0)" data-placement="left" id="replySetting" data-html="true" data-toggle="popover" data-container="body" type="button">
                                   <i class="fa fa-cog" title="게시물 설정"></i>
                                   </a>
                                   
                                   <div id="popover-content4" class="hide" role="tooltip">
                                   <div class="arrow" style="right: 50%"></div>
                                   <h3 class="popover-title">설정</h3>
                                   <div class="popover-footer clearfix" id="user-func-popover">
                                   <a href="javascript:replyUpdate(` + obj.rno +
                                   `)" class="popover-btn"><i class="fa fa-edit fa-fw"></i> 수정</a>
                                   <a href="javascript:replyDelete(` + obj.rno +
                                   `)" class="popover-btn"><i class="fa fa-trash-o fa-fw"></i> 삭제</a>
                                   </div>
                                   </div>
                                   </div>
                                   </div>
     ...
     $('#boardsetting').popover({
          html: true,
          content: function() {
               return $('#popover-content3').html();
          },
     });
     $('#replySetting').click(function(event) {
          if ($(event.target.next()).attr("class") == "hide") {
               $(event.target.next()).removeClass();
          } else {
               $(event.target.next()).attr("class", "hide");
          }
     });
          // html: true,
          // content: function() {
