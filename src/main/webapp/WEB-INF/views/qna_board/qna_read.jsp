                                          ...
                                          <form action="${pageContext.request.contextPath}/QnAContent.qo" method="post"
                                                ...
                                                <div class="dropdown">
                                                      ...
                                                      <ul class="dropdown-menu" role="menu">
                                                            <li>
                                                                  <a href="${pageContext.request.contextPath}/QnAEdit.qo?no=${no}&cp=${cpage}&ps=${pagesize}" class="edit"><i
                                          ...
                                          <div class="content-body panel-body pull-left">
                                                ...
                                                <div class="avatar clearfix avatar-medium ">
                                                      ...
                                                      <div class="avatar-info">
                                                            ...
                                                            <div class="activity"><span class="fa fa-flash"></span> 28
                                                            </div>
                                                                  <%--활동점수--%>
                                                      ...
                                                      <c:choose>
                                                            <c:when test="${sessionScope.id != null}">
                                                                  ...
                                                                  <ul class="dropdown-menu" role="menu">
                                                                        ...
                                                                        <li onclick="deleteReply('${replyList.rno}')">
                                    ...
                                    <form action="/QnAReplyOk.qo" method="post" class="note-create-form">
                                          ...
                                          <div class="content-function-cog note-submit-buttons clearfix">
                                                <c:choose>
                                                      <c:when test="${sessionScope.id !=null}">
                                                            <p>
                                                                  <a href="javascript://" id="note-create-cancel-btn" class="btn btn-default btn-wide">취소</a>
                                                            </p>
          ...
          $.ajax({
               ...
               success: function(result) {
                    ...
                    for (let reply of result) {
                         ...
                         html += '<a class="nickname" href="/memberDetailGo.do" title="aa" data-value="' + reply.no +
                              '">' + reply.id + '</a>';
                         html += '<div class="activity"><span class="fa fa-flash"></span> 28</div>';
                         html += '<div class="date-created"><span class="timeago" title="asdsa">' + reply.date +
                              '</span>';
                         html += '</div>';
                         html += '</div>';
                         html += '</div>';
