...
<div id="article-create" class="content" role="main">
    ...
    <div class="panel panel-default clearfix">
        ...
        <div class="panel-body">
            <form action="${pageContext.request.contextPath}/QnAWriteOK.qo" method="post" id="article-form" class="article-form" role="form"
                ...
                <fieldset class="form">
                    ...
                    <div class="nav" role="navigation">
                        <fieldset class="buttons">
                            <a href="/QnAList.qo" class="btn btn-default btn-wide"
