	...
	<div class="nav-user nav-sidebar">
		...
		<c:if test="${not empty sessionScope.id}">
			...
			<ul class="list-unstyled">
				<li>
					<a data-placement="bottom" data-toggle="popover" data-container="body" data-placement="left"
					   type="button" data-html="true" href="#" id="setting"><i class="fas fa-cog"
					                                                           style="margin-top: 7px"></i></a>
				</li>
				<li>
					<a data-placement="bottom" data-toggle="popover" data-container="body" data-placement="left"
					   type="button" data-html="true" href="#" id="notification"><i class="fas fa-bell"
					                                                                style="margin-top: 7px"></i></a>
				</li>
					<%--팝오버 창 start--%>
				<div id="popover-content" class="hide" role="tooltip">
					...
					<div class="popover-footer clearfix" id="user-func-popover">
						<label href="logout.do" for="logoutButton" class="popover-btn"><i class="fa fa-sign-out"></i>
							로그아웃</label>
