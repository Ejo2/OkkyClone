...
(function (a, q) {
  ...
  function c(d, a, n) {
    ...
    if ("string" === typeof a) {
      if (Va.test(a)) return f.filter(a, d, n);
      a = f.filter(a, d);
    }
    return f.grep(d, function (d) {
  ...
  function t(d) {
    for (var a in d)
      if (("data" !== a || !f.isEmptyObject(d[a])) && "toJSON" !== a) return !1;
    return !0;
  }
  function k(d, a, n, B) {
    if (f.acceptData(d)) {
    ...
    if (f.acceptData(d)) {
      ...
      if (h[e]) {
        if (a && (B = n ? h[e] : h[e].data)) {
          ...
          for (b = a.length; b--; ) delete B[a[b]];
          if (n ? !t(B) : !f.isEmptyObject(B)) return;
        }
        if (!n && (delete h[e].data, !t(h[e]))) return;
        c
          ? f.cleanData([d], !0)
    ...
    if (1 === a.nodeType && f.hasData(d)) {
      ...
      if (h)
        for (n in (delete c.handle, (c.events = {}), h))
          for (B = 0, b = h[n].length; B < b; B++) f.event.add(a, n, h[n][B]);
  ...
  function x(d, a, n) {
    var b,
      ...
      m = e.promise({
        ...
        stop: function (a) {
          ...
          if (b) return this;
          for (b = !0; f < G; f++) m.tweens[f].run(1);
    ...
    for (P(n, m.opts.specialEasing); c < h; c++)
      if ((a = Ma[c].call(m, d, n, m.opts))) return a;
    f.map(n, U, m);
  ...
  function S(d, a) {
    ...
    for (b in a) void 0 !== a[b] && ((c[b] ? d : n || (n = {}))[b] = a[b]);
    n && f.extend(!0, d, n);
    return d;
  }
  function ea(d, a, n, b) {
    ...
    else if (n || "object" !== f.type(a)) b(d, a);
    else for (c in a) ea(d + "[" + c + "]", a[c], n, b);
  }
  function fa() {
    try {
  ...
  f.extend({
    ...
    isPlainObject: function (d) {
      ...
      if (u.ownLast) for (a in d) return I.call(d, a);
      for (a in d);
    ...
    each: function (d, a, f) {
      ...
      b = r(d);
      if (f)
        if (b) for (; c < h && ((b = a.apply(d[c], f)), !1 !== b); c++);
        else
          for (c in d) {
            if (((b = a.apply(d[c], f)), !1 === b)) break;
          }
      else if (b) for (; c < h && ((b = a.call(d[c], c, d[c])), !1 !== b); c++);
      else for (c in d) if (((b = a.call(d[c], c, d[c])), !1 === b)) break;
      return d;
    },
    trim: function (d) {
    ...
    inArray: function (d, a, f) {
      var b;
      if (a) {
        if (Da) return Da.call(a, d, f);
        b = a.length;
        for (f = f ? (0 > f ? Math.max(0, b + f) : f) : 0; f < b; f++)
          if (f in a && a[f] === d) return f;
      }
      return -1;
    },
    merge: function (d, a) {
      for (var f = +a.length, b = 0, c = d.length; b < f; ) d[c++] = a[b++];
      if (f !== f) for (; void 0 !== a[b]; ) d[c++] = a[b++];
      d.length = c;
      return d;
    },
    grep: function (d, a, f) {
    ...
    map: function (d, a, f) {
      var b,
        ...
        h = d.length,
        e = [];
      if (r(d)) for (; c < h; c++) (b = a(d[c], c, f)), null != b && e.push(b);
      else for (c in d) (b = a(d[c], c, f)), null != b && e.push(b);
      return ca.apply([], e);
    },
    guid: 1,
    proxy: function (d, a) {
  ...
  var na = (function (d) {
    function a(d, f, n, b) {
      ...
      f = f || H;
      n = n || [];
      if (!d || "string" !== typeof d) return n;
      if (1 !== (e = f.nodeType) && 9 !== e) return [];
      if (ka && !b) {
        if ((G = Ka.exec(d)))
          if ((h = G[1]))
            if (9 === e)
              if ((c = f.getElementById(h)) && c.parentNode) {
                if (c.id === h) return n.push(c), n;
              } else return n;
            else {
              if (
                f.ownerDocument &&
            ...
            if (G[2]) return ra.apply(n, f.getElementsByTagName(d)), n;
            if (
              (h = G[3]) &&
    ...
    function h(d, a) {
      for (var f = d.split("|"), n = d.length; n--; ) t.attrHandle[f[n]] = a;
    }
    function e(d, a) {
      var f = a && d,
        n =
    ...
    function l() {}
    function u(d) {
      for (var a = 0, f = d.length, n = ""; a < f; a++) n += d[a].value;
      return n;
    }
    function x(d, a, f) {
      var n = a.dir,
      ...
      return a.first
        ? function (a, f, G) {
            for (; (a = a[n]); ) if (1 === a.nodeType || b) return d(a, f, G);
          }
        : function (a, f, c) {
            var h,
              e,
            ...
            if (c)
              for (; (a = a[n]); ) {
                if ((1 === a.nodeType || b) && d(a, f, c)) return !0;
              }
            else
              for (; (a = a[n]); )
                if (1 === a.nodeType || b) {
    ...
    function w(d) {
      return 1 < d.length
        ? function (a, f, n) {
            for (var b = d.length; b--; ) if (!d[b](a, f, n)) return !1;
            return !0;
          }
        : d[0];
    }
    function p(d, a, f, n, b) {
      for (var G, c = [], h = 0, e = d.length, m = null != a; h < e; h++)
        if ((G = d[h])) if (!f || f(G, n, b)) c.push(G), m && a.push(h);
      return c;
    }
      ...
      return b(function (b, e, m, B) {
        ...
        if (c)
          for (g = p(u, l), c(g, [], m, B), m = g.length; m--; )
            if ((k = g[m])) u[l[m]] = !(ga[l[m]] = k);
        if (b) {
          if (h || d) {
            if (h) {
              g = [];
              for (m = u.length; m--; ) (k = u[m]) && g.push((ga[m] = k));
              h(null, (u = []), g, B);
            }
            for (m = u.length; m--; )
              (k = u[m]) &&
        ...
        } else (u = p(u === e ? u.splice(ta, u.length) : u)), h ? h(null, e, u, B) : ra.apply(e, u);
      });
    }
    function X(d) {
      var a,
      ...
      for (
        ...
        if ((f = t.relative[d[c].type])) m = [x(w(m), f)];
        else {
    ...
    function W(d, f) {
      var n = 0 < f.length,
        ...
        h = function (b, h, e, m, B) {
          ...
          u += l;
          if (n && l !== u) {
            for (k = 0; (y = f[k++]); ) y(ta, ga, h, e);
            if (b) {
              if (0 < u) for (; l--; ) ta[l] || ga[l] || (ga[l] = Ya.call(m));
              ga = p(ga);
            }
            ra.apply(m, ga);
    ...
    r = a.setDocument = function (d) {
      ...
      t.find.TAG = S.getElementsByTagName
        ...
        : function (d, a) {
            ...
            if ("*" === d) {
              for (; (f = G[b++]); ) 1 === f.nodeType && n.push(f);
              return n;
            }
            return G;
          };
        ...
        : function (d, f) {
            ...
            if (!n || !G)
              return d === a
                ...
                : 0;
            if (n === G) return e(d, f);
            for (n = d; (n = n.parentNode); ) c.unshift(n);
            for (n = f; (n = n.parentNode); ) h.unshift(n);
            for (; c[b] === h[b]; ) b++;
    ...
    a.uniqueSort = function (d) {
      ...
      d.sort(Da);
      if (q) {
        for (; (a = d[b++]); ) a === d[b] && (n = f.push(b));
        for (; n--; ) d.splice(f[n], 1);
      }
      P = null;
      return d;
    };
    ea = a.getText = function (d) {
      var a,
        ...
        n = 0;
      a = d.nodeType;
      if (!a) for (; (a = d[n++]); ) f += ea(a);
      else if (1 === a || 9 === a || 11 === a) {
        if ("string" === typeof d.textContent) return d.textContent;
        for (d = d.firstChild; d; d = d.nextSibling) f += ea(d);
    ...
    t = a.selectors = {
      ...
      preFilter: {
        ...
        PSEUDO: function (d) {
          var a,
            f = !d[6] && d[2];
          if (na.CHILD.test(d[0])) return null;
          d[3]
            ? (d[2] = d[4] || d[5] || "")
            : f &&
              Fa.test(f) &&
      ...
      pseudos: {
        ...
        even: k(function (d, a) {
          for (var f = 0; f < a; f += 2) d.push(f);
          return d;
        }),
        odd: k(function (d, a) {
          for (var f = 1; f < a; f += 2) d.push(f);
          return d;
        }),
        lt: k(function (d, a, f) {
          for (a = 0 > f ? f + a : f; 0 <= --a; ) d.push(a);
          return d;
        }),
        gt: k(function (d, a, f) {
          for (f = 0 > f ? f + a : f; ++f < a; ) d.push(f);
          return d;
        }),
      },
    };
    ...
    for (Q in { radio: !0, checkbox: !0, file: !0, password: !0, image: !0 })
      t.pseudos[Q] = m(Q);
    for (Q in { submit: !0, reset: !0 }) t.pseudos[Q] = g(Q);
    l.prototype = t.filters = t.pseudos;
    t.setFilters = new l();
    D = a.tokenize = function (d, f) {
      var n, b, c, h, e, m, B;
      if ((e = M[d + " "])) return f ? 0 : e.slice(0);
      e = d;
      m = [];
      for (B = t.preFilter; e; ) {
        if (!n || (b = Xa.exec(e)))
    ...
    fa = a.compile = function (d, a) {
      ...
      if (!c) {
        a || (a = D(d));
        for (f = a.length; f--; ) (c = X(a[f])), c[ba] ? n.push(c) : b.push(c);
        c = A(d, W(b, n));
        c.selector = d;
      }
      return c;
    ...
    c(function (d) {
      ...
      h("type|href|height|width", function (d, a, f) {
        if (!f) return d.getAttribute(a, "type" === a.toLowerCase() ? 1 : 2);
      });
    (S.attributes &&
      c(function (d) {
        d.innerHTML = "<input/>";
      ...
      h("value", function (d, a, f) {
        if (!f && "input" === d.nodeName.toLowerCase()) return d.defaultValue;
      });
    c(function (d) {
  ...
  f.fn.extend({
    find: function (d) {
      ...
      if ("string" !== typeof d)
        return this.pushStack(
          f(d).filter(function () {
            for (a = 0; a < c; a++) if (f.contains(b[a], this)) return !0;
          })
        );
      for (a = 0; a < c; a++) f.find(d, b[a], n);
    ...
    is: function (d) {
      return !!c(this, "string" === typeof d && oa.test(d) ? f(d) : d || [], !1)
        .length;
    },
  });
  var pa,
    ...
    if ("string" === typeof d) {
      ...
      if (n[1]) {
        if (
          ...
          for (n in a)
            if (f.isFunction(this[n])) this[n](a[n]);
            else this.attr(n, a[n]);
      } else {
        if ((b = F.getElementById(n[2])) && b.parentNode) {
          if (b.id !== n[2]) return pa.find(d);
          this.length = 1;
          this[0] = b;
        }
        this.context = F;
  ...
  f.fn.extend({
    has: function (d) {
      ...
      return this.filter(function () {
        for (a = 0; a < b; a++) if (f.contains(this, n[a])) return !0;
      });
    },
  ...
  f.extend({
    ...
    ready: function (d) {
      if (!0 === d ? !--f.readyWait : !f.isReady) {
        if (!F.body) return setTimeout(f.ready);
        f.isReady = !0;
        (!0 !== d && 0 < --f.readyWait) ||
          (Pa.resolveWith(F, [f]),
          f.fn.triggerHandler &&
  ...
  var Qa = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
    ...
    sa = (f.access = function (d, a, b, c, h, e, m) {
      var g = 0,
        ...
        y = null == b;
      if ("object" === f.type(b))
        for (g in ((h = !0), b)) f.access(d, a, g, b[g], !0, e, m);
      else if (
        void 0 !== c &&
        ((h = !0),
        f.isFunction(c) || (m = !0),
        ...
        for (; g < k; g++) a(d[g], b, m ? c : c.call(d[g], g, a(d[g], b)));
  ...
  f.event = {
        ...
        for (y = a.length; y--; )
          if (
            ...
            k &&
              ...
              delete l[w]);
          } else for (w in l) f.event.remove(d, w + a[y], b, c, !0);
    ...
    trigger: function (d, b, n, c) {
      ...
      if (
        ...
        if (!c && !k.noBubble && !f.isWindow(n)) {
          ...
          for (; m; m = m.parentNode) l.push(m), (h = m);
          h === (n.ownerDocument || F) &&
    ...
    fix: function (d) {
      ...
      d = new f.Event(h);
      for (a = c.length; a--; ) (b = c[a]), (d[b] = h[b]);
  ...
  f.Event = function (d, a) {
    if (!(this instanceof f.Event)) return new f.Event(d, a);
    d && d.type
  ...
  f.fn.extend({
    on: function (d, a, b, c, h) {
      ...
      if ("object" === typeof d) {
        ...
        for (e in d) this.on(e, a, b, d[e], h);
        return this;
      }
      null == b && null == c
        ? ((c = a), (b = a = void 0))
    ...
    triggerHandler: function (d, a) {
      var b = this[0];
      if (b) return f.event.trigger(d, a, b, !0);
    },
  });
  var Ka =
          ...
          if (c[g]) {
            ...
            if (1 === l.nodeType) {
              ...
              if (!u.noCloneEvent && l[f.expando]) {
                I = f._data(l);
                for (w in I.events) f.removeEvent(l, w, I.handle);
      ...
      for (
        ...
        if ((g = d[p]) || 0 === g)
          if ("object" === f.type(g)) f.merge(X, g.nodeType ? [g] : g);
            ...
            k = I.lastChild;
          } else X.push(a.createTextNode(g));
      k && I.removeChild(k);
      ...
      for (p = 0; (g = X[p++]); )
        if (!c || -1 === f.inArray(g, c))
          if (
            ...
            for (e = 0; (g = k[e++]); ) nb.test(g.type || "") && b.push(g);
      return I;
    },
  ...
  f.swap = function (d, a, f, b) {
    var c,
      h = {};
    for (c in a) (h[c] = d.style[c]), (d.style[c] = a[c]);
    f = f.apply(d, b || []);
    for (c in a) d.style[c] = h[c];
    return f;
  };
  var ab = /alpha\([^)]*\)/i,
    Qb = /opacity\s*=\s*([^)]*)/,
    ...
    css: function (d, a) {
      return sa(
        ...
        function (d, a, b) {
          ...
          if (f.isArray(a)) {
            b = xa(d);
            for (c = a.length; e < c; e++) h[a[e]] = f.css(d, a[e], !1, b);
            return h;
          }
  ...
  K.propHooks = {
    _default: {
      ...
      set: function (d) {
        if (f.fx.step[d.prop]) f.fx.step[d.prop](d);
        else
          d.elem.style &&
      ...
      "*": [
        function (d, a) {
          ...
          if (m && m[3] !== e) {
            ...
            h = h || [];
            m = +c || 1;
            do (g = g || ".5"), (m /= g), f.style(b.elem, d, m + e);
  ...
  f.fn.extend({
    ...
    stop: function (d, a, b) {
      ...
      return this.each(function () {
        var a = !0,
          ...
          e = f.timers,
          m = f._data(this);
        if (h) m[h] && m[h].stop && c(m[h]);
        else for (h in m) m[h] && m[h].stop && Vb.test(h) && c(m[h]);
        for (h = e.length; h--; )
          e[h].elem !== this ||
            (null != d && e[h].queue !== d) ||
    ...
    finish: function (d) {
      ...
      return this.each(function () {
        ...
        for (a = 0; a < e; a++) c[a] && c[a].finish && c[a].finish.call(this);
        delete b.finish;
      });
    },
  });
      ...
      if (a && 3 !== m && 8 !== m && 2 !== m) {
        ...
        if (void 0 !== c)
          if (null === c) f.removeAttr(a, b);
            ...
            if (h && "set" in h && void 0 !== (e = h.set(a, c, b))) return e;
            a.setAttribute(b, c + "");
            return c;
          }
        else {
          if (h && "get" in h && null !== (e = h.get(a, b))) return e;
          e = f.find.attr(a, b);
  ...
  za ||
    ((Ga = {
      set: function (a, b, f) {
        ...
        c.value = b += "";
        if ("value" === f || b === a.getAttribute(f)) return b;
      },
    }),
    (va.id =
      va.name =
    ...
    (f.valHooks.button = {
      get: function (a, b) {
        ...
        if (f && f.specified) return f.value;
      },
      set: Ga.set,
    }),
  ...
  f.extend({
    ...
    ajax: function (a, b) {
        ...
        if (2 !== ea) {
          ...
          a: {
            ...
            var q,
              ...
              Z = b.dataTypes.slice();
            if (Z[1])
              for (H in b.converters) Q[H.toLowerCase()] = b.converters[H];
            for (P = Z.shift(); P; )
              if (
          ...
          else if (((n = x), a || !x)) (x = "error"), 0 > a && (a = 0);
          D.status = a;
          D.statusText = (d || x) + "";
      ...
      var h,
        ...
        D = {
          ...
          getResponseHeader: function (a) {
            ...
            if (2 === ea) {
              if (!x)
                for (x = {}; (d = ac.exec(g)); ) x[d[1].toLowerCase()] = d[2];
              d = x[a.toLowerCase()];
            }
          ...
          statusCode: function (a) {
            var d;
            if (a)
              if (2 > ea) for (d in a) S[d] = [S[d], a[d]];
      ...
      for (e in w.headers) D.setRequestHeader(e, w.headers[e]);
      if (w.beforeSend && (!1 === w.beforeSend.call(I, D, w) || 2 === ea))
        return D.abort();
      s = "abort";
      for (e in { success: 1, error: 1, complete: 1 }) D[e](w[e]);
      if ((u = y(Wa, w, b, D))) {
        D.readyState = 1;
      ...
      if (!a.crossDomain || u.cors) {
        ...
        return {
          send: function (c, h) {
            ...
            if (a.xhrFields) for (e in a.xhrFields) m[e] = a.xhrFields[e];
            a.mimeType && m.overrideMimeType && m.overrideMimeType(a.mimeType);
            a.crossDomain ||
              c["X-Requested-With"] ||
              (c["X-Requested-With"] = "XMLHttpRequest");
            for (e in c) void 0 !== c[e] && m.setRequestHeader(e, c[e] + "");
  ...
  f.fn.load = function (a, b, c) {
    ...
    0 < g.length &&
      f
        .ajax({ url: a, type: m, dataType: "html", data: b })
        .done(function (a) {
          e = arguments;
  ...
  f.each(["top", "left"], function (a, b) {
    f.cssHooks[b] = N(u.pixelPosition, function (a, d) {
      if (d) return (d = ya(a, b)), La.test(d) ? f(a).position()[b] + "px" : d;
    });
  });
...
+(function (a) {
  ...
  r.prototype.getState = function (a, c, g, l) {
    ...
    if (null != g && "top" == this.affixed) return p < g ? "top" : !1;
    ...
    if (this.$element.is(":visible")) {
      ...
      if (this.affixed != c) {
        ...
        this.$element
          .removeClass(r.RESET)
          .addClass(g)
          .trigger(g.replace("affix", "affixed") + ".bs.affix");
      }
...
+(function (a) {
  function q(b) {
    return this.each(function () {
      ...
      if ("number" == typeof b) l.to(b);
      else if (t) l[t]();
      else p.interval && l.pause().cycle();
    });
  }
  var r = function (b, c) {
    this.$element = a(b);
  ...
  var b = function (b) {
    ...
    if (p.hasClass("carousel")) {
      ...
      if ((l = l.attr("data-slide-to"))) c.interval = !1;
      q.call(p, c);
  ...
  c.prototype.show = function () {
    if (!this.transitioning && !this.$element.hasClass("in")) {
      ...
      if (!l.isDefaultPrevented()) {
        ...
        this.$element
          .one("bsTransitionEnd", a.proxy(b, this))
...
+(function (a) {
  function q(b, c) {
    return this.each(function () {
      ...
      if ("string" == typeof b) l[b](c);
      else p.show && l.show(c);
    });
  }
  var r = function (b, c) {
    this.options = c;
...
+(function (a) {
  ...
  q.prototype.enter = function (c) {
    ...
    if (b && b.$tip && b.$tip.is(":visible")) b.hoverState = "in";
    else {
      b ||
...
+(function (a) {
  ...
  q.prototype.process = function () {
    ...
    if (a >= g) return t != (k = p[p.length - 1]) && this.activate(k);
    if (t && a < l[0]) return (this.activeTarget = null), this.clear();
    for (k = l.length; k--; )
      t != p[k] &&
        a >= l[k] &&
        (!l[k + 1] || a <= l[k + 1]) &&
...
+(function (a) {
  function q() {
    var a = document.createElement("bootstrap"),
      ...
      b;
    for (b in c) if (void 0 !== a.style[b]) return { end: c[b] };
    return !1;
  }
...
(function (a) {
  ...
  function g(b, c) {
    ...
    a.each(c, function (a, c) {
      if ("number" === typeof c && b.which === c) return (e = !0), !1;
      if (b.which === c.which) {
      ...
      if (
        ...
        if (!c.toString().match(/^\s*$/)) {
          ...
          if ("string" === typeof c && "INPUT" === this.$element[0].tagName) {
            var l = c.split(",");
            if (1 < l.length) {
              for (var p = 0; p < l.length; p++) this.add(l[p], !0);
              e || g.pushVal();
              return;
            }
          }
...
(function (a) {
  ...
  function e(b, c) {
    ...
    for (var q in g) c.test(q) && ((l = q.replace(p, e)), (k[l] = g[q]));
    return k;
  }
  function g(b) {
    var c = {};
    if (!C[b] && ((b = b.split("-")[0]), !C[b])) return;
    var e = C[b];
  ...
  p.prototype = {
    ...
    fill: function () {
      ...
      if (!isNaN(c) && !isNaN(e)) {
        this.picker
          .find(".datepicker-days .datepicker-switch")
          .text(z.formatDate(b, N, this.o.language));
        this.picker
          .find("tfoot .today")
          .text(t)
    ...
    moveMonth: function (a, b) {
      ...
      if (1 === k) {
        ...
        for (var p = 0; p < k; p++) c = this.moveMonth(c, b);
        l = c.getUTCMonth();
        c.setUTCDate(e);
        k = function () {
      ...
      for (; k(); ) c.setUTCDate(--e), c.setUTCMonth(l);
      return c;
    },
    ...
    showMode: function (a) {
      ...
      this.picker
        .children("div")
        .hide()
        .filter(".datepicker-" + z.modes[this.viewMode].clsName)
        .show();
      this.updateNavArrows();
    },
  };
  ...
  var k = a.fn.datepicker,
    s = function (b) {
      ...
      if (k === q || k instanceof p || k instanceof t) return this;
      if (1 < this.length)
        throw Error(
  ...
  var C = (a.fn.datepicker.dates = {
    ...
    z = {
      ...
      parseDate: function (b, e, g, k) {
        ...
        if (e.toValue) return e.toValue(b, e, g);
        var t = /([\-+]\d+)([dmwy])/,
          T = b.match(/([\-+]\d+)([dmwy])/g),
      ...
      formatDate: function (b, c, e) {
        ...
        if (c.toDisplay) return c.toDisplay(b, c, e);
        e = {
          d: b.getUTCDate(),
...
(function (a) {
  ...
  Array.prototype.reduce ||
    (Array.prototype.reduce = function (a) {
      ...
      for (; e < c; e++) e in b && (g = a(g, b[e], e, b));
      return g;
    });
  ...
  var g = {
    ...
    p = (function () {
      ...
      return {
        ...
        contains: e,
        all: function (a, b) {
          for (var c = 0, e = a.length; c < e; c++) if (!b(a[c])) return !1;
          return !0;
        },
        sum: function (a, b) {
          b = b || l.self;
        ...
        from: function (a) {
          for (var b = [], c = -1, e = a.length; ++c < e; ) b[c] = a[c];
          return b;
        },
    ...
    k = (function () {
      var b = function (b) {
        ...
        E = function (a, b) {
          for (; a && a !== b; ) {
            if (Y(a) !== v(a.parentNode) - 1) return !1;
            a = a.parentNode;
          }
          return !0;
        },
        ...
        da = function (a, b) {
          ...
          if (L(a) && (h(a.node) || f)) {
            if (N(a)) return a.node;
            if (M(a)) return a.node.nextSibling;
          }
          if (h(a.node)) return a.node.splitText(a.offset);
          ...
          if (a && a.parentNode) {
            ...
            if (!b) {
              var f = [],
                ...
                g;
              e = 0;
              for (g = a.childNodes.length; e < g; e++) f.push(a.childNodes[e]);
              e = 0;
              for (g = f.length; e < g; e++) c.insertBefore(f[e], a);
            }
            c.removeChild(a);
          }
        },
      ...
      return {
        ...
        isVisiblePoint: function (a) {
          if (h(a.node) || !K(a.node) || Q(a.node)) return !0;
    ...
    s = (function () {
      var b = function (a, b) {
          ...
          for (e = 0; e < l.length; e++)
            if (!k.isText(l[e])) {
              ...
              if (0 <= g.compareEndPoints("StartToStart", a)) break;
              h = l[e];
            }
          ...
          this.normalize = function () {
            var a = function (a, b) {
                ...
                if (
                  ...
                  if (k.isVisiblePoint(a)) return a;
                  b = !b;
                }
                return (
                  (b
      ...
      return {
        create: function (a, c, h, l) {
          if (arguments.length) 2 === arguments.length && ((h = a), (l = c));
          else if (g.isW3CRangeSupport) {
            var m = document.getSelection();
            if (!m || 0 === m.rangeCount || k.isBody(m.anchorNode)) return null;
            m = m.getRangeAt(0);
            a = m.startContainer;
            c = m.startOffset;
            h = m.endContainer;
    ...
    z = function () {
      ...
      this.styleNodes = function (b, c) {
        ...
        if (b.isCollapsed()) return [b.insertNode(k.create(e))];
    ...
    Q = function () {
      ...
      this.createTable = function (b, c) {
        for (var e = [], g = 0; g < b; g++) e.push("<td>" + k.blank + "</td>");
      ...
      this.fontSize = function (b, c) {
        ...
        if (g.isCollapsed()) {
          ...
          h &&
            ...
            b.data("bogus", h));
        } else J(b), a(e.styleNodes(g)).css({ "font-size": c + "px" }), v(b);
      };
    ...
    R = function () {
      ...
      this.attach = function (a, b) {
        if (!b.disableResizeEditor) a.statusbar().on("mousedown", c);
      };
      var c = function (a) {
        a.preventDefault();
        a.stopPropagation();
        var c = k.makeLayoutInfo(a.target).editable(),
          ...
          g = k
            .makeLayoutInfo(a.currentTarget || a.target)
            .editor()
            .data("options");
  ...
  var Y = function (a) {
    ...
    v = function (b) {
      ...
      this.attach = function (a, b) {
        ...
        else this.attachDragAndDropEvent(a, b);
      };
              ...
              e.ctrlKey &&
                ...
                setTimeout(function () {
                  ...
                  if (k.isImg(g)) {
                    ...
                    b.invoke("focus", e);
                    b.insertImages(h, [g]);
                  } else (g = a("<div />").html(c.html()).html()), b.invoke("restoreRange", e), b.invoke("focus", e), g && b.invoke("pasteHTML", e, g);
                  c.empty();
                }, 0));
            }),
            h.editable().before(c);
        else h.editable().on("paste", e);
      };
      var e = function (a) {
  ...
  var O = new (function () {
      var b = function (a, b) {
        ...
        D = function (a, b) {
          var c = b.extraKeys,
            e = [],
            g;
          for (g in c) c.hasOwnProperty(g) && e.push({ kbd: g, text: c[g] });
      ...
      this.createLayoutByFrame = function (b, c) {
        ...
        a(R(e, c))
          .prependTo(l)
          .find("button.close, a.modal-close")
          .click(function () {
            a(this).closest(".modal").modal("hide");
          });
        h.insertAfter(b);
    ...
    U = new (function () {
      ...
      this.bindKeyMap = function (b, e) {
        ...
        k.on("keydown", function (l) {
          ...
          if ((m = e[p])) {
            ...
            if (a.isFunction(p) && p(l, c.editor, b)) return !1;
          ...
          } else E.isEdit(l.keyCode) && c.editor.afterCommand(k);
        });
      };
      this.attach = function (b, e) {
        ...
        (e.airMode ? b.popover() : b.toolbar())
          .find(".note-dimension-picker-mousecatcher")
          .css({
...
(function (a, q) {
  ...
  function c(a, b) {
    ...
    for (g = 0; g < t.length; g++)
      if (((e = t[g] + b), void 0 !== c[e])) return e;
    if (void 0 !== c[b]) return b;
  }
  function b(a, b) {
    for (var e in b) a.style[c(a, e) || e] = b[e];
    return a;
  }
  function e(a) {
  ...
  a.fn.placeHolder = function (b) {
    ...
    return a(this).each(function (b) {
      ...
      var s = a(this),
        ...
        C,
        z;
      if ("" === L || void 0 === L) L = s[0].attributes.placeholder.value;
      C = s.closest("label");
      ...
      if (C.length || E)
        if (
          ...
          if (E.length) return r(E, s), E.text(L), s;
  ...
  function c(c, l) {
    ...
    for (var K = new g(c), ia, O, U, P; !K.eos(); ) {
      ...
      if ((U = K.scanUntil(v))) {
        ...
        for (var x = U.length; P < x; ++P)
          if (
            ...
            if (A && !H) for (; N.length; ) delete t[N.pop()];
            else N = [];
            H = A = !1;
          }
      }
      ...
      "=" === O
        ...
        : (U = K.scanUntil(E));
      if (!K.scan(E)) throw Error("Unclosed tag at " + K.pos);
      P = [O, U, ia, K.pos];
      t.push(P);
      if ("#" === O || "^" === O) q.push(P);
      else if ("/" === O) {
        O = q.pop();
        if (!O) throw Error('Unopened section "' + U + '" at ' + ia);
        if (O[1] !== U) throw Error('Unclosed section "' + O[1] + '" at ' + ia);
      } else
      ...
      switch (((p = b[s]), p[0])) {
        case "#":
          ...
          if (k(r))
            ...
            null != r && (l += r);
          } else l += this.renderTokens(p[4], c, e, g);
          break;
        case "^":
          r = c.lookup(p[1]);
          if (!r || (k(r) && 0 === r.length))
...
(function (a) {
  ...
  a.fn.timeago = function (a, b) {
    var c = a ? e[a] : e.init;
    if (!c) throw Error("Unknown function name '" + a + "' for timeago");
    this.each(function () {
      c.call(this, b);
    });
    return this;
      ...
      if (this.length) {
        ...
        b.settings.onsubmit &&
          ...
          this.on("submit.validate", function (c) {
            ...
            if (b.cancelSubmit) return (b.cancelSubmit = !1), g();
            if (b.form())
  ...
  a.extend(a.validator, {
    ...
    prototype: {
      ...
      elementValue: function (c) {
        ...
        if ("file" === e) {
          if ("C:\\fakepath\\" === c.substr(0, 12)) return c.substr(12);
          e = c.lastIndexOf("/");
          if (0 <= e) return c.substr(e + 1);
          e = c.lastIndexOf("\\");
      ...
      check: function (c) {
        ...
        for (q in b) {
          ...
          try {
            if (
              ...
              if (!p) return this.formatAndAdd(c, k), !1;
            }
          } catch (r) {
            throw (
              (this.settings.debug &&
        ...
        if (!g) return this.objectLength(b) && this.successList.push(c), !0;
      },
    ...
    methods: {
      ...
      step: function (c, b, e) {
        var g = a(b).attr("type"),
          ...
          r = !0;
        if (g && !q.test(p.join())) throw Error(l);
        g = k(e);
        if (
          k(c) > g ||
          0 !==
...
var urlize = (function () {
    ...
    function q(a, b) {
      for (var c = 0, e = 0; ; )
        if (((e = a.indexOf(b, e)), -1 != e)) c++, (e += b.length);
        else break;
      return c;
    }
    function r(a) {
  ...
  autoLinker = function (a) {
    $(a)
      ...
      .each(function () {
        ...
        else if (!a.is("a, pre, code")) autoLinker(this);
