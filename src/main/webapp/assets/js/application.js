...
(function(a, q) {
     ...
     function r(d) {
          var a = d.length, n = f.type(d);
          return "function" === n || f.isWindow(d) ? !1 : 1 === d.nodeType && a ? !0 : "array" === n || 0 === a ||
     ...
     function g() {
          F.addEventListener
               ? (F.removeEventListener("DOMContentLoaded", l, !1), a.removeEventListener("load", l, !1))
               : (F.detachEvent("onreadystatechange",
               l), a.detachEvent("onload", l));
     }
     
     function l() {
          if (F.addEventListener || "load" === event.type || "complete" === F.readyState) {
               g(), f.ready();
          }
     }
     ...
     function p(d, a, n) {
          if (void 0 === n && 1 === d.nodeType) {
               if (n = "data-" +
                    a.replace(Ab, "-$1").toLowerCase(), n = d.getAttribute(n), "string" === typeof n)
               {
                    try {
     ...
     function k(d, a, n, B) {
          if (f.acceptData(d)) {
               var b = f.expando, c = d.nodeType, h = c ? f.cache : d, e = c ? d[b] : d[b] && b;
               if (e && h[e] && (B || h[e].data) || void 0 !== n || "string" !== typeof a) {
                    e || (e = c ? d[b] = J.pop() || f.guid++ : b);
                    h[e] || (h[e] = c ? {} : {toJSON: f.noop});
                    if ("object" === typeof a || "function" === typeof a) {
                         B
                              ? h[e] = f.extend(h[e], a)
                              : h[e].data = f.extend(h[e].data, a);
                    }
                    d = h[e];
                    B || (d.data || (d.data = {}), d = d.data);
                    void 0 !== n && (d[f.camelCase(a)] = n);
                    "string" === typeof a ? (n = d[a], null == n && (n = d[f.camelCase(a)])) : n = d;
                    return n;
               }
          }
     }
     ...
     function s(d, a, n) {
          if (f.acceptData(d)) {
               var B,
                    b, c = d.nodeType, h = c ? f.cache : d, e = c ? d[f.expando] : f.expando;
               if (h[e]) {
                    if (a && (B = n ? h[e] : h[e].data)) {
                         f.isArray(a) ? a = a.concat(f.map(a, f.camelCase)) : a in B
                              ? a = [a]
                    ...
                    c ? f.cleanData([d], !0) : u.deleteExpando || h != h.window ? delete h[e] : h[e] = null;
               }
          }
     }
     ...
     function h(d, a) {
          var n, B, b = 0,
               c = "undefined" !== typeof d.getElementsByTagName ? d.getElementsByTagName(a || "*") : "undefined" !==
               typeof d.querySelectorAll ? d.querySelectorAll(a || "*") : void 0;
          if (!c) {
     ...
     function Q(d, a) {
          return f.nodeName(d, "table") && f.nodeName(11 !== a.nodeType ? a : a.firstChild, "tr")
               ? d.getElementsByTagName("tbody")[0] || d.appendChild(d.ownerDocument.createElement("tbody"))
               : d;
     }
     ...
     function R(d, a) {
          if (1 === a.nodeType && f.hasData(d)) {
               var n,
                    B, b;
               B = f._data(d);
               var c = f._data(a, B), h = B.events;
               if (h) {
                    for (n in delete c.handle, c.events = {}, h) {
                         for (B = 0, b = h[n].length; B <
                         b; B++)
                         {
     ...
     function T(d, G) {
          var n, B = f(G.createElement(d)).appendTo(G.body),
               b = a.getDefaultComputedStyle && (n = a.getDefaultComputedStyle(B[0]))
                    ? n.display
                    : f.css(B[0], "display");
          B.detach();
          return b;
     ...
     function M(d) {
          var a = F, n = hb[d];
          n || (n = T(d, a), "none" !== n && n ||
          (Ha = (Ha || f("<iframe frameborder='0' width='0' height='0'/>")).appendTo(a.documentElement),
               a = (Ha[0].contentWindow ||
                    Ha[0].contentDocument).document, a.write(), a.close(), n = T(d, a), Ha.detach()), hb[d] = n);
          return n;
     }
     ...
     function A(d, a) {
          ...
          for (var f = a.charAt(0).toUpperCase() + a.slice(1), B = a, b = ib.length; b--;) {
               if (a = ib[b] + f, a in
               d)
               {
                    return a;
     ...
     function Y(d, a) {
          for (var n, b, c, h = [], e = 0, g = d.length; e < g; e++) {
               b = d[e], b.style &&
               (h[e] = f._data(b, "olddisplay"), n = b.style.display,
                    a ? (h[e] || "none" !== n || (b.style.display = ""), "" === b.style.display && ua(b) &&
                    (h[e] = f._data(b, "olddisplay", M(b.nodeName)))) : (c = ua(b), (n && "none" !== n || !c) &&
                    f._data(b, "olddisplay", c ? n : f.css(b, "display"))));
          }
          for (e = 0; e < g; e++) {
               b = d[e], !b.style || a && "none" !== b.style.display && "" !== b.style.display ||
     ...
     function aa(d, a, n, b, c) {
          ...
          for (var h = 0; 4 > a; a += 2) {
               "margin" ===
               n && (h += f.css(d, n + qa[a], !0, c)), b ? ("content" === n &&
               (h -= f.css(d, "padding" + qa[a], !0, c)), "margin" !== n &&
               (h -= f.css(d, "border" + qa[a] + "Width", !0, c))) : (h += f.css(d, "padding" +
                    qa[a], !0, c), "padding" !==
               n && (h += f.css(d, "border" + qa[a] + "Width", !0, c)));
          }
          return h;
     }
     
     function da(d, a, n) {
          var b = !0, c = "width" === a ? d.offsetWidth : d.offsetHeight, h = xa(d),
     ...
     function U(d, a, f) {
          for (var b, c = (Ia[a] || []).concat(Ia["*"]), h = 0, e = c.length; h <
          e; h++)
          {
               if (b = c[h].call(f, a, d)) {
                    return b;
     ...
     function P(d, a) {
          ...
          for (n in d) {
               if (b = f.camelCase(n),
                    c = a[b], h = d[n], f.isArray(h) && (c = h[1], h = d[n] = h[0]), n !== b &&
               (d[b] = h, delete d[n]), (e = f.cssHooks[b]) && "expand" in e)
               {
     ...
     function x(d, a, n) {
          var b, c = 0, h = Ma.length, e = f.Deferred().always(function() {
                    delete g.elem;
               }), g = function() {
                    if (b) {
                         return !1;
                    }
                    for (var a = Ca || ia(), a = Math.max(0, m.startTime + m.duration - a), f = 1 -
                         (a / m.duration || 0), G = 0, n = m.tweens.length; G < n; G++)
                    {
                         m.tweens[G].run(f);
                    }
               ...
               m = e.promise({
                    ...
                    createTween: function(a, G) {
                         var n = f.Tween(d, m.opts, a, G, m.opts.specialEasing[a] || m.opts.easing);
                         m.tweens.push(n);
                         return n;
                    },
                    stop: function(a) {
                         var f = 0, G = a ? m.tweens.length : 0;
                         if (b) {
                              return this;
                         }
                         for (b = !0; f < G; f++) {
     ...
     function w(d) {
          return function(a, n) {
               ...
               var b, c = 0, h = a.toLowerCase().match(ha) || [];
               if (f.isFunction(n)) {
                    for (; b = h[c++];) {
                         "+" === b.charAt(0) ? (b = b.slice(1) || "*", (d[b] = d[b] ||
                              []).unshift(n)) : (d[b] = d[b] || []).push(n);
                    }
               }
          };
     }
     ...
     function S(d, a) {
          var n, b, c = f.ajaxSettings.flatOptions || {};
          for (b in a) {
     ...
     function ea(d, a, n, b) {
          ...
          if (f.isArray(a)) {
               f.each(a, function(a, f) {
                    n || Eb.test(d) ? b(d, f) : ea(d + "[" + ("object" === typeof f ? a :
                         "") + "]", f, n, b);
               });
     ...
     var J = [], Z = J.slice, ca = J.concat, ma = J.push, Da = J.indexOf, W = {}, ka = W.toString, I = W.hasOwnProperty,
          u = {}, f = function(d, a) {
               return new f.fn.init(d, a);
          }, ra = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, Na = /^-ms-/, Ea = /-([\da-z])/gi, Xa = function(d, a) {
               return a.toUpperCase();
          };
     f.fn = f.prototype =
          {
               jquery: "1.11.1", constructor: f, selector: "", length: 0, toArray: function() {
                    return Z.call(this);
               }, get: function(d) {
                    return null != d ? 0 > d ? this[d + this.length] : this[d] : Z.call(this);
                    ...
                    return this.pushStack(f.map(this, function(a, f) {
                         return d.call(a, f, a);
                    }));
               }, slice: function() {
               ...
               }, push: ma, sort: J.sort, splice: J.splice,
          };
     f.extend = f.fn.extend = function() {
          var d, a, n, b, c, h = arguments[0] || {}, e = 1, m = arguments.length, g = !1;
          ...
          for (; e < m; e++) {
               if (null != (c = arguments[e])) {
                    for (b in c) {
                         d = h[b], n = c[b],
                         h !== n && (g && n && (f.isPlainObject(n) || (a = f.isArray(n))) ? (a
                              ? (a = !1, d = d && f.isArray(d) ? d : [])
                              : d = d && f.isPlainObject(d) ? d : {}, h[b] = f.extend(g, d, n)) : void 0 !== n &&
                              (h[b] = n));
                    }
               }
          }
     ...
     f.extend({
          expando: "jQuery" + ("1.11.1" + Math.random()).replace(/\D/g, ""), isReady: !0, error: function(d) {
               throw Error(d);
          }, noop: function() {
               ...
               try {
                    if (d.constructor && !I.call(d, "constructor") &&
               ...
               return null == d ? d + "" : "object" === typeof d || "function" === typeof d
                    ? W[ka.call(d)] || "object"
                    : typeof d;
          },
          globalEval: function(d) {
               d && f.trim(d) && (a.execScript || function(d) {
                    a.eval.call(a, d);
               })(d);
               ...
               if (f) {
                    ...
                    for (; c < h &&
                    (b = a.call(d[c], c, d[c]), !1 !== b); c++)
                    {
                         ;
                    }
               } else {
                    for (c in d) {
                         if (b = a.call(d[c], c, d[c]), !1 ===
                         b)
                         {
                              break;
                         }
          ...
          trim: function(d) {
               ...
               var n = a || [];
               null != d && (r(Object(d)) ? f.merge(n, "string" === typeof d ? [d] : d) : ma.call(n, d));
               return n;
               ...
               for (var b =
                    [], c = 0, h = d.length, e = !f; c < h; c++)
               {
                    f = !a(d[c], c), f !== e && b.push(d[c]);
               }
               return b;
          }, map: function(d, a, f) {
               var b, c = 0, h = d.length, e = [];
               if (r(d)) {
                    for (; c < h; c++) {
                         b = a(d[c], c, f), null != b &&
                         e.push(b);
               ...
               if (f.isFunction(d)) {
                    return n = Z.call(arguments, 2), b = function() {
                         return d.apply(a || this, n.concat(Z.call(arguments)));
                    }, b.guid = d.guid = d.guid || f.guid++, b;
               }
          }, now: function() {
               return +new Date;
          }, support: u,
     });
     f.each("Boolean Number String Function Array Date RegExp Object Error".split(" "), function(d, a) {
     ...
     var na = function(d) {
               ...
               if (ka && !b) {
                    if (G = Ka.exec(d)) {
                         if (h = G[1]) {
                              if (9 === e) {
                                   ...
                                   if (f.ownerDocument && (c = f.ownerDocument.getElementById(h)) &&
                                        V(f, c) && c.id === h)
                                   {
                                        return n.push(c), n;
                                   }
                              ...
                              if ((h = G[3]) && S.getElementsByClassName &&
                    ...
                    if (S.qsa && (!ja || !ja.test(d))) {
                         ...
                         if (1 === e && "object" !== f.nodeName.toLowerCase()) {
                              e = D(d);
                              (G = f.getAttribute("id")) ? c = G.replace(Oa, "\\$&") : f.setAttribute("id", c);
                              c = "[id='" + c + "'] ";
                              for (h = e.length; h--;) {
                                   e[h] = c + u(e[h]);
                              }
          ...
          function e(d, a) {
               var f = a && d, n = f && 1 === d.nodeType &&
                    1 === a.nodeType && (~a.sourceIndex || -2147483648) - (~d.sourceIndex || -2147483648);
               if (n) {
                    return n;
               }
               if (f) {
          ...
          function y(d) {
               return d &&
                    "undefined" !== typeof d.getElementsByTagName && d;
          }
          ...
          function x(d, a, f) {
               var n = a.dir, b = f && "parentNode" === n, G = L++;
          ...
          function w(d) {
               return 1 < d.length ? function(a, f, n) {
          ...
          function I(d, f, n, c, h, e) {
               ...
               return b(function(b, e, m, B) {
                    var g, k, y = [], l = [], ta = e.length, ga;
                    if (!(ga = b)) {
                         ga = f || "*";
                         for (var u = m.nodeType ? [m] : m, x = [], w = 0, I = u.length; w < I; w++) {
                              a(ga, u[w], x);
                         }
                         ga = x;
                    }
          ...
          function X(d) {
               var a, f, n, b = d.length, G = t.relative[d[0].type];
               f = G || t.relative[" "];
               for (var c = G ? 1 : 0, h = x(function(d) {
                    return d === a;
               }, f, !0), e = x(function(d) {
                    return -1 <
                         K.call(a, d);
               }, f, !0), m = [function(d, f, n) {
                    return !G && (n || f !== Z) || ((a = f).nodeType ? h(d, f, n) : e(d, f, n));
               }]; c < b; c++)
               {
                    if (f = t.relative[d[c].type]) {
                         ...
                         if (f[ba]) {
                              ...
                              return I(1 < c && w(m), 1 < c &&
                                   u(d.slice(0, c - 1).concat({value: " " === d[c - 2].type ? "*" : ""})).
                                        replace(Ea, "$1"), f, c < n && X(d.slice(c, n)), n < b && X(d = d.slice(n)), n <
                                   b &&
                                   u(d));
                         }
                         m.push(f);
          ...
          function W(d, f) {
               var n = 0 < f.length, c = 0 < d.length, h = function(b, h, e, m, B) {
                    var g,
                         k, y, u = 0, l = "0", ta = b && [], ga = [], x = Z, w = b || c && t.find.TAG("*", B),
                         I = E += null == x ? 1 : Math.random() || .1, X = w.length;
          ...
          var Q, S, t, ea, s, D, fa, ca, Z, P, q, r, H,
               J, ka, ja, z, ma, V, ba = "sizzle" + -new Date, R = d.document, E = 0, L = 0, T = f(), M = f(), A = f(),
               Da = function(d, a) {
                    d === a && (q = !0);
                    return 0;
               }, C = {}.hasOwnProperty, v = [], Ya = v.pop, N = v.push, ra = v.push, Na = v.slice,
               K = v.indexOf || function(d) {
               ...
               Y = ":((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" +
                    Ja + ")*)|.*)\\)|)", Ea = /^[\x20\t\r\n\f]+|((?:^|[^\\])(?:\\.)*)[\x20\t\r\n\f]+$/g,
               Xa = /^[\x20\t\r\n\f]*,[\x20\t\r\n\f]*/, da = /^[\x20\t\r\n\f]*([>+~]|[\x20\t\r\n\f])[\x20\t\r\n\f]*/,
               O = /=[\x20\t\r\n\f]*([^\]'"]*?)[\x20\t\r\n\f]*\]/g, Fa = new RegExp(Y), aa = new RegExp("^" + F + "$"),
               na = {
                    ID: /^#((?:\\.|[\w-]|[^\x00-\xa0])+)/,
                    CLASS: /^\.((?:\\.|[\w-]|[^\x00-\xa0])+)/,
               ...
               ia = /^(?:input|select|textarea|button)$/i, Va = /^h\d$/i, pa = /^[^{]+\{\s*\[native \w/,
               Ka = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, U = /[+~]/, Oa = /'|\\/g,
               oa = /\\([\da-f]{1,6}[\x20\t\r\n\f]?|([\x20\t\r\n\f])|.)/ig, ha = function(d, a, f) {
                    d = "0x" + a - 65536;
                    return d !== d || f ? a : 0 > d ? String.fromCharCode(d + 65536) : String.fromCharCode(d >> 10 |
                         55296, d & 1023 | 56320);
               };
          try {
               ra.apply(v = Na.call(R.childNodes), R.childNodes), v[R.childNodes.length].nodeType;
          } catch (la) {
               ra = {
                    apply: v.length ? function(d, a) {
                         N.apply(d, Na.call(a));
                    } : function(d, a) {
                         for (var f =
                              d.length, n = 0; d[f++] = a[n++];)
                         {
                              ;
                         }
                         d.length = f - 1;
          ...
          r = a.setDocument = function(d) {
               ...
               S.getElementsByClassName = pa.test(a.getElementsByClassName) && c(function(d) {
               ...
               S.getById ? (t.find.ID = function(d, a) {
               ...
               }) : (delete t.find.ID, t.filter.ID = function(d) {
                    var a = d.replace(oa, ha);
                    return function(d) {
               ...
               t.find.TAG = S.getElementsByTagName ? function(d, a) {
                    if ("undefined" !== typeof a.getElementsByTagName) {
                         return a.getElementsByTagName(d);
                    }
               } : function(d, a) {
                    var f, n = [], b = 0, G = a.getElementsByTagName(d);
                    if ("*" === d) {
                         for (; f = G[b++];) {
               ...
               t.find.CLASS = S.getElementsByClassName && function(d, a) {
               ...
               if (S.qsa = pa.test(a.querySelectorAll)) {
                    c(function(d) {
                         d.innerHTML = "<select msallowclip=''><option selected=''></option></select>";
                         ...
                         d.querySelectorAll("[name=d]").length && ja.push("name[\\x20\\t\\r\\n\\f]*[*^$|!~]?=");
                         d.querySelectorAll(":enabled").length || ja.push(":enabled", ":disabled");
                         d.querySelectorAll("*,:x");
                         ja.push(",.*:");
                    });
               }
               (S.matchesSelector = pa.test(ma = J.matches || J.webkitMatchesSelector || J.mozMatchesSelector ||
                    J.oMatchesSelector || J.msMatchesSelector)) &&
               c(function(d) {
               ...
               V = (d = pa.test(J.compareDocumentPosition)) || pa.test(J.contains) ? function(d, a) {
                    var f = 9 === d.nodeType ? d.documentElement : d, n = a && a.parentNode;
                    return d === n || !!(n && 1 === n.nodeType &&
                         (f.contains ? f.contains(n) : d.compareDocumentPosition && d.compareDocumentPosition(n) & 16));
               } : function(d, a) {
                    if (a) {
                         for (; a = a.parentNode;) {
                              if (a === d) {
               ...
               Da = d ? function(d,
                    ...
                    n = (d.ownerDocument || d) === (f.ownerDocument || f) ? d.compareDocumentPosition(f) : 1;
                    return n & 1 || !S.sortDetached && f.compareDocumentPosition(d) === n ? d === a ||
                    d.ownerDocument === R && V(R, d) ? -1 : f === a || f.ownerDocument === R && V(R, f) ? 1 : P
                    ...
                    var n, b = 0;
                    n = d.parentNode;
                    var G = f.parentNode, c = [d], h = [f];
                    if (!n || !G) {
                         return d === a ? -1 : f === a ? 1 : n ? -1 : G ? 1 : P ? K.call(P, d) -
                              K.call(P, f) : 0;
                    }
                    if (n === G) {
                         return e(d, f);
          ...
          a.matchesSelector = function(d, f) {
               ...
               f = f.replace(O, "='$1']");
               if (!(!S.matchesSelector || !ka || z && z.test(f) || ja && ja.test(f))) {
                    try {
                         var n = ma.call(d, f);
                         if (n || S.disconnectedMatch || d.document && 11 !== d.document.nodeType) {
                              return n;
                         }
                    } catch (b) {
                    }
          ...
          a.attr = function(d, a) {
               ...
               return void 0 !== f ? f : S.attributes || !ka ? d.getAttribute(a) : (f = d.getAttributeNode(a)) &&
          ...
          t = a.selectors = {
               cacheLength: 50, createPseudo: b, match: na, attrHandle: {}, find: {}, relative: {
                    ...
                    ATTR: function(d) {
                         ...
                         d[1] = d[1].toLowerCase();
                         "nth" === d[1].slice(0, 3) ? (d[3] || a.error(d[0]), d[4] = +(d[4] ? d[5] + (d[6] || 1) : 2 *
                              ("even" === d[3] || "odd" === d[3])), d[5] = +(d[7] + d[8] || "odd" === d[3])) : d[3] &&
                              a.error(d[0]);
                         return d;
                    }, PSEUDO: function(d) {
                         var a, f = !d[6] && d[2];
                         ...
                         d[3] ?
                              d[2] = d[4] || d[5] || "" : f && Fa.test(f) && (a = D(f, !0)) &&
                    ...
                    TAG: function(d) {
                         ...
                         return a || (a = new RegExp("(^|[\\x20\\t\\r\\n\\f])" + d + "([\\x20\\t\\r\\n\\f]|$)")) &&
                              T(d, function(d) {
                                   return a.test("string" === typeof d.className && d.className || "undefined" !==
                                        typeof d.getAttribute && d.getAttribute("class") || "");
                              });
                    }, ATTR: function(d, f, n) {
                         return function(b) {
                              b = a.attr(b, d);
                              ...
                              b += "";
                              return "=" === f ? b === n : "!=" === f ? b !== n : "^=" === f
                                   ? n && 0 === b.indexOf(n)
                                   : "*=" === f ? n && -1 < b.indexOf(n) : "$=" === f
                                        ? n && b.slice(-n.length) === n
                                        : "~=" === f ? -1 < (" " + b + " ").indexOf(n) : "|=" === f ? b === n ||
                                             b.slice(0, n.length + 1) === n + "-" : !1;
                         };
                    }, CHILD: function(d, a, f, n, b) {
                         var G = "nth" !== d.slice(0, 3), c = "last" !== d.slice(-4), h = "of-type" === a;
                         return 1 === n && 0 === b ? function(d) {
                                   return !!d.parentNode;
                              } :
                              function(a, f, e) {
                                   var m, B, g, k, y;
                                   f = G !== c ? "nextSibling" : "previousSibling";
                                   var l = a.parentNode, u = h && a.nodeName.toLowerCase();
                                   e = !e && !h;
                                   if (l) {
                                        if (G) {
                                             for (; f;) {
                                                  for (B = a; B = B[f];) {
                                                       if (h ? B.nodeName.toLowerCase() === u : 1 ===
                                                            B.nodeType)
                                                       {
                                                            return !1;
                                                       }
                                        ...
                                        if (c && e) {
                                             for (e = l[ba] || (l[ba] = {}), m = e[d] || [], k = m[0] === E &&
                                                  m[1], g = m[0] === E && m[2], B = k && l.childNodes[k]; B = ++k &&
                                                  B &&
                                                  B[f] || (g = k = 0) || y.pop();)
                                             {
                                             ...
                                             (a[ba] = {}))[d]) && m[0] === E)
                                        {
                                             ...
                                             for (; (B = ++k && B &&
                                                  B[f] || (g = k = 0) || y.pop()) &&
                                             ((h ? B.nodeName.toLowerCase() !== u : 1 !== B.nodeType) || !++g ||
                         ...
                         var n,
                              c = t.pseudos[d] || t.setFilters[d.toLowerCase()] || a.error("unsupported pseudo: " + d);
                         return c[ba] ? c(f) : 1 < c.length ? (n = [d,
                              d,
                              "",
                              f], t.setFilters.hasOwnProperty(d.toLowerCase()) ? b(function(d, a) {
                    ...
                    not: b(function(d) {
                         var a = [], f = [], n = fa(d.replace(Ea, "$1"));
                         return n[ba] ? b(function(d, a, f, b) {
                              b = n(d, null, b, []);
                         ...
                         return function(a) {
                              var f;
                              do {
                                   if (f = ka ? a.lang : a.getAttribute("xml:lang") ||
                                        a.getAttribute("lang"))
                                   {
                                        return f = f.toLowerCase(), f === d || 0 ===
                                        f.indexOf(d + "-");
                                   }
                         ...
                         return d === H.activeElement && (!H.hasFocus || H.hasFocus()) &&
                         ...
                         var a = d.nodeName.toLowerCase();
                         return "input" ===
                              a && "button" === d.type || "button" === a;
                    }, text: function(d) {
                         var a;
                         return "input" === d.nodeName.toLowerCase() && "text" === d.type &&
          ...
          D = a.tokenize = function(d, f) {
               ...
               for (B = t.preFilter; e;) {
                    ...
                    for (h in t.filter) {
                         !(b = na[h].exec(e)) || B[h] && !(b = B[h](b)) ||
                         (n = b.shift(), c.push({value: n, type: h, matches: b}), e = e.slice(n.length));
                    }
                    if (!n) {
                         break;
                    }
          ...
          ca = a.select = function(d, a, f, n) {
               var b, c, G, h, e = "function" === typeof d && d, m = !n && D(d = e.selector || d);
               f = f || [];
               if (1 === m.length) {
                    c = m[0] = m[0].slice(0);
                    if (2 < c.length &&
                         "ID" === (G = c[0]).type && S.getById && 9 === a.nodeType && ka && t.relative[c[1].type])
                    {
                    ...
                    for (b = na.needsContext.test(d) ? 0 : c.length; b--;) {
                         ...
                         if (h = t.find[h]) {
                              if (n = h(G.matches[0].replace(oa, ha), U.test(c[0].type) &&
                                   y(a.parentNode) || a))
                              {
                                   c.splice(b, 1);
                                   d = n.length && u(c);
          ...
          h("checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", function(d, a, f) {
               var n;
               if (!f) {
                    return !0 === d[a] ? a.toLowerCase() : (n = d.getAttributeNode(a)) && n.specified
                         ? n.value
                         : null;
               }
          });
     ...
     var oa = f.expr.match.needsContext, Oa = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, Va = /^.[^:#\[\.,]*$/;
     f.filter = function(d, a, n) {
          var b = a[0];
          n && (d = ":not(" + d + ")");
          return 1 === a.length && 1 === b.nodeType
               ? f.find.matchesSelector(b, d) ? [b] : []
               : f.find.matches(d, f.grep(a, function(d) {
                    return 1 === d.nodeType;
               }));
     };
     f.fn.extend({
          find: function(d) {
               var a, n = [], b = this, c = b.length;
               if ("string" !== typeof d) {
                    return this.pushStack(f(d).filter(function() {
                         for (a = 0; a < c; a++) {
     ...
     var pa, F = a.document, Gb = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/;
     (f.fn.init = function(d, a) {
          ...
          if ("string" === typeof d) {
               n = "<" === d.charAt(0) && ">" === d.charAt(d.length -
                    1) && 3 <= d.length ? [null, d, null] : Gb.exec(d);
               if (!n || !n[1] && a) {
                    return !a || a.jquery ? (a || pa).find(d) : this.constructor(a).find(d);
               }
               if (n[1]) {
                    if (a = a instanceof f ? a[0] : a, f.merge(this, f.parseHTML(n[1], a && a.nodeType
                         ? a.ownerDocument || a
                         : F, !0)), Oa.test(n[1]) &&
                    f.isPlainObject(a))
                    {
          ...
          void 0 !== d.selector && (this.selector = d.selector, this.context = d.context);
          return f.makeArray(d, this);
     }).prototype = f.fn;
     pa = f(F);
     var Hb = /^(?:parents|prev(?:Until|All))/, Ib = {children: !0, contents: !0, next: !0, prev: !0};
     f.extend({
          dir: function(d, a, n) {
               var b = [];
               for (d = d[a]; d && 9 !== d.nodeType && (void 0 === n || 1 !== d.nodeType || !f(d).is(n));) {
                    1 ===
                    d.nodeType && b.push(d), d = d[a];
               }
               return b;
     ...
     f.fn.extend({
          has: function(d) {
               ...
               for (var n, b = 0, c = this.length, h = [], e = oa.test(d) || "string" !== typeof d ? f(d, a ||
                    this.context) : 0; b < c; b++)
               {
                    for (n = this[b]; n && n !== a; n = n.parentNode) {
                         if (11 >
                              n.nodeType && (e ? -1 < e.index(n) : 1 === n.nodeType && f.find.matchesSelector(n, d)))
                         {
                              h.push(n);
                              break;
                         }
          ...
          index: function(d) {
               return d
                    ? "string" === typeof d ? f.inArray(this[0], f(d)) : f.inArray(d.jquery ? d[0] : d, this)
     ...
     f.each({
          parent: function(d) {
               ...
               return f.nodeName(d,
                    "iframe") ? d.contentDocument || d.contentWindow.document : f.merge([], d.childNodes);
          },
     }, function(d, a) {
          f.fn[d] = function(n, b) {
               ...
               1 < this.length && (Ib[d] || (c = f.unique(c)), Hb.test(d) && (c = c.reverse()));
     ...
     f.Callbacks = function(d) {
          ...
          var a, n, b, c, h, m, g = [], k = !d.once && [], l = function(f) {
               n = d.memory && f;
               b = !0;
               h = m || 0;
               m = 0;
               ...
               add: function() {
                    if (g) {
                         ...
                         (function Fb(a) {
                              f.each(a, function(a, n) {
                                   var b = f.type(n);
                                   "function" === b ? d.unique && y.has(n) || g.push(n) : n && n.length && "string" !==
                                        b && Fb(n);
                              });
                         })(arguments);
                    ...
                    g && f.each(arguments, function(d, n) {
                    ...
                    !g || b && !k || (f = f || [], f = [d, f.slice ? f.slice() : f], a ? k.push(f) : l(f));
                    return this;
               }, fire: function() {
     ...
     f.extend({
          Deferred: function(d) {
               var a = [["resolve", "done", f.Callbacks("once memory"),
                    "resolved"],
                    ["reject", "fail", f.Callbacks("once memory"), "rejected"],
                    ["notify", "progress", f.Callbacks("memory")]], n = "pending", b = {
                    state: function() {
                         return n;
                    }, always: function() {
                              ...
                              f.each(a, function(a, G) {
                                   ...
                                   c[G[1]](function() {
                                        ...
                                        if (d && f.isFunction(d.promise)) {
                                             ...
                                             n[G[0] + "With"](this ===
                                             b ? n.promise() : this, h ? [d] : arguments);
                                        }
                                   });
                              });
                              d = null;
               ...
               var a = 0, n = Z.call(arguments), b = n.length, c = 1 !== b || d && f.isFunction(d.promise) ? b : 0,
                    h = 1 === c ? d : f.Deferred(),
                    e = function(d, a, f) {
                         return function(n) {
                              a[d] = this;
     ...
     f.extend({
          isReady: !1, readyWait: 1, holdReady: function(d) {
               ...
               d ? !--f.readyWait : !f.isReady)
               {
                    ...
                    f.isReady = !0;
                    !0 !== d && 0 < --f.readyWait ||
                    (Pa.resolveWith(F, [f]), f.fn.triggerHandler && (f(F).triggerHandler("ready"), f(F).off("ready")));
               }
          },
     });
     f.ready.promise = function(d) {
          if (!Pa) {
               if (Pa = f.Deferred(), "complete" ===
               F.readyState)
               {
                    setTimeout(f.ready);
               } else if (F.addEventListener) {
                    F.addEventListener("DOMContentLoaded", l, !1), a.addEventListener("load", l, !1);
               } else {
     ...
     f(function() {
          var d, a, f;
          (a = F.getElementsByTagName("body")[0]) && a.style &&
          (d = F.createElement("div"), f = F.createElement("div"), f.style.cssText = "position:absolute;border:0;width:0;height:0;top:0;left:-9999px", a.appendChild(f).
               appendChild(d), "undefined" !== typeof d.style.zoom &&
          (d.style.cssText = "display:inline;margin:0;border:0;padding:1px;width:1px;zoom:1", u.inlineBlockNeedsLayout = d = 3 ===
               d.offsetWidth) && (a.style.zoom = 1), a.removeChild(f));
     });
     (function() {
     ...
     f.acceptData = function(d) {
          var a = f.noData[(d.nodeName + " ").toLowerCase()], n = +d.nodeType || 1;
          return 1 !== n && 9 !== n ? !1 : !a || !0 !== a && d.getAttribute("classid") === a;
     };
     var Bb = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/, Ab = /([A-Z])/g;
     f.extend({
          cache: {},
     ...
     f.fn.extend({
          data: function(d, a) {
               var n, b, c, h = this[0], e = h && h.attributes;
               if (void 0 === d) {
                    if (this.length && (c = f.data(h), 1 === h.nodeType && !f._data(h,
                         "parsedAttrs")))
                    {
                         for (n = e.length; n--;) {
                              e[n] &&
                              (b = e[n].name, 0 === b.indexOf("data-") && (b = f.camelCase(b.slice(5)), p(h, b, c[b])));
                         }
     ...
     f.extend({
          queue: function(d, a, n) {
               var b;
               if (d) {
                    return a = (a || "fx") + "queue", b = f._data(d, a), n && (!b || f.isArray(n) ? b = f._data(d,
                         a, f.makeArray(n)) : b.push(n)), b || [];
               }
          }, dequeue: function(d, a) {
               a = a || "fx";
               var b = f.queue(d, a), c = b.length, h = b.shift(), e = f._queueHooks(d, a), m = function() {
                    f.dequeue(d, a);
               };
               "inprogress" === h && (h = b.shift(), c--);
               h && ("fx" === a && b.unshift("inprogress"), delete e.stop, h.call(d, m, e));
               !c && e && e.empty.fire();
          }, _queueHooks: function(d, a) {
               var b = a + "queueHooks";
               return f._data(d, b) || f._data(d, b, {
     ...
     f.fn.extend({
          queue: function(d, a) {
               ...
               return arguments.length < b ? f.queue(this[0], d) : void 0 === a ? this : this.each(function() {
               ...
               var b, c = 1, h = f.Deferred(), e = this, m = this.length, g = function() {
                    --c || h.resolveWith(e, [e]);
               };
               "string" !== typeof d && (a = d, d = void 0);
               for (d = d || "fx"; m--;) {
                    (b =
                         f._data(e[m], d + "queueHooks")) && b.empty && (c++, b.empty.add(g));
               }
               g();
               return h.promise(a);
          },
     });
     var Qa = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, qa = ["Top", "Right", "Bottom", "Left"],
          ua = function(d, a) {
               d = a || d;
               return "none" === f.css(d, "display") || !f.contains(d.ownerDocument, d);
          }, sa = f.access = function(d, a, b, c, h, e, m) {
               var g = 0, k = d.length, y = null == b;
               if ("object" === f.type(b)) {
                    for (g in h = !0, b) {
                         f.access(d, a, g, b[g], !0, e, m);
                    }
               } else if (void 0 !== c &&
                    (h = !0, f.isFunction(c) || (m = !0), y &&
                    (m ? (a.call(d, c), a = null) : (y = a, a = function(d, a, b) {
                         return y.call(f(d),
                              b);
                    })), a))
               {
     ...
     (function() {
          var d = F.createElement("input"), a = F.createElement("div"), f = F.createDocumentFragment();
          ...
          u.html5Clone = "<:nav></:nav>" !== F.createElement("nav").cloneNode(!0).outerHTML;
          d.type = "checkbox";
          d.checked = !0;
          f.appendChild(d);
     ...
     (function() {
          var d, f, b = F.createElement("div");
          for (d in {submit: !0, change: !0, focusin: !0}) {
               f = "on" + d, (u[d + "Bubbles"] = f in a) ||
               (b.setAttribute(f, "t"), u[d + "Bubbles"] = !1 === b.attributes[f].expando);
          }
     })();
     var X = /^(?:input|select|textarea)$/i, ba = /^key/, Ya = /^(?:mouse|pointer|contextmenu)|click/,
          Ja = /^(?:focusinfocus|focusoutblur)$/, Fa = /^([^.]*)(?:\.(.+)|)$/;
     f.event = {
          global: {},
          add: function(d, a, b, c, h) {
               ...
               if (g = f._data(d)) {
                    ...
                    (y = g.handle) || (y = g.handle = function(d) {
                         return "undefined" === typeof f || d && f.event.triggered === d.type
                              ? void 0
                              : f.event.dispatch.apply(y.elem, arguments);
                    }, y.elem = d);
                    a = (a || "").match(ha) || [""];
                    for (g = a.length; g--;) {
                         e = Fa.exec(a[g]) || [], x = l = e[1], w = (e[2] || "").split(".").
                              sort(), x &&
                         (e = f.event.special[x] || {}, x = (h ? e.delegateType : e.bindType) ||
                              x, e = f.event.special[x] ||
                              {}, l = f.extend({
                              type: x,
                              origType: l,
                              data: c,
                         ...
                         (u = m[x] = [], u.delegateCount = 0, e.setup && !1 !== e.setup.call(d, c, w, y) ||
                         (d.addEventListener ? d.addEventListener(x, y, !1) : d.attachEvent &&
                              d.attachEvent("on" + x, y))), e.add &&
                         (e.add.call(d, l), l.handler.guid || (l.handler.guid = b.guid)), h
                              ? u.splice(u.delegateCount++, 0, l)
                              : u.push(l), f.event.global[x] = !0);
                    }
                    d = null;
               }
          },
          remove: function(d, a, b, c, h) {
               var e, m, g, k, y, l, u, x, w, I, p, X = f.hasData(d) && f._data(d);
               if (X && (l = X.events)) {
                    a = (a || "").match(ha) || [""];
                    for (y = a.length; y--;) {
                         if (g = Fa.exec(a[y]) || [], w =
                              p = g[1], I = (g[2] || "").split(".").sort(), w)
                         {
                              u = f.event.special[w] || {};
                              w = (c ? u.delegateType : u.bindType) || w;
                              x = l[w] || [];
                              g = g[2] && new RegExp("(^|\\.)" + I.join("\\.(?:.*\\.|)") + "(\\.|$)");
                              for (k = e = x.length; e--;) {
                                   m = x[e], !h && p !== m.origType || b && b.guid !== m.guid || g &&
                                   !g.test(m.namespace) || c && c !== m.selector && ("**" !== c || !m.selector) ||
                                   (x.splice(e, 1), m.selector && x.delegateCount--, u.remove && u.remove.call(d, m));
                              }
                              k && !x.length && (u.teardown && !1 !== u.teardown.call(d, I, X.handle) ||
                              f.removeEvent(d, w, X.handle), delete l[w]);
                         } else {
                              for (w in l) {
                                   f.event.remove(d,
                                        w + a[y], b, c, !0);
          ...
          trigger: function(d, b, n, c) {
               var h, e, m, g, k, y, l = [n || F], u = I.call(d, "type") ? d.type : d;
               k = I.call(d, "namespace") ? d.namespace.split(".") : [];
               m = h = n = n || F;
               if (3 !== n.nodeType && 8 !== n.nodeType && !Ja.test(u + f.event.triggered) &&
                    (0 <= u.indexOf(".") && (k = u.split("."), u = k.shift(), k.sort()), e = 0 > u.indexOf(":") &&
                         "on" + u, d = d[f.expando] ? d : new f.Event(u, "object" === typeof d && d), d.isTrigger = c
                         ? 2
                         : 3, d.namespace = k.join("."), d.namespace_re = d.namespace ? new RegExp("(^|\\.)" +
                         k.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, d.result = void 0, d.target ||
                    (d.target = n), b = null == b ? [d] : f.makeArray(b, [d]), k = f.event.special[u] || {}, c ||
                    !k.trigger || !1 !== k.trigger.apply(n, b)))
               {
                    if (!c && !k.noBubble && !f.isWindow(n)) {
                         ...
                         h === (n.ownerDocument || F) && l.push(h.defaultView || h.parentWindow || a);
                    }
                    for (y = 0; (m = l[y++]) && !d.isPropagationStopped();) {
                         d.type = 1 < y ? g : k.bindType ||
                              u, (h = (f._data(m, "events") || {})[d.type] && f._data(m, "handle")) &&
                         h.apply(m, b), (h = e && m[e]) && h.apply && f.acceptData(m) &&
                         (d.result = h.apply(m, b), !1 === d.result && d.preventDefault());
                    }
                    d.type = u;
                    if (!(c || d.isDefaultPrevented() || k._default && !1 !== k._default.apply(l.pop(), b)) &&
                         f.acceptData(n) && e && n[u] && !f.isWindow(n))
                    {
                         (h = n[e]) && (n[e] = null);
                         f.event.triggered = u;
                         try {
          ...
          dispatch: function(d) {
               d = f.event.fix(d);
               var a, b, c, h, e = [], m = Z.call(arguments);
               ...
               if (!g.preDispatch || !1 !== g.preDispatch.call(this, d)) {
                    ...
                    for (a = 0; (c = e[a++]) &&
                    !d.isPropagationStopped();)
                    {
                         for (d.currentTarget = c.elem, h = 0; (b = c.handlers[h++]) &&
                         !d.isImmediatePropagationStopped();)
                         {
                              if (!d.namespace_re ||
                                   d.namespace_re.test(b.namespace))
                              {
                                   d.handleObj = b, d.data = b.data, b = ((f.event.special[b.origType] ||
                                        {}).handle || b.handler).apply(c.elem, m), void 0 !== b && !1 ===
                                   (d.result = b) &&
          ...
          handlers: function(d, a) {
               var b, c, h, e, m = [], g = a.delegateCount, k = d.target;
               if (g && k.nodeType && (!d.button || "click" !== d.type)) {
                         ...
                         this)
                    {
                         if (1 === k.nodeType && (!0 !== k.disabled || "click" !== d.type)) {
                              h = [];
                              for (e = 0; e < g; e++) {
                                   c = a[e], b = c.selector + " ", void 0 === h[b] &&
                                   (h[b] = c.needsContext
                                        ? 0 <= f(b, this).index(k)
                                        : f.find(b, this, null, [k]).length), h[b] &&
                                   h.push(c);
                              }
          ...
          fix: function(d) {
               ...
               var a, b, c;
               a = d.type;
               var h = d, e = this.fixHooks[a];
               e || (this.fixHooks[a] = e = Ya.test(a) ? this.mouseHooks : ba.test(a) ? this.keyHooks : {});
          ...
          fixHooks: {},
          keyHooks: {
               props: ["char", "charCode", "key", "keyCode"], filter: function(d, a) {
          ...
          mouseHooks: {
               ...
               filter: function(d, a) {
                    var f, b, c = a.button, h = a.fromElement;
                    null == d.pageX && null != a.clientX &&
                    (f = d.target.ownerDocument || F, b = f.documentElement, f = f.body, d.pageX = a.clientX +
                         (b && b.scrollLeft || f && f.scrollLeft || 0) - (b && b.clientLeft ||
                              f && f.clientLeft || 0), d.pageY = a.clientY +
                         (b && b.scrollTop || f && f.scrollTop || 0) - (b && b.clientTop || f && f.clientTop || 0));
                    !d.relatedTarget && h && (d.relatedTarget = h === d.target ? a.toElement : h);
                    d.which || void 0 === c || (d.which = c & 1 ? 1 : c & 2 ? 3 : c & 4 ? 2 : 0);
                    return d;
               },
          },
          special: {
               load: {noBubble: !0}, focus: {
                    ...
                    trigger: function() {
                         if (f.nodeName(this,
                              "input") && "checkbox" === this.type && this.click)
                         {
                              return this.click(), !1;
                         }
                    }, _default: function(d) {
          ...
          simulate: function(d, a, b, c) {
               d = f.extend(new f.Event, b, {type: d, isSimulated: !0, originalEvent: {}});
               c ? f.event.trigger(d, null, a) : f.event.dispatch.call(a, d);
               d.isDefaultPrevented() && b.preventDefault();
          },
     };
     f.removeEvent = F.removeEventListener ? function(d, a, f) {
          d.removeEventListener &&
          d.removeEventListener(a, f, !1);
     } : function(d, a, f) {
          a = "on" + a;
          d.detachEvent && ("undefined" === typeof d[a] && (d[a] = null), d.detachEvent(a, f));
     };
     f.Event = function(d, a) {
          if (!(this instanceof f.Event)) {
               return new f.Event(d, a);
          }
          d && d.type ? (this.originalEvent = d, this.type = d.type, this.isDefaultPrevented = d.defaultPrevented ||
          void 0 === d.defaultPrevented && !1 === d.returnValue ? L : E) : this.type = d;
          a && f.extend(this, a);
     ...
     f.Event.prototype = {
          ...
          isImmediatePropagationStopped: E, preventDefault: function() {
     ...
     f.each({
          ...
          mouseleave: "mouseout", pointerenter: "pointerover", pointerleave: "pointerout",
     }, function(d, a) {
          f.event.special[d] = {
               delegateType: a, bindType: a, handle: function(d) {
                    var b, c = d.relatedTarget, h = d.handleObj;
                    if (!c || c !== this &&
                         !f.contains(this, c))
                    {
                         d.type = h.origType, b = h.handler.apply(this, arguments), d.type = a;
                    }
                    return b;
               },
          };
     ...
     u.submitBubbles || (f.event.special.submit = {
          setup: function() {
               ...
               f.event.add(this, "click._submit keypress._submit", function(d) {
                    d = d.target;
                    (d = f.nodeName(d, "input") || f.nodeName(d,
                         "button") ? d.form : void 0) && !f._data(d, "submitBubbles") &&
                    (f.event.add(d, "submit._submit", function(d) {
                         d._submit_bubble = !0;
                    }), f._data(d, "submitBubbles", !0));
               });
          }, postDispatch: function(d) {
               d._submit_bubble && (delete d._submit_bubble, this.parentNode && !d.isTrigger &&
     ...
     u.changeBubbles || (f.event.special.change = {
          setup: function() {
               ...
               f.event.add(this, "beforeactivate._change", function(d) {
                    d = d.target;
                    X.test(d.nodeName) && !f._data(d, "changeBubbles") &&
                    (f.event.add(d, "change._change", function(d) {
                         !this.parentNode || d.isSimulated || d.isTrigger || f.event.simulate("change",
                              this.parentNode, d, !0);
                    }), f._data(d, "changeBubbles", !0));
               });
          }, handle: function(d) {
               var a = d.target;
               if (this !== a || d.isSimulated || d.isTrigger || "radio" !== a.type && "checkbox" !==
                    a.type)
               {
     ...
     u.focusinBubbles || f.each({focus: "focusin", blur: "focusout"}, function(d, a) {
          var b = function(d) {
          ...
          f.event.special[a] = {
               setup: function() {
                    ...
                    var c = this.ownerDocument || this, h = f._data(c, a) - 1;
                    h ? f._data(c, a, h) : (c.removeEventListener(d, b, !0), f._removeData(c, a));
               },
          };
     });
     f.fn.extend({
          on: function(d, a, b, c, h) {
               ...
               null == b && null == c ? (c = a, b = a = void 0) : null == c &&
                    ("string" === typeof a ? (c = b, b = void 0) : (c = b, b = a, a = void 0));
               if (!1 === c) {
                    c = E;
               } else if (!c) {
                    return this;
               }
               1 === h && (m = c, c = function(d) {
                    f().off(d);
               ...
               if (d && d.preventDefault && d.handleObj) {
                    return c = d.handleObj, f(d.delegateTarget).
                         off(c.namespace ? c.origType + "." + c.namespace : c.origType, c.selector, c.handler), this;
               }
               if ("object" === typeof d) {
                    for (c in d) {
                         this.off(c, a, d[c]);
     ...
     var Ka = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
          Kb = / jQuery\d+="(?:null|\d+)"/g, jb = new RegExp("<(?:" + Ka + ")[\\s/>]", "i"), Za = /^\s+/,
          kb = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi,
          lb = /<([\w:]+)/, mb = /<tbody/i, Lb = /<|&#?\w+;/, Mb = /<(?:script|style|link)/i,
          Nb = /checked\s*(?:[^=]|=\s*.checked.)/i, nb = /^$|\/(?:java|ecma)script/i, Cb = /^true\/(.*)/,
          Ob = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, la = {
     ...
     f.extend({
          clone: function(d, a, b) {
               var c, e, m, g, k, y = f.contains(d.ownerDocument, d);
               u.html5Clone || f.isXMLDoc(d) || !jb.test("<" + d.nodeName + ">")
                    ? m = d.cloneNode(!0)
                    : ($a.innerHTML = d.outerHTML, $a.removeChild(m = $a.firstChild));
               if (!(u.noCloneEvent && u.noCloneChecked || 1 !== d.nodeType && 11 !==
                    d.nodeType || f.isXMLDoc(d)))
               {
                    for (c = h(m), k = h(d), g = 0; null != (e = k[g]); ++g) {
                         if (c[g]) {
                              var l = c[g], x = void 0, w = void 0, I = void 0;
                              if (1 === l.nodeType) {
                                   ...
                                   if ("script" === x && l.text !== e.text) {
                                        ...
                                        x)
                                   {
                                        l.parentNode && (l.outerHTML = e.outerHTML), u.html5Clone && e.innerHTML &&
                                        !f.trim(l.innerHTML) && (l.innerHTML = e.innerHTML);
                                   } else if ("input" === x &&
                                        Ba.test(e.type))
                                   {
                                        l.defaultChecked =
                                             l.checked = e.checked, l.value !== e.value && (l.value = e.value);
                                   } else if ("option" ===
                                        x)
                                   {
               ...
               for (var e, g, k, l, y, x, w = d.length, I = z(a), X = [], p = 0; p < w; p++) {
                    if ((g = d[p]) || 0 ===
                         g)
                    {
                         if ("object" === f.type(g)) {
                              ...
                              k =
                                   k || I.appendChild(a.createElement("div"));
                              ...
                              !u.leadingWhitespace && Za.test(g) && X.push(a.createTextNode(Za.exec(g)[0]));
                              if (!u.tbody) {
                                   for (e = (g = "table" !== l || mb.test(g)
                                        ? "<table>" !== x[1] || mb.test(g) ? 0 : k
                                        : k.firstChild) && g.childNodes.length; e--;)
                                   {
                                        f.nodeName(y = g.childNodes[e], "tbody") &&
                                        !y.childNodes.length && g.removeChild(y);
                                   }
                              }
               ...
               for (p = 0; g = X[p++];) {
                    if (!c || -1 ===
                         f.inArray(g, c))
                    {
                         if (d = f.contains(g.ownerDocument, g), k = h(I.appendChild(g), "script"), d &&
                         V(k), b)
                         {
                              for (e = 0; g = k[e++];) {
               ...
               for (var b, c, h, e, m = 0, g = f.expando, k = f.cache, l = u.deleteExpando, y = f.event.special; null !=
               (b = d[m]); m++)
               {
                    if (a || f.acceptData(b)) {
                         if (e = (h = b[g]) && k[h]) {
                              if (e.events) {
                                   for (c in e.events) {
                                        y[c] ? f.event.remove(b,
                                             c) : f.removeEvent(b, c, e.handle);
                                   }
                              }
                              k[h] && (delete k[h], l ? delete b[g] : "undefined" !== typeof b.removeAttribute
                                   ? b.removeAttribute(g)
                                   : b[g] = null, J.push(h));
                         }
                    }
     ...
     f.fn.extend({
          text: function(d) {
               return sa(this, function(d) {
                    return void 0 === d ? f.text(this) : this.empty().
                         append((this[0] && this[0].ownerDocument || F).createTextNode(d));
               }, null, d, arguments.length);
          }, append: function() {
               return this.domManip(arguments, function(d) {
                    1 !== this.nodeType && 11 !== this.nodeType && 9 !== this.nodeType || Q(this, d).appendChild(d);
               });
          }, prepend: function() {
               ...
               for (var b, c = d ? f.filter(d, this) : this, e = 0; null != (b = c[e]); e++) {
                    a || 1 !== b.nodeType ||
                    f.cleanData(h(b)), b.parentNode &&
                    (a && f.contains(b.ownerDocument, b) && V(h(b, "script")), b.parentNode.removeChild(b));
               }
               return this;
          }, empty: function() {
               ...
               return sa(this, function(d) {
                    var a = this[0] || {}, b = 0, c = this.length;
                    if (void 0 === d) {
                         return 1 ===
                         a.nodeType ? a.innerHTML.replace(Kb, "") : void 0;
                    }
                    if (!("string" !== typeof d || Mb.test(d) || !u.htmlSerialize && jb.test(d) ||
                         !u.leadingWhitespace && Za.test(d) || la[(lb.exec(d) || ["", ""])[1].toLowerCase()]))
                    {
                         d = d.replace(kb, "<$1></$2>");
                         try {
                              for (; b < c; b++) {
                                   a = this[b] || {}, 1 === a.nodeType &&
               ...
               d = ca.apply([], d);
               var b, c, e, m, g = 0, k = this.length, l = this, y = k - 1, x = d[0], w = f.isFunction(x);
               ...
               if (k && (m = f.buildFragment(d, this[0].ownerDocument, !1, this), b = m.firstChild, 1 ===
               m.childNodes.length && (m = b), b))
               {
                    ...
                    {
                         b = m, g !== y &&
                         (b = f.clone(b, !0, !0), c && f.merge(e, h(b, "script"))), a.call(this[g], b, g);
                    }
                    if (c) {
                         for (m = e[e.length - 1].ownerDocument, f.map(e, D), g = 0; g <
                         c; g++)
                         {
                              b = e[g], nb.test(b.type || "") && !f._data(b, "globalEval") && f.contains(m, b) &&
                              (b.src ? f._evalUrl && f._evalUrl(b.src) : f.globalEval((b.text || b.textContent ||
                                   b.innerHTML ||
                                   "").replace(Ob, "")));
                         }
                    }
     ...
     f.each({
          ...
          f.fn[d] = function(d) {
               for (var b =
                    0, c = [], h = f(d), e = h.length - 1; b <= e; b++)
               {
                    d = b === e
                         ? this
                         : this.clone(!0), f(h[b])[a](d), ma.apply(c, d.get());
               }
               return this.pushStack(c);
          };
     });
     ...
     (function() {
          ...
          u.shrinkWrapBlocks = function() {
               ...
               d = !1;
               var a, f, b;
               if ((f = F.getElementsByTagName("body")[0]) &&
                    f.style)
               {
                    return a = F.createElement("div"), b = F.createElement("div"), b.style.cssText = "position:absolute;border:0;width:0;height:0;top:0;left:-9999px", f.appendChild(b).
                         appendChild(a), "undefined" !== typeof a.style.zoom &&
                    (a.style.cssText = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:1px;width:1px;zoom:1",
                         a.appendChild(F.createElement("div")).style.width = "5px", d = 3 !==
                         a.offsetWidth), f.removeChild(b), d;
               }
          };
     })();
     var ob = /^margin/, La = new RegExp("^(" + Qa + ")(?!px)[a-z%]+$", "i"), xa, ya, Pb = /^(top|right|bottom|left)$/;
     a.getComputedStyle ? (xa = function(d) {
          return d.ownerDocument.defaultView.getComputedStyle(d, null);
     }, ya = function(d, a, b) {
          var c, h, e = d.style;
          h = (b = b || xa(d)) ? b.getPropertyValue(a) || b[a] : void 0;
          b && ("" !== h || f.contains(d.ownerDocument, d) || (h = f.style(d, a)), La.test(h) && ob.test(a) &&
          (d = e.width, a = e.minWidth, c = e.maxWidth,
               e.minWidth = e.maxWidth = e.width = h, h = b.width, e.width = d, e.minWidth = a, e.maxWidth = c));
          return void 0 === h ? h : h + "";
     }) : F.documentElement.currentStyle && (xa = function(d) {
     ...
     (function() {
          function d() {
               ...
               if ((f = F.getElementsByTagName("body")[0]) && f.style) {
                    ...
                    g = !0;
                    a.getComputedStyle &&
                    (h = "1%" !== (a.getComputedStyle(d, null) || {}).top, e = "4px" === (a.getComputedStyle(d,
                         null) ||
                         {width: "4px"}).width, c = d.appendChild(F.createElement("div")), c.style.cssText = d.style.cssText = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:0", c.style.marginRight = c.style.width = "0", d.style.width = "1px", g = !parseFloat((a.getComputedStyle(c, null) ||
                         {}).marginRight));
                    ...
                    if (m =
                         0 === c[0].offsetHeight)
                    {
                         c[0].style.display = "", c[1].style.display = "none", m = 0 ===
                              c[0].offsetHeight;
                    }
                    f.removeChild(b);
               }
          ...
          if (c = (c = b.getElementsByTagName("a")[0]) &&
               c.style)
          {
               c.cssText = "float:left;opacity:.5", u.opacity = "0.5" ===
                    c.opacity, u.cssFloat = !!c.cssFloat, b.style.backgroundClip = "content-box", b.cloneNode(!0).style.backgroundClip = "", u.clearCloneStyle = "content-box" ===
                    b.style.backgroundClip,
                    u.boxSizing = "" === c.boxSizing || "" === c.MozBoxSizing || "" === c.WebkitBoxSizing, f.extend(u, {
     ...
     var ab = /alpha\([^)]*\)/i, Qb = /opacity\s*=\s*([^)]*)/, Rb = /^(none|table(?!-c[ea]).+)/,
          Db = new RegExp("^(" + Qa + ")(.*)$", "i"), Sb = new RegExp("^([+-])=(" + Qa + ")", "i"),
          Tb = {position: "absolute", visibility: "hidden", display: "block"},
          pb = {letterSpacing: "0", fontWeight: "400"}, ib = ["Webkit", "O", "Moz", "ms"];
     f.extend({
          cssHooks: {
               opacity: {
                    get: function(d, a) {
          ...
          style: function(d, a, b, c) {
               if (d && 3 !== d.nodeType && 8 !== d.nodeType && d.style) {
                    var h, e, m, g = f.camelCase(a), k = d.style;
                    a = f.cssProps[g] || (f.cssProps[g] = A(k, g));
                    m = f.cssHooks[a] || f.cssHooks[g];
                    if (void 0 !== b) {
                         if (e = typeof b, "string" === e && (h = Sb.exec(b)) &&
                         (b = (h[1] + 1) * h[2] + parseFloat(f.css(d, a)), e = "number"), null != b && b === b &&
                         ("number" !== e || f.cssNumber[g] || (b += "px"), u.clearCloneStyle || "" !== b || 0 !==
                         a.indexOf("background") || (k[a] = "inherit"), !(m && "set" in m) || void 0 !==
                         (b = m.set(d, b, c))))
                         {
                              try {
                                   k[a] = b;
                         ...
                         return m &&
                         "get" in m && void 0 !== (h = m.get(d, !1, c)) ? h : k[a];
                    }
               }
          },
          css: function(d, a, b, c) {
               ...
               (e = f.cssHooks[a] || f.cssHooks[e]) && "get" in e && (h = e.get(d, !0, b));
               void 0 === h && (h = ya(d, a, c));
               "normal" === h && a in pb && (h = pb[a]);
               return "" === b || b ? (d = parseFloat(h), !0 === b || f.isNumeric(d) ? d || 0 : h) : h;
          },
     });
     f.each(["height", "width"], function(d, a) {
          f.cssHooks[a] = {
               get: function(d, b, c) {
                    if (b) {
                         return Rb.test(f.css(d, "display")) && 0 === d.offsetWidth ? f.swap(d, Tb, function() {
                              return da(d, a,
                                   c);
                         }) : da(d, a, c);
                    }
                    ...
                    var h = c && xa(d);
                    return v(d, b, c ? aa(d, a, c, u.boxSizing && "border-box" === f.css(d, "boxSizing", !1, h), h) : 0);
               },
          };
     });
     u.opacity || (f.cssHooks.opacity = {
          get: function(d, a) {
               return Qb.test((a && d.currentStyle ? d.currentStyle.filter : d.style.filter) || "") ? .01 *
                    parseFloat(RegExp.$1) + "" : a ? "1" : "";
          }, set: function(d, a) {
               var b = d.style, c = d.currentStyle, h = f.isNumeric(a) ? "alpha(opacity=" + 100 * a + ")" : "",
                    e = c && c.filter || b.filter || "";
               b.zoom = 1;
               if ((1 <= a || "" === a) && "" === f.trim(e.replace(ab, "")) && b.removeAttribute &&
     ...
     f.Tween = K;
     K.prototype = {
          constructor: K, init: function(d, a, b, c, h, e) {
               this.elem = d;
               this.prop = b;
               this.easing =
                    h || "swing";
               ...
               var a, b = K.propHooks[this.prop];
               this.pos = this.options.duration ? a = f.easing[this.easing](d, this.options.duration *
                    d, 0, 1, this.options.duration) : a = d;
     ...
     K.propHooks = {
          _default: {
               get: function(d) {
                    return null == d.elem[d.prop] || d.elem.style && null != d.elem.style[d.prop]
                         ? (d = f.css(d.elem, d.prop, "")) && "auto" !== d ? d : 0
                         : d.elem[d.prop];
               }, set: function(d) {
                    if (f.fx.step[d.prop]) {
                         f.fx.step[d.prop](d);
     ...
     K.propHooks.scrollTop = K.propHooks.scrollLeft = {
          set: function(d) {
               d.elem.nodeType &&
               d.elem.parentNode && (d.elem[d.prop] = d.now);
          },
     };
     f.easing = {
          linear: function(d) {
     ...
     f.fx.step = {};
     var Ca, Ra, Ub = /^(?:toggle|show|hide)$/, qb = new RegExp("^(?:([+-])=|)(" + Qa + ")([a-z%]*)$", "i"),
          Vb = /queueHooks$/, Ma = [function(d, a, b) {
               var c, h, e, m, g, k, l = this, y = {}, x = d.style, w = d.nodeType && ua(d), I = f._data(d, "fxshow");
               b.queue || (m = f._queueHooks(d, "fx"), null == m.unqueued &&
               (m.unqueued = 0, g = m.empty.fire, m.empty.fire = function() {
                    m.unqueued || g();
               }), m.unqueued++,
                    l.always(function() {
                         l.always(function() {
               ...
               1 === d.nodeType && ("height" in a || "width" in a) &&
               (b.overflow = [x.overflow, x.overflowX, x.overflowY], k = f.css(d, "display"), h = "none" === k
                    ? f._data(d, "olddisplay") || M(d.nodeName)
                    : k, "inline" === h && "none" === f.css(d, "float") &&
               (u.inlineBlockNeedsLayout && "inline" !== M(d.nodeName) ? x.zoom = 1 : x.display = "inline-block"));
               b.overflow && (x.overflow = "hidden", u.shrinkWrapBlocks() || l.always(function() {
               ...
               if (f.isEmptyObject(y)) {
                    ...
                    for (c in I
                         ...
                         : I = f._data(d, "fxshow", {}), e && (I.hidden = !w), w ? f(d).show() : l.done(function() {
                         f(d).hide();
                    }), l.done(function() {
                         var a;
                    ...
                    {
                         a = U(w ? I[c] : 0, c, l), c in I ||
                         (I[c] = a.start, w && (a.end = a.start, a.start = "width" === c || "height" === c ? 1 : 0));
                    }
               }
          }], Ia = {
               "*": [function(d, a) {
                    var b = this.createTween(d, a), c = b.cur(), h = qb.exec(a),
                         e = h && h[3] || (f.cssNumber[d] ? "" : "px"),
                         m = (f.cssNumber[d] || "px" !== e && +c) && qb.exec(f.css(b.elem, d)), g = 1, k = 20;
                    if (m && m[3] !== e) {
                         e = e || m[3];
                         h = h || [];
                         m = +c || 1;
                         ...
                         } while (g !== (g = b.cur() / c) && 1 !== g &&
                         --k);
                    }
                    h && (m = b.start = +m || +c || 0, b.unit = e, b.end = h[1] ? m + (h[1] + 1) * h[2] : +h[2]);
                    return b;
               }],
          };
     ...
     f.speed = function(d, a, b) {
          var c = d && "object" === typeof d ? f.extend({}, d) : {
               complete: b || !b && a || f.isFunction(d) && d,
               duration: d,
               easing: b && a || a && !f.isFunction(a) && a,
          };
          c.duration = f.fx.off ? 0 : "number" === typeof c.duration ? c.duration : c.duration in f.fx.speeds
     ...
     f.fn.extend({
          fadeTo: function(d, a, f, b) {
               ...
               var h = f.isEmptyObject(d), e = f.speed(a, b, c);
               a = function() {
               ...
               return this.each(function() {
                    var a = !0, h = null != d && d + "queueHooks", e = f.timers, m = f._data(this);
                    if (h) {
                         m[h] && m[h].stop && c(m[h]);
                    } else {
                         for (h in m) {
                    ...
                    for (h = e.length; h--;) {
                         e[h].elem !== this || null != d && e[h].queue !== d ||
               ...
               return this.each(function() {
                    var a,
                         b = f._data(this), c = b[d + "queue"];
                    a = b[d + "queueHooks"];
                    var h = f.timers, e = c ? c.length : 0;
                    b.finish = !0;
                    f.queue(this, d, []);
                    a && a.stop && a.stop.call(this, !0);
                    for (a = h.length; a--;) {
                         h[a].elem === this && h[a].queue === d &&
     ...
     f.each(["toggle", "show", "hide"], function(d, a) {
          ...
          f.fn[a] = function(d, f, c) {
               return null == d || "boolean" === typeof d ? b.apply(this, arguments) : this.animate(O(a, !0), d, f, c);
          };
     });
     f.each({
          slideDown: O("show"),
     ...
     f.fn.extend({
          val: function(a) {
               var b,
                    c, h, e = this[0];
               if (arguments.length) {
                    return h = f.isFunction(a), this.each(function(c) {
                         1 === this.nodeType &&
                         (c = h ? a.call(this, c, f(this).val()) : a, null == c ? c = "" : "number" === typeof c
                              ? c += ""
                              : f.isArray(c) && (c = f.map(c, function(a) {
                              return null == a ? "" : a + "";
                         })), b = f.valHooks[this.type] || f.valHooks[this.nodeName.toLowerCase()], b && "set" in b &&
                         void 0 !== b.set(this, c, "value") || (this.value = c));
                    });
               }
               if (e) {
                    if ((b = f.valHooks[e.type] || f.valHooks[e.nodeName.toLowerCase()]) && "get" in b && void 0 !==
                         (c = b.get(e, "value")))
                    {
                         return c;
                    }
                    c = e.value;
                    return "string" ===
                    typeof c ? c.replace(Wb, "") : null == c ? "" : c;
               }
          },
     });
     f.extend({
          valHooks: {
               option: {
                    ...
                    get: function(a) {
                         for (var b, c = a.options, h = a.selectedIndex, e = (a = "select-one" === a.type || 0 > h)
                              ? null
                              : [], m = a ? h + 1 : c.length, g = 0 > h ? m : a ? h : 0; g <
                         m; g++)
                         {
                              if (b = c[g], !(!b.selected && g !== h ||
                                   (u.optDisabled ? b.disabled : null !== b.getAttribute("disabled")) ||
                         ...
                         for (var c, h, e = a.options, m = f.makeArray(b), g = e.length; g--;) {
                              if (h = e[g], 0 <=
                              f.inArray(f.valHooks.option.get(h), m))
                              {
                                   try {
                                        h.selected = c = !0;
                                   } catch (k) {
     ...
     f.each(["radio", "checkbox"], function() {
          ...
          u.checkOn || (f.valHooks[this].get = function(a) {
               return null === a.getAttribute("value") ? "on" : a.value;
          });
     });
     var Ga, rb, va = f.expr.attrHandle, bb = /^(?:checked|selected)$/i,
          za = u.getSetAttribute, Sa = u.input;
     f.fn.extend({
          attr: function(a, b) {
     ...
     f.extend({
          attr: function(a, b, c) {
               var h, e, m = a.nodeType;
               if (a && 3 !== m && 8 !== m && 2 !== m) {
                    if ("undefined" === typeof a.getAttribute) {
                         return f.prop(a, b, c);
                    }
                    1 === m && f.isXMLDoc(a) ||
                    (b = b.toLowerCase(), h = f.attrHooks[b] || (f.expr.match.bool.test(b) ? rb : Ga));
                    if (void 0 !== c) {
                         if (null === c) {
                              f.removeAttr(a, b);
                         } else {
                              if (h && "set" in h && void 0 !== (e = h.set(a,
                                   c, b)))
                              {
                                   return e;
                              }
               ...
               var c, h, e = 0, m = b && b.match(ha);
               if (m && 1 === a.nodeType) {
                    for (; c = m[e++];) {
                         h = f.propFix[c] || c, f.expr.match.bool.test(c)
                              ? Sa && za || !bb.test(c) ? a[h] = !1 : a[f.camelCase("default-" + c)] = a[h] = !1
                              : f.attr(a, c, ""), a.removeAttribute(za ? c : h);
                    }
               }
          }, attrHooks: {
               type: {
     ...
     rb = {
          set: function(a, b, c) {
               !1 === b ? f.removeAttr(a, c) : Sa && za || !bb.test(c)
     ...
     f.each(f.expr.match.bool.source.match(/\w+/g), function(a, b) {
          ...
          va[b] = Sa && za || !bb.test(b) ? function(a, d, b) {
               var f, h;
               b || (h = va[d], va[d] = f, f = null != c(a, d, b) ? d.toLowerCase() : null, va[d] = h);
               return f;
          } : function(a, d, b) {
               if (!b) {
     ...
     }, va.id = va.name = va.coords = function(a, b, f) {
          var c;
          if (!f) {
     ...
     var Xb = /^(?:input|select|textarea|button|object)$/i, Yb = /^(?:a|area)$/i;
     f.fn.extend({
          prop: function(a, b) {
     ...
     f.extend({
          propFix: {"for": "htmlFor", "class": "className"}, prop: function(a, b, c) {
               ...
               if (a && 3 !== m && 8 !== m && 2 !== m) {
                    ...
                    return void 0 !== c ? e && "set" in e && void 0 !== (h = e.set(a, c, b)) ? h : a[b] = c : e &&
                    "get" in e && null !== (h = e.get(a, b)) ? h : a[b];
               }
          }, propHooks: {
               tabIndex: {
                    get: function(a) {
     ...
     f.fn.extend({
          addClass: function(a) {
               ...
               var b, c, h, e, m, g = 0, k = this.length;
               ...
               return "boolean" === typeof b && "string" === c
                    ...
                    : f.isFunction(a) ? this.each(function(c) {
                         ...
                         this.each(function() {
                              if ("string" === c) {
                                   for (var b, h = 0, e = f(this), m = a.match(ha) ||
                                        []; b = m[h++];)
                                   {
                                        e.hasClass(b)
                                             ? e.removeClass(b)
                                   ...
                                   this.className &&
                                   f._data(this, "__className__", this.className), this.className = this.className ||
                                   !1 ===
                                   a ? "" : f._data(this, "__className__") || "";
                              }
                         });
          }, hasClass: function(a) {
               a = " " + a + " ";
               for (var b = 0, f = this.length; b < f; b++) {
                    if (1 === this[b].nodeType && 0 <=
                         (" " + this[b].className + " ").replace(cb, " ").indexOf(a))
                    {
                         return !0;
                    }
               }
     ...
     f.parseJSON = function(d) {
          ...
          var b, c = null, h = f.trim(d + "");
          return h && !f.trim(h.replace(Zb, function(a, d, f, h) {
               b && d && (c = 0);
               if (0 === c) {
                    return a;
               }
               ...
               c += !h - !f;
               return "";
          })) ? Function("return " + h)() : f.error("Invalid JSON: " + d);
     };
     f.parseXML = function(d) {
          ...
          try {
               a.DOMParser
                    ...
                    : (b = new ActiveXObject("Microsoft.XMLDOM"), b.async = "false", b.loadXML(d));
          } catch (h) {
               b = void 0;
          }
          b && b.documentElement &&
          !b.getElementsByTagName("parsererror").length || f.error("Invalid XML: " + d);
          return b;
     };
     var Aa, wa, $b = /#.*$/, sb = /([?&])_=[^&]*/, ac = /^(.*?):[ \t]*([^\r\n]*)\r?$/mg, bc = /^(?:GET|HEAD)$/,
          cc = /^\/\//, tb = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, ub = {}, Wa = {},
     ...
     f.extend({
          active: 0, lastModified: {}, etag: {}, ajaxSettings: {
               ...
               return b ? S(S(a,
                    f.ajaxSettings), b) : S(f.ajaxSettings, a);
          }, ajaxPrefilter: w(ub), ajaxTransport: w(Wa), ajax: function(a, b) {
               function c(a, d, b, h) {
                    var e, n, y, x;
                    x = d;
                    if (2 !== ea) {
                         ...
                         if (b) {
                              y = w;
                              for (var Q = D, W, s, fa, P, Z = y.contents, ca = y.dataTypes; "*" ===
                              ca[0];)
                              {
                                   ca.shift(), void 0 === s &&
                         ...
                         a:{
                              ...
                              s = D;
                              fa = h;
                              var q, H, r, Q = {}, Z = b.dataTypes.slice();
                              if (Z[1]) {
                              ...
                              for (P = Z.shift(); P;) {
                                   if (b.responseFields[P] && (s[b.responseFields[P]] = W), !r &&
                                   fa && b.dataFilter && (W = b.dataFilter(W, b.dataType)), r = P, P = Z.shift())
                                   {
                                        if ("*" ===
                                             P)
                                        {
                         ...
                         if (h) {
                              w.ifModified && ((x = D.getResponseHeader("Last-Modified")) &&
                              (f.lastModified[m] = x), (x = D.getResponseHeader("etag")) && (f.etag[m] = x)), 204 ===
                              a ||
                              "HEAD" === w.type ? x = "nocontent" : 304 === a
                                   ? x = "notmodified"
                         ...
                         t.fireWith(I, [D, x]);
                         l && (X.trigger("ajaxComplete", [D, w]), --f.active || f.event.trigger("ajaxStop"));
                    }
               }
               
               "object" === typeof a && (b = a, a = void 0);
               b = b || {};
               var h, e, m, g, k, l, u, x, w = f.ajaxSetup({}, b), I = w.context || w,
                    X = w.context && (I.nodeType || I.jquery) ? f(I) : f.event, p = f.Deferred(),
                    t = f.Callbacks("once memory"), S = w.statusCode || {}, Q = {}, W = {}, ea = 0, s = "canceled",
                    D = {
               ...
               null == w.crossDomain &&
               (h = tb.exec(w.url.toLowerCase()), w.crossDomain = !(!h || h[1] === Aa[1] && h[2] === Aa[2] &&
                    (h[3] || ("http:" === h[1] ? "80" : "443")) === (Aa[3] || ("http:" === Aa[1] ? "80" : "443"))));
               w.data && w.processData && "string" !== typeof w.data && (w.data = f.param(w.data, w.traditional));
               y(ub, w, b, D);
               if (2 === ea) {
                    return D;
               }
               ...
               m = w.url;
               w.hasContent ||
               (w.data && (m = w.url += (eb.test(m) ? "&" : "?") + w.data, delete w.data), !1 === w.cache &&
               (w.url = sb.test(m) ? m.replace(sb, "$1_=" + db++) : m + (eb.test(m) ? "&" : "?") + "_=" + db++));
               w.ifModified &&
               (f.lastModified[m] && D.setRequestHeader("If-Modified-Since", f.lastModified[m]), f.etag[m] &&
               D.setRequestHeader("If-None-Match", f.etag[m]));
               (w.data && w.hasContent && !1 !== w.contentType || b.contentType) &&
               D.setRequestHeader("Content-Type", w.contentType);
               D.setRequestHeader("Accept", w.dataTypes[0] && w.accepts[w.dataTypes[0]] ? w.accepts[w.dataTypes[0]] +
                    ("*" !== w.dataTypes[0] ? ", " + vb + "; q=0.01" : "") : w.accepts["*"]);
               for (e in w.headers) {
               ...
               if (u = y(Wa, w, b, D)) {
                    ...
                    w.async && 0 < w.timeout && (k = setTimeout(function() {
                              D.abort("timeout");
                         },
                         w.timeout));
                    try {
     ...
     f._evalUrl = function(a) {
          return f.ajax({url: a, type: "GET", dataType: "script", async: !1, global: !1, "throws": !0});
     };
     f.fn.extend({
          wrapAll: function(a) {
               if (f.isFunction(a)) {
     ...
     f.expr.filters.hidden = function(a) {
          return 0 >= a.offsetWidth && 0 >= a.offsetHeight || !u.reliableHiddenOffsets() && "none" === (a.style &&
     ...
     f.fn.extend({
          serialize: function() {
               ...
               return this.map(function() {
                    ...
                    var a = this.type;
                    return this.name && !f(this).is(":disabled") && fc.test(this.nodeName) && !ec.test(a) &&
     ...
     f.ajaxSettings.xhr = void 0 !== a.ActiveXObject ? function() {
          var d;
          if (!(d = !this.isLocal && /^(get|post|head|put|delete|options)$/i.test(this.type) && fa())) {
               a:{
                    try {
     ...
     var gc = 0, Ta = {}, Ua = f.ajaxSettings.xhr();
     if (a.ActiveXObject) {
     ...
     (Ua = u.ajax = !!Ua) && f.ajaxTransport(function(a) {
          if (!a.crossDomain ||
               u.cors)
          {
               var b;
                    ...
                    send: function(c, h) {
                         ...
                         b = function(c, e) {
                              ...
                              if (b && (e || 4 === m.readyState)) {
                                   if (delete Ta[g], b = void 0, m.onreadystatechange =
                                        f.noop, e)
                                   {
                                        ...
                                        l = {};
                                        k = m.status;
                                        "string" === typeof m.responseText && (l.text = m.responseText);
                                        try {
                                             n = m.statusText;
                                        } catch (y) {
                                             n = "";
                                        }
                                        k || !a.isLocal || a.crossDomain ? 1223 === k && (k = 204) : k = l.text
                                             ? 200
                                             : 404;
                                   }
                              }
                         ...
                         a.async ? 4 === m.readyState ? setTimeout(b) : m.onreadystatechange = Ta[g] = b : b();
                    }, abort: function() {
                         b && b(void 0, !0);
                    },
               };
     ...
     f.ajaxTransport("script", function(a) {
          if (a.crossDomain) {
               var b, c = F.head || f("head")[0] || F.documentElement;
               return {
                    send: function(f, h) {
                         ...
                         b.onload = b.onreadystatechange = function(a, d) {
                              if (d || !b.readyState || /loaded|complete/.test(b.readyState)) {
                                   ...
                                   b.parentNode.removeChild(b), b = null, d || h(200, "success");
                              }
                         };
     ...
     f.ajaxPrefilter("json jsonp", function(d, b, c) {
          var h, e, m, g = !1 !== d.jsonp && (fb.test(d.url) ? "url" : "string" === typeof d.data &&
               !(d.contentType || "").indexOf("application/x-www-form-urlencoded") &&
               fb.test(d.data) && "data");
          if (g || "jsonp" === d.dataTypes[0]) {
               return h = d.jsonpCallback = f.isFunction(d.jsonpCallback)
                    ? d.jsonpCallback()
                    : d.jsonpCallback, g ? d[g] = d[g].replace(fb, "$1" + h) : !1 !== d.jsonp &&
                    (d.url += (eb.test(d.url) ? "&" : "?") + d.jsonp + "=" +
                         h), d.converters["script json"] = function() {
                    m || f.error(h + " was not called");
                    return m[0];
               }, d.dataTypes[0] = "json", e = a[h], a[h] = function() {
                    m = arguments;
               }, c.always(function() {
                    a[h] = e;
     ...
     f.fn.load = function(a, b, c) {
          ...
          var h, e, m, g = this, k = a.indexOf(" ");
          0 <= k && (h = f.trim(a.slice(k, a.length)), a = a.slice(0, k));
          f.isFunction(b) ? (c = b, b = void 0) : b && "object" === typeof b && (m =
               "POST");
          0 < g.length && f.ajax({url: a, type: m, dataType: "html", data: b}).done(function(a) {
               e = arguments;
     ...
     f.offset = {
          setOffset: function(a, b, c) {
               var h, e, m, g = f.css(a, "position"), k = f(a), l = {};
     ...
     f.fn.extend({
          offset: function(a) {
               ...
               var b, c, h = {top: 0, left: 0}, e = (c = this[0]) && c.ownerDocument;
               if (e) {
                    b = e.documentElement;
                    if (!f.contains(b, c)) {
                         return h;
                    }
                    "undefined" !== typeof c.getBoundingClientRect && (h = c.getBoundingClientRect());
                    c = ja(e);
                    return {
               ...
               if (this[0]) {
                    var a, b, c = {top: 0, left: 0}, h = this[0];
                    "fixed" === f.css(h, "position")
                         ? b = h.getBoundingClientRect()
                         : (a = this.offsetParent(), b = this.offset(), f.nodeName(a[0], "html") ||
                         (c = a.offset()), c.top += f.css(a[0], "borderTopWidth", !0), c.left += f.css(a[0],
                         "borderLeftWidth", !0));
                    return {
               ...
               return this.map(function() {
                    for (var a = this.offsetParent || zb; a && !f.nodeName(a, "html") && "static" ===
                    f.css(a, "position");)
                    {
                         a = a.offsetParent;
                    }
     ...
     f.each({scrollLeft: "pageXOffset", scrollTop: "pageYOffset"}, function(a, b) {
          var c = /Y/.test(b);
          f.fn[a] = function(h) {
               return sa(this, function(a, d, h) {
                    var e = ja(a);
                    if (void 0 === h) {
                         return e ? b in e ? e[b] : e.document.documentElement[d] :
                              a[d];
                    }
                    e ? e.scrollTo(c ? f(e).scrollLeft() : h, c ? h : f(e).scrollTop()) : a[d] = h;
     ...
     f.each({Height: "height", Width: "width"}, function(a, b) {
          f.each({padding: "inner" + a, content: b, "": "outer" + a}, function(c, h) {
               f.fn[h] = function(h, e) {
                    var m = arguments.length && (c || "boolean" !== typeof h),
                         g = c || (!0 === h || !0 === e ? "margin" : "border");
                    return sa(this, function(b, c,
                         h) {
                         return f.isWindow(b) ? b.document.documentElement["client" + a] : 9 === b.nodeType
                              ? (c = b.documentElement, Math.max(b.body["scroll" + a], c["scroll" +
                              a], b.body["offset" + a], c["offset" + a], c["client" + a]))
                              : void 0 === h ? f.css(b, c, g) : f.style(b, c, h, g);
                    }, b, m ? h : void 0, m, null);
               };
          });
     });
...
+function(a) {
     function q(b) {
          return this.each(function() {
               var c = a(this), g = c.data("bs.affix"), l = "object" == typeof b && b;
     ...
     r.prototype.getState = function(a, c, g, l) {
          var p = this.$target.scrollTop(), t = this.$element.offset(), k = this.$target.height();
          if (null != g && "top" == this.affixed) {
               return p < g ? "top" : !1;
          }
          if ("bottom" == this.affixed) {
               return null != g ? p + this.unpin <= t.top ? !1 : "bottom" : p + k <= a - l
                    ? !1
                    : "bottom";
          }
          var s = null == this.affixed, t = s ? p : t.top;
          return null != g && p <= g ? "top" : null != l && t + (s ? k : c) >= a - l ? "bottom" : !1;
     };
     ...
     r.prototype.checkPosition = function() {
          if (this.$element.is(":visible")) {
               var b = this.$element.height(), c = this.options.offset, g = c.top, l = c.bottom, p = a("body").height();
               ...
               if (this.affixed != c) {
                    ...
                    var g = "affix" + (c ? "-" + c : ""), t = a.Event(g + ".bs.affix");
...
+function(a) {
     ...
     q.prototype.close = function(c) {
          ...
          var e = a(this), g = e.attr("data-target");
          g || (g = (g = e.attr("href")) && g.replace(/.*(?=#[^\s]*$)/, ""));
          var l = a(g);
          c && c.preventDefault();
          l.length || (l = e.closest(".alert"));
          l.trigger(c = a.Event("close.bs.alert"));
          c.isDefaultPrevented() || (l.removeClass("in"), a.support.transition && l.hasClass("fade") ?
               l.one("bsTransitionEnd", b).emulateTransitionEnd(q.TRANSITION_DURATION) : b());
     };
     var r = a.fn.alert;
     a.fn.alert = function(c) {
          return this.each(function() {
               var b = a(this), e = b.data("bs.alert");
     ...
     a(document).on("click.bs.alert.data-api", '[data-dismiss="alert"]', q.prototype.close);
}(jQuery);
+function(a) {
     function q(b) {
          return this.each(function() {
               var c = a(this), g = c.data("bs.button"), l = "object" == typeof b && b;
     ...
     r.prototype.setState = function(b) {
          var c = this.$element, g = c.is("input") ? "val" : "html", l = c.data();
          b += "Text";
          ...
          setTimeout(a.proxy(function() {
               ...
               "loadingText" == b
                    ? (this.isLoading = !0, c.addClass("disabled").attr("disabled", "disabled"))
                    : this.isLoading && (this.isLoading = !1, c.removeClass("disabled").removeAttr("disabled"));
          }, this), 0);
     };
     r.prototype.toggle = function() {
          ...
          if (c.length) {
               ...
               "radio" == g.prop("type") &&
               (g.prop("checked") && this.$element.hasClass("active") ? a = !1 : c.find(".active").
                    removeClass("active"));
               a && g.prop("checked", !this.$element.hasClass("active")).trigger("change");
          } else {
...
+function(a) {
     function q(b) {
          return this.each(function() {
               var c = a(this), l = c.data("bs.carousel"),
     ...
     r.prototype.slide = function(b, c) {
          var l = this.$element.find(".item.active"), p = c || this.getItemForDirection(b, l), t = this.interval,
               k = "next" == b ? "left" : "right", s = this;
          if (p.hasClass("active")) {
               return this.sliding = !1;
          }
          var q = p[0], E = a.Event("slide.bs.carousel", {relatedTarget: q, direction: k});
          this.$element.trigger(E);
          if (!E.isDefaultPrevented()) {
               this.sliding = !0;
               t && this.pause();
               this.$indicators.length && (this.$indicators.find(".active").
                    removeClass("active"), (E = a(this.$indicators.children()[this.getItemIndex(p)])) &&
               E.addClass("active"));
               var C = a.Event("slid.bs.carousel", {relatedTarget: q, direction: k});
               a.support.transition && this.$element.hasClass("slide")
                    ? (p.addClass(b), p[0].offsetWidth, l.addClass(k), p.addClass(k), l.one("bsTransitionEnd", function() {
                    ...
                    : (l.removeClass("active"), p.addClass("active"), this.sliding = !1, this.$element.trigger(C));
               t && this.cycle();
               return this;
          }
     };
     ...
     var b = function(b) {
          var c, l = a(this), p = a(l.attr("data-target") || (c = l.attr("href")) && c.replace(/.*(?=#[^\s]+$)/, ""));
          if (p.hasClass("carousel")) {
               c =
                    a.extend({}, p.data(), l.data());
...
+function(a) {
     ...
     function r(b) {
          return this.each(function() {
               var g = a(this), l = g.data("bs.collapse"),
     ...
     c.prototype.show = function() {
          if (!this.transitioning && !this.$element.hasClass("in")) {
               ...
               if (!l.isDefaultPrevented()) {
                    ...
                    this.$element.one("bsTransitionEnd", a.proxy(b, this)).
                         emulateTransitionEnd(c.TRANSITION_DURATION)[p](this.$element[0][g]);
               }
          }
     };
     ...
     a(document).on("click.bs.collapse.data-api", '[data-toggle="collapse"]', function(b) {
          ...
          b = q(c);
          c = b.data("bs.collapse") ? "toggle" : a.extend({}, c.data(), {trigger: this});
          r.call(b, c);
     });
}(jQuery);
+function(a) {
     function q(b) {
          b && 3 === b.which || (a(".dropdown-backdrop").remove(), a('[data-toggle="dropdown"]').each(function() {
               var c = a(this), l = r(c), p = {relatedTarget: this};
               l.hasClass("open") && (l.trigger(b = a.Event("hide.bs.dropdown", p)), b.isDefaultPrevented() ||
               (c.attr("aria-expanded", "false"), l.removeClass("open").trigger("hidden.bs.dropdown", p)));
          }));
     }
     ...
     c.prototype.keydown = function(b) {
          if (/(38|40|27|32)/.test(b.which) && !/input|textarea/i.test(b.target.tagName)) {
               ...
               b.stopPropagation();
               if (!c.is(".disabled, :disabled")) {
                    var l = r(c), p = l.hasClass("open");
                    if (!p && 27 != b.which || p && 27 == b.which) {
                         return 27 == b.which &&
                         l.find('[data-toggle="dropdown"]').trigger("focus"), c.trigger("click");
                    }
                    c = l.find('[role="menu"] li:not(.divider):visible a, [role="listbox"] li:not(.divider):visible a');
                    c.length &&
                    (l = c.index(b.target), 38 == b.which && 0 < l && l--, 40 == b.which && l < c.length - 1 &&
                    l++, ~l || (l = 0), c.eq(l).trigger("focus"));
               }
          }
     };
     var b = a.fn.dropdown;
     a.fn.dropdown = function(b) {
          return this.each(function() {
               var g = a(this), l = g.data("bs.dropdown");
     ...
     a(document).
          on("click.bs.dropdown.data-api", q).
          on("click.bs.dropdown.data-api", ".dropdown form", function(a) {
               a.stopPropagation();
          }).
          on("click.bs.dropdown.data-api",
               '[data-toggle="dropdown"]', c.prototype.toggle).
          on("keydown.bs.dropdown.data-api", '[data-toggle="dropdown"]', c.prototype.keydown).
          on("keydown.bs.dropdown.data-api", '[role="menu"]', c.prototype.keydown).
          on("keydown.bs.dropdown.data-api", '[role="listbox"]', c.prototype.keydown);
}(jQuery);
+function(a) {
     function q(b, c) {
          return this.each(function() {
               var g = a(this), l = g.data("bs.modal"),
     ...
     r.prototype.show = function(b) {
          var c = this, g = a.Event("show.bs.modal", {relatedTarget: b});
          ...
          (this.isShown = !0, this.checkScrollbar(), this.setScrollbar(), this.$body.addClass("modal-open"), this.escape(), this.resize(), this.$element.on("click.dismiss.bs.modal",
               ...
               g ? c.$element.find(".modal-dialog").one("bsTransitionEnd", function() {
     ...
     r.prototype.hide = function(b) {
          ...
          this.$element.trigger(b);
          this.isShown && !b.isDefaultPrevented() && (this.isShown = !1, this.escape(), this.resize(), a(document).
               off("focusin.bs.modal"), this.$element.removeClass("in").
               attr("aria-hidden", !0).
               off("click.dismiss.bs.modal"), a.support.transition && this.$element.hasClass("fade")
     ...
     r.prototype.backdrop = function(b) {
          var c = this, g = this.$element.hasClass("fade") ? "fade" : "";
          if (this.isShown && this.options.backdrop) {
               var l =
                    a.support.transition && g;
               this.$backdrop = a('<div class="modal-backdrop ' + g + '" />').
               ...
               b &&
               (l ? this.$backdrop.one("bsTransitionEnd", b).emulateTransitionEnd(r.BACKDROP_TRANSITION_DURATION) : b());
          } else {
     ...
     a(document).on("click.bs.modal.data-api",
          '[data-toggle="modal"]', function(b) {
               var c = a(this), g = c.attr("href"),
                    l = a(c.attr("data-target") || g && g.replace(/.*(?=#[^\s]+$)/, "")),
                    g = l.data("bs.modal") ? "toggle" : a.extend({remote: !/#/.test(g) && g}, l.data(), c.data());
...
+function(a) {
          ...
          for (b = c.length; b--;) {
               if (e = c[b], "click" == e) {
                    this.$element.on("click." +
                         this.type, this.options.selector, a.proxy(this.toggle, this));
               } else if ("manual" != e) {
                    var g = "hover" == e ? "mouseleave" : "focusout";
                    this.$element.on(("hover" == e ? "mouseenter" : "focusin") + "." +
                         this.type, this.options.selector, a.proxy(this.enter, this));
                    this.$element.on(g +
     ...
     q.prototype.getOptions = function(c) {
          ...
          c.delay && "number" == typeof c.delay && (c.delay = {show: c.delay, hide: c.delay});
          return c;
     };
     q.prototype.getDelegateOptions = function() {
          var c = {}, b = this.getDefaults();
     ...
     q.prototype.enter = function(c) {
          var b = c instanceof this.constructor ? c : a(c.currentTarget).data("bs." + this.type);
          if (b && b.$tip && b.$tip.is(":visible")) {
               b.hoverState = "in";
          } else {
               b || (b = new this.constructor(c.currentTarget, this.getDelegateOptions()), a(c.currentTarget).
                    data("bs." + this.type, b));
     ...
     q.prototype.show = function() {
          ...
          if (this.hasContent() && this.enabled) {
               ...
               var b = a.contains(this.$element[0].ownerDocument.documentElement, this.$element[0]);
               if (!c.isDefaultPrevented() && b) {
                    var e = this, c = this.tip(), b = this.getUID(this.type);
                    this.setContent();
                    c.attr("id", b);
                    this.$element.attr("aria-describedby", b);
                    this.options.animation && c.addClass("fade");
                    var b = "function" == typeof this.options.placement
                         ? this.options.placement.call(this, c[0], this.$element[0])
                         : this.options.placement, g = /\s?auto?\s?/i, l = g.test(b);
                    l && (b = b.replace(g, "") || "top");
                    c.detach().css({top: 0, left: 0, display: "block"}).addClass(b).data("bs." +
                         this.type, this);
                    this.options.container ? c.appendTo(this.options.container) : c.insertAfter(this.$element);
                    var g = this.getPosition(), p = c[0].offsetWidth, t = c[0].offsetHeight;
                    if (l) {
                         var l = b, k = this.options.container ? a(this.options.container) : this.$element.parent(),
                              k = this.getPosition(k),
                              b = "bottom" == b && g.bottom + t > k.bottom ? "top" : "top" == b && g.top - t < k.top
                                   ? "bottom"
                                   : "right" == b && g.right + p > k.width ? "left" : "left" == b && g.left - p < k.left
                                        ? "right"
                                        : b;
                    ...
                    a.support.transition && this.$tip.hasClass("fade") ? c.one("bsTransitionEnd", b).
                         emulateTransitionEnd(q.TRANSITION_DURATION) : b();
               }
          }
     };
     q.prototype.applyPlacement = function(c, b) {
          var e = this.tip(), g = e[0].offsetWidth, l = e[0].offsetHeight, p = parseInt(e.css("margin-top"), 10),
          ...
          e.addClass("in");
          var t = e[0].offsetWidth, k = e[0].offsetHeight;
     ...
     q.prototype.hide = function(c) {
          ...
          var e = this, g = this.tip(), l = a.Event("hide.bs." + this.type);
          this.$element.trigger(l);
          if (!l.isDefaultPrevented()) {
               return g.removeClass("in"), a.support.transition && this.$tip.hasClass("fade")
     ...
     q.prototype.getPosition = function(c) {
          c = c || this.$element;
          var b = c[0], e = "BODY" == b.tagName, b = b.getBoundingClientRect();
          null == b.width && (b = a.extend({}, b, {width: b.right - b.left, height: b.bottom - b.top}));
          var g = e ? {top: 0, left: 0} : c.offset();
          c = {scroll: e ? document.documentElement.scrollTop || document.body.scrollTop : c.scrollTop()};
     ...
     q.prototype.getCalculatedOffset = function(a, b, e, g) {
          return "bottom" == a ? {top: b.top + b.height, left: b.left + b.width / 2 - e / 2} : "top" == a
               ? {top: b.top - g, left: b.left + b.width / 2 - e / 2}
               : "left" == a ? {top: b.top + b.height / 2 - g / 2, left: b.left - e} : {
     ...
     q.prototype.getViewportAdjustedDelta = function(a, b, e, g) {
          ...
          var p = this.options.viewport && this.options.viewport.padding || 0, t = this.getPosition(this.$viewport);
          /right|left/.test(a) ? (e = b.top - p - t.scroll, b = b.top + p - t.scroll + g, e < t.top
               ? l.top = t.top - e
               : b > t.top + t.height && (l.top = t.top + t.height - b)) : (g = b.left - p, b = b.left + p + e, g <
          t.left ? l.left = t.left - g : b > t.width && (l.left = t.left + t.width - b));
          return l;
     };
     ...
     q.prototype.toggle = function(c) {
          var b = this;
          c && (b = a(c.currentTarget).data("bs." +
               this.type), b ||
          (b = new this.constructor(c.currentTarget, this.getDelegateOptions()), a(c.currentTarget).
               data("bs." + this.type, b)));
     ...
     a.fn.tooltip = function(c) {
          return this.each(function() {
               var b = a(this), e = b.data("bs.tooltip"), g = "object" == typeof c && c;
               if (e || "destroy" != c) {
                    if (e || b.data("bs.tooltip", e = new q(this,
                         g)), "string" == typeof c)
                    {
                         e[c]();
                    }
...
+function(a) {
     ...
     q.prototype.setContent = function() {
          ...
          a.find(".popover-content").children().detach().end()[this.options.html ? "string" == typeof e
               ? "html"
               : "append" : "text"](e);
     ...
     a.fn.popover = function(c) {
          return this.each(function() {
               var b = a(this), e = b.data("bs.popover"), g = "object" == typeof c && c;
               if (e || "destroy" != c) {
                    if (e || b.data("bs.popover", e = new q(this, g)), "string" == typeof c) {
                         e[c]();
                    }
               }
          });
...
+function(a) {
     ...
     q.prototype.refresh = function() {
          ...
          this.$body.find(this.selector).map(function() {
               var g =
                    a(this), g = g.data("target") || g.attr("href"), p = /^#./.test(g) && a(g);
               return p && p.length && p.is(":visible") && [[p[b]().top + c, g]] || null;
          }).sort(function(a, b) {
               return a[0] - b[0];
          }).each(function() {
     ...
     q.prototype.process = function() {
          var a = this.$scrollElement.scrollTop() + this.options.offset, c = this.getScrollHeight(),
               g = this.options.offset + c - this.$scrollElement.height(), l = this.offsets, p = this.targets,
               t = this.activeTarget, k;
          this.scrollHeight != c && this.refresh();
          if (a >= g) {
               return t !=
                    (k = p[p.length - 1]) && this.activate(k);
          }
          if (t && a < l[0]) {
               return this.activeTarget = null, this.clear();
          }
          for (k = l.length; k--;) {
               t != p[k] && a >= l[k] && (!l[k + 1] || a <= l[k + 1]) && this.activate(p[k]);
          }
     };
     q.prototype.activate = function(b) {
          this.activeTarget = b;
          this.clear();
          b = a(this.selector + '[data-target="' + b + '"],' + this.selector + '[href="' + b + '"]').
               parents("li").
               addClass("active");
...
+function(a) {
     ...
     r.prototype.show = function() {
          var b = this.element, c = b.closest("ul:not(.dropdown-menu)"), l = b.data("target");
          l || (l = (l = b.attr("href")) && l.replace(/.*(?=#[^\s]*$)/, ""));
          if (!b.parent("li").hasClass("active")) {
               var p = c.find(".active:last a"), t = a.Event("hide.bs.tab", {relatedTarget: b[0]}),
                    k = a.Event("show.bs.tab", {relatedTarget: p[0]});
               p.trigger(t);
               b.trigger(k);
               k.isDefaultPrevented() || t.isDefaultPrevented() ||
               (l = a(l), this.activate(b.closest("li"), c), this.activate(l, l.parent(), function() {
     ...
     r.prototype.activate = function(b, c, l) {
          function p() {
               ...
               b.addClass("active").find('[data-toggle="tab"]').attr("aria-expanded",
                    !0);
          ...
          var t = c.find("> .active"),
               k = l && a.support.transition && (t.length && t.hasClass("fade") || !!c.find("> .fade").length);
          t.length && k ? t.one("bsTransitionEnd", p).emulateTransitionEnd(r.TRANSITION_DURATION) : p();
          t.removeClass("in");
     };
     var c = a.fn.tab;
     a.fn.tab = q;
...
(function(a) {
     function q(b, c) {
          ...
          this.$element = a(b);
          this.$element.hide();
          this.multiple = (this.isSelect = "SELECT" === b.tagName) && b.hasAttribute("multiple");
     ...
     var l = {
          ...
          }, freeInput: !0, addOnBlur: !0, maxTags: 10, maxChars: 20, confirmKeys: [13,
               32, 44, 91, 188], onTagExists: function(a, b) {
               b.hide().fadeIn();
          }, trimValue: !1, allowDuplicates: !1,
     };
     q.prototype = {
          constructor: q, add: function(c, e) {
               var g = this;
               if (!(g.options.maxTags && g.itemsArray.length >= g.options.maxTags || !1 !== c && !c)) {
                    ...
                    if (!c.toString().match(/^\s*$/)) {
                         g.isSelect && !g.multiple && 0 < g.itemsArray.length && g.remove(g.itemsArray[0]);
                         if ("string" === typeof c &&
                         ...
                         if (!l.cancel) {
                              c = l.item;
                              var q = g.options.itemValue(c), l = g.options.itemText(c), p = g.options.tagClass(c),
                                   r = a.grep(g.itemsArray, function(a) {
                                        return g.options.itemValue(a) === q;
                                   })[0];
                              r && !g.options.allowDuplicates ? g.options.onTagExists &&
                                   (l = a(".tag", g.$container).filter(function() {
                                        return a(this).data("item") ===
                                             r;
                                   }), g.options.onTagExists(c, l)) : g.items().toString().length + c.length + 1 >
                                   g.options.maxInputLength ||
                                   (g.itemsArray.push(c), p = a('<span class="tag ' + b(p) + '">' + b(l) +
                                        '<span data-role="remove"></span></span>'), p.data("item", c), g.findInputWrapper().
                                        before(p), p.after(" "), g.isSelect &&
                                   !a('option[value="' + encodeURIComponent(q) + '"]', g.$element)[0] &&
                                   (l = a("<option selected>" + b(l) +
                                        "</option>"), l.data("item", c), l.attr("value", q), g.$element.append(l)), e ||
                                   g.pushVal(), g.options.maxTags !== g.itemsArray.length &&
                                   g.items().toString().length !==
                                   g.options.maxInputLength ||
                                   g.$container.addClass("bootstrap-tagsinput-max"), g.$element.trigger(a.Event("itemAdded", {item: c})));
                         }
                    }
               }
          }, remove: function(b, c) {
               var e = this;
               e.objectItems && (b = "object" === typeof b ? a.grep(e.itemsArray, function(a) {
               ...
               a(".tag", c.$container).each(function() {
                    var e = a(this), g = e.data("item"), l = c.options.itemValue(g), p = c.options.itemText(g),
                    ...
                    c.isSelect && a("option", c.$element).filter(function() {
               ...
               if (k.options.typeahead) {
                    ...
                    k.$input.typeahead(a.extend({}, p, {
                         source: function(b, c) {
                              ...
                              var h = this.map = {}, m = p.source(b);
                              a.isFunction(m.success) ? m.success(e) :
                                   a.isFunction(m.then) ? m.then(e) : a.when(m).then(e);
                         }, updater: function(a) {
                              k.add(this.map[a]);
                         }, matcher: function(a) {
                              ...
                              return a.replace(new RegExp("(" + this.query + ")", "gi"), "<strong>$1</strong>");
                         },
                    }));
               }
               if (k.options.typeaheadjs) {
                    var q = k.options.typeaheadjs || {};
                    k.$input.typeahead(null, q).on("typeahead:selected", a.proxy(function(a, b) {
                         q.valueKey ? k.add(b[q.valueKey]) : k.add(b);
                         k.$input.typeahead("val",
                              "");
                    }, k));
               }
               k.$container.on("click", a.proxy(function(a) {
                    k.$element.attr("disabled") || k.$input.removeAttr("disabled");
                    k.$input.focus();
               }, k));
               if (k.options.addOnBlur && k.options.freeInput) {
                    k.$input.on("focusout", a.proxy(function(b) {
                         0 === a(".typeahead, .twitter-typeahead", k.$container).length &&
                         (k.add(k.$input.val()), k.$input.val(""));
                    }, k));
               }
               k.$container.on("keydown", "input", a.proxy(function(b) {
                    var c = a(b.target), g = k.findInputWrapper();
                    if (k.$element.attr("disabled")) {
                         ...
                         switch (b.which) {
                              ...
                              case 37:
                                   ...
                                   break;
                              case 39:
                                   b = g.next(), 0 === c.val().length && b[0] && (b.after(g), c.focus());
                         }
                         g = c.val().length;
                         Math.ceil(g / 5);
               ...
               k.$container.on("keyup", "input", a.proxy(function(b) {
                    var c = a(b.target), e = c.val().substr(0, c.val().length).trim(), h = k.options.maxChars &&
                         e.length >= k.options.maxChars;
                    k.options.freeInput && (g(b, k.options.confirmKeys) || h) &&
                    (k.add(h ? e.substr(0, k.options.maxChars) : e), c.val(""), b.preventDefault());
                    b = e.length;
                    Math.ceil(b / 5);
                    c.attr("size", Math.max(this.inputSize, b));
               }, k));
               k.$container.on("click", "[data-role=remove]", a.proxy(function(b) {
                    k.$element.attr("disabled") || k.remove(a(b.target).closest(".tag").data("item"));
               }, k));
               k.options.itemValue === l.itemValue &&
               ("INPUT" === k.$element[0].tagName ? k.add(k.$element.val()) : a("option", k.$element).each(function() {
                    k.add(a(this).attr("value"),
                         !0);
               }));
          }, destroy: function() {
     ...
     a.fn.tagsinput = function(b, c) {
          ...
          this.each(function() {
               ...
               g ? b || c ? void 0 !==
                    g[b] && (g = g[b](c), void 0 !== g && e.push(g)) : e.push(g) : (g = new q(this, b), a(this).
                    data("tagsinput", g), e.push(g), "SELECT" === this.tagName &&
               a("option", a(this)).attr("selected", "selected"), a(this).val(a(this).val()));
          });
...
(function(a) {
     ...
     function e(b, c) {
          ...
          var g = a(b).data(), k = {}, l, p = new RegExp("^" + c.toLowerCase() + "([A-Z])");
     ...
     var l = function() {
          ...
          this.focusDate = null;
          this.element = a(b);
          this.inputField = (this.isInput = this.element.is("input")) ? this.element : this.element.find("input");
          this.hasInput = (this.component = this.element.hasClass("date")
          ...
          this._buildEvents();
          this._attachEvents();
          this.isInline ? this.picker.addClass("datepicker-inline").appendTo(this.element) :
     ...
     p.prototype = {
          constructor: p, _resolveViewName: function(a, b) {
               return 0 === a || "days" === a || "month" === a ? 0 : 1 === a || "months" === a || "year" === a
                    ? 1
                    : 2 === a || "years" === a || "decade" === a ? 2 : 3 === a || "decades" === a || "century" === a
                         ? 3
                         : 4 === a || "centuries" === a || "millennium" === a ? 4 : b === q ? !1 : b;
          }, _check_template: function(b) {
               try {
                    return b === q || "" === b ? !1 : 0 >= (b.match(/[<>]/g) || []).length ? !0 : 0 < a(b).length;
               } catch (c) {
                    return !1;
               }
               ...
               !0 !== e.multidate && (e.multidate = Number(e.multidate) || !1, !1 !== e.multidate &&
               (e.multidate = Math.max(0, e.multidate)));
               e.multidateSeparator =
                    String(e.multidateSeparator);
               e.weekStart %= 7;
               e.weekEnd = (e.weekStart + 6) % 7;
               var g = z.parseFormat(e.format);
               -Infinity !== e.startDate && (e.startDate = e.startDate ? e.startDate instanceof Date
                    ? this._local_to_utc(this._zero_time(e.startDate))
                    : z.parseDate(e.startDate, g, e.language, e.assumeNearbyYear) : -Infinity);
               Infinity !== e.endDate && (e.endDate = e.endDate ? e.endDate instanceof Date
                    ? this._local_to_utc(this._zero_time(e.endDate))
                    : z.parseDate(e.endDate, g, e.language, e.assumeNearbyYear) : Infinity);
               ...
               a.isArray(e.datesDisabled) || (e.datesDisabled =
                    [e.datesDisabled]);
               ...
               if (k && "auto" !== k) {
                    if (1 === b.length) {
                         ...
                         k = a.grep(b, function(a) {
                              ...
                              e.orientation.x = k[0] || "auto", k = a.grep(b, function(a) {
                              return /^top|bottom$/.test(a);
                         }), e.orientation.y = k[0] || "auto";
                    }
               }
               e.defaultViewDate ? (b = e.defaultViewDate.year ||
                    (new Date).getFullYear(), e.defaultViewDate = r(b, e.defaultViewDate.month ||
                    0, e.defaultViewDate.day || 1)) : e.defaultViewDate = c();
          }, _events: [], _secondaryEvents: [], _applyEvents: function(a) {
               for (var b = 0, c, e, g; b < a.length; b++) {
                    c = a[b][0], 2 === a[b].length ? (e = q, g = a[b][1]) : 3 ===
                         a[b].length && (e = a[b][1], g = a[b][2]), c.on(g, e);
               }
          }, _unapplyEvents: function(a) {
               for (var b = 0,
                    c, e, g; b < a.length; b++)
               {
                    c = a[b][0], 2 === a[b].length ? (g = q, e = a[b][1]) : 3 ===
                         a[b].length && (g = a[b][1], e = a[b][2]), c.off(e, g);
               }
               ...
               this._events = this.isInput ? [[this.element, b]] : this.component && this.hasInput ? [[this.inputField,
                    b], [this.component, {
                    click: a.proxy(this.show,
                         this),
               ...
               this._secondaryEvents = [[this.picker, {click: a.proxy(this.click, this)}], [a(window), {
                    resize: a.proxy(this.place,
                         this),
               }], [a(document), {
                    mousedown: a.proxy(function(a) {
                         this.element.is(a.target) || this.element.find(a.target).length || this.picker.is(a.target) ||
                         this.picker.find(a.target).length || this.isInline || this.hide();
                    }, this),
               }]];
          ...
          _trigger: function(b, c) {
               var e = c || this.dates.get(-1), e = this._utc_to_local(e);
               this.element.trigger({
                    type: b,
                    date: e,
                    dates: a.map(this.dates, this._utc_to_local),
                    format: a.proxy(function(a, b) {
                         0 === arguments.length ? (a = this.dates.length - 1, b = this.o.format) : "string" ===
                              typeof a && (b = a, a = this.dates.length - 1);
                         b = b || this.o.format;
               ...
               if (!(this.inputField.prop("disabled") || this.inputField.prop("readonly") && !1 ===
                    this.o.enableOnReadonly))
               {
                    return this.isInline ||
                    this.picker.appendTo(this.o.container), this.place(), this.picker.show(), this._attachSecondaryEvents(), this._trigger("show"), (window.navigator.msMaxTouchPoints ||
                         "ontouchstart" in document) && this.o.disableTouchKeyboard && a(this.element).blur(), this;
               }
          }, hide: function() {
               ...
               var b =
                    a.isArray(arguments[0]) ? arguments[0] : arguments;
               this.update.apply(this, a.map(b, this._utc_to_local));
               this._trigger("changeDate");
               this.setValue();
               return this;
          }, setDate: b("setDates"), setUTCDate: b("setUTCDates"), remove: b("destroy"), setValue: function() {
          ...
          setDatesDisabled: function(a) {
               ...
               var b = this.picker.outerWidth(), c = this.picker.outerHeight(), e = a(this.o.container), g = e.width(),
                    k = "body" === this.o.container ? a(document).scrollTop() : e.scrollTop(), l = e.offset(), p = [];
               this.element.parents().each(function() {
                    var b = a(this).css("z-index");
                    "auto" !== b && 0 !== b && p.push(parseInt(b));
               });
               var e = Math.max.apply(Math, p) + this.o.zIndexOffset, q = this.component ?
                    this.component.parent().offset() : this.element.offset(),
                    r = this.component ? this.component.outerHeight(!0) : this.element.outerHeight(!1),
                    t = this.component ? this.component.outerWidth(!0) : this.element.outerWidth(!1),
                    s = q.left - l.left, l = q.top - l.top;
               "body" !== this.o.container && (l += k);
               this.picker.removeClass("datepicker-orient-top datepicker-orient-bottom datepicker-orient-right datepicker-orient-left");
               "auto" !== this.o.orientation.x ? (this.picker.addClass("datepicker-orient-" +
                    this.o.orientation.x), "right" === this.o.orientation.x &&
               (s -= b - t)) : 0 > q.left ? (this.picker.addClass("datepicker-orient-left"), s -= q.left - 10) : s + b >
               g
               ...
               l = "top" === b ? l - (c + parseInt(this.picker.css("padding-top"))) : l + r;
               this.o.rtl ? this.picker.css({top: l, right: g - (s + t), zIndex: e}) : this.picker.css({
                    top: l,
                    left: s,
                    zIndex: e,
               });
               ...
               var b = this.dates.copy(), c = [], e = !1;
               arguments.length ? (a.each(arguments, a.proxy(function(a, b) {
                    b instanceof Date && (b = this._local_to_utc(b));
                    c.push(b);
               }, this)), e = !0) : (c = (c = this.isInput ? this.element.val() : this.element.data("date") ||
                    this.inputField.val()) && this.o.multidate
                    ? c.split(this.o.multidateSeparator)
                    : [c], delete this.element.data().date);
               c = a.map(c, a.proxy(function(a) {
                    return z.parseDate(a, this.o.format, this.o.language, this.o.assumeNearbyYear);
               }, this));
               c = a.grep(c, a.proxy(function(a) {
                    return !this.dateWithinRange(a) ||
                         !a;
               }, this), !0);
               this.dates.replace(c);
               this.viewDate = this.dates.length ? new Date(this.dates.get(-1)) : this.viewDate < this.o.startDate
                    ? new Date(this.o.startDate)
                    : this.viewDate > this.o.endDate ? new Date(this.o.endDate) : this.o.defaultViewDate;
               e ? this.setValue() : c.length && String(b) !== String(this.dates) && this._trigger("changeDate");
               ...
               this.o.calendarWeeks && (this.picker.find(".datepicker-days .datepicker-switch").attr("colspan",
                    function(a, b) {
                         return parseInt(b) + 1;
                    }), c += '<th class="cw">&#160;</th>');
               for (; b < this.o.weekStart + 7;) {
                    c += '<th class="dow', -1 < a.inArray(b, this.o.daysOfWeekDisabled) &&
                    (c += " disabled"), c += '">' + C[this.o.language].daysMin[b++ % 7] + "</th>";
               }
               c += "</tr>";
               this.picker.find(".datepicker-days thead").append(c);
          }, fillMonths: function() {
               for (var a = this._utc_to_local(this.viewDate), b = "", c = 0; 12 > c;) {
                    var e = a && a.getMonth() === c
                         ? " focused"
                         : "",
                         b = b + ('<span class="month' + e + '">' + C[this.o.language].monthsShort[c++] + "</span>");
               }
          ...
          setRange: function(b) {
               ...
               var c = [], e = this.viewDate.getUTCFullYear(), g = this.viewDate.getUTCMonth(), k = new Date;
               b.getUTCFullYear() < e || b.getUTCFullYear() === e && b.getUTCMonth() < g
                    ? c.push("old")
                    : (b.getUTCFullYear() > e || b.getUTCFullYear() === e && b.getUTCMonth() > g) && c.push("new");
               this.focusDate && b.valueOf() === this.focusDate.valueOf() && c.push("focused");
               this.o.todayHighlight && b.getUTCFullYear() ===
               k.getFullYear() && b.getUTCMonth() === k.getMonth() && b.getUTCDate() === k.getDate() && c.push("today");
               ...
               this.range && (b > this.range[0] && b < this.range[this.range.length - 1] && c.push("range"), -1 !==
               a.inArray(b.valueOf(), this.range) && c.push("selected"), b.valueOf() === this.range[0] &&
               c.push("range-start"),
               ...
               k -= g;
               for (s = -1; 11 > s; s += 1) {
                    z = [c], C = null, -1 === s ? z.push("old") : 10 === s &&
                         z.push("new"), -1 !== a.inArray(k, p) && z.push("active"), (k < l || k > e) &&
                    z.push("disabled"), k ===
                    this.viewDate.getFullYear() && z.push("focused"), r !== a.noop &&
                    (v = r(new Date(k, 0, 1)), v === q ? v = {} : "boolean" === typeof v
                         ? v = {enabled: v}
                         : "string" ===
                         typeof v && (v = {classes: v}), !1 === v.enabled && z.push("disabled"), v.classes &&
                    (z = z.concat(v.classes.split(/\s+/))), v.tooltip && (C = v.tooltip)), t += '<span class="' +
                         z.join(" ") + '"' + (C ? ' title="' + C + '"' : "") + ">" + k + "</span>", k += g;
               }
               b.find("td").html(t);
          }, fill: function() {
               var b = new Date(this.viewDate), c = b.getUTCFullYear(), e = b.getUTCMonth(),
                    g = -Infinity !== this.o.startDate ? this.o.startDate.getUTCFullYear() :
                         -Infinity, k = -Infinity !== this.o.startDate ? this.o.startDate.getUTCMonth() : -Infinity,
                    l = Infinity !== this.o.endDate ? this.o.endDate.getUTCFullYear() : Infinity,
                    p = Infinity !== this.o.endDate ? this.o.endDate.getUTCMonth() : Infinity,
                    t = C[this.o.language].today || C.en.today || "", s = C[this.o.language].clear || C.en.clear || "",
                    N = C[this.o.language].titleFormat || C.en.titleFormat, A;
               if (!isNaN(c) && !isNaN(e)) {
                    this.picker.find(".datepicker-days .datepicker-switch").text(z.formatDate(b, N, this.o.language));
                    this.picker.find("tfoot .today").text(t).toggle(!1 !==
                         this.o.todayBtn);
                    ...
                    for (t = []; b.valueOf() < e;) {
                         if (b.getUTCDay() ===
                              this.o.weekStart && (t.push("<tr>"), this.o.calendarWeeks))
                         {
                              var s = new Date(+b + (this.o.weekStart - b.getUTCDay() - 7) % 7 * 864E5),
                                   s = new Date(Number(s) + (11 - s.getUTCDay()) % 7 * 864E5),
                                   L = new Date(Number(L = r(s.getUTCFullYear(), 0, 1)) + (11 - L.getUTCDay()) % 7 *
                                        864E5);
                         ...
                         (s = this.o.beforeShowDay(this._utc_to_local(b)), s === q ? s = {} : "boolean" === typeof s
                              ? s = {enabled: s}
                              : "string" === typeof s && (s = {classes: s}), !1 === s.enabled &&
                         N.push("disabled"), s.classes && (N = N.concat(s.classes.split(/\s+/))), s.tooltip &&
                         (A = s.tooltip));
                         N = a.isFunction(a.uniqueSort) ? a.uniqueSort(N) : a.unique(N);
                         t.push('<td class="' + N.join(" ") + '"' + (A ? ' title="' + A + '"' : "") + ">" +
                              b.getUTCDate() + "</td>");
                         A = null;
                    ...
                    var v = this.picker.find(".datepicker-months").find(".datepicker-switch").text(2 >
                    this.o.maxViewMode ? A : c).end().find("span").removeClass("active");
                    ...
                    if (this.o.beforeShowMonth !== a.noop) {
                         ...
                         a.each(v, function(b, e) {
                              ...
                              h === q ? h = {} : "boolean" === typeof h ? h = {enabled: h} : "string" === typeof h &&
                                   (h = {classes: h});
                              !1 !== h.enabled || a(e).hasClass("disabled") ||
                              a(e).addClass("disabled");
                              h.classes && a(e).addClass(h.classes);
                              h.tooltip && a(e).prop("title", h.tooltip);
                         });
                    }
                    this._fill_yearsView(".datepicker-years", "year", 10, 1, c, g, l, this.o.beforeShowYear);
                    this._fill_yearsView(".datepicker-decades", "decade", 100, 10, c, g, l, this.o.beforeShowDecade);
                    this._fill_yearsView(".datepicker-centuries", "century", 1E3, 100, c, g, l, this.o.beforeShowCentury);
               }
               ...
               if (this._allow_update) {
                    ...
                    switch (this.viewMode) {
                         case 0:
                              -Infinity !==
                              this.o.startDate && b <= this.o.startDate.getUTCFullYear() && a <=
                              this.o.startDate.getUTCMonth()
                                   ? this.picker.find(".prev").css({visibility: "hidden"})
                                   : this.picker.find(".prev").css({visibility: "visible"});
                              Infinity !== this.o.endDate && b >= this.o.endDate.getUTCFullYear() && a >=
                         ...
                         case 4:
                              ...
                              2 > this.o.maxViewMode
                                   ? this.picker.find(".prev").css({visibility: "hidden"})
                                   : this.picker.find(".prev").css({visibility: "visible"}), Infinity !==
                              this.o.endDate && b >= this.o.endDate.getUTCFullYear() || 2 > this.o.maxViewMode
                                   ? this.picker.find(".next").css({visibility: "hidden"})
                                   : this.picker.find(".next").css({visibility: "visible"});
                    }
               }
               ...
               0 < e.length && (e = z.modes[this.viewMode].navStep *
                    (e.hasClass("prev") ? -1 : 1), 0 === this.viewMode
                    ? (this.viewDate = this.moveMonth(this.viewDate, e), this._trigger("changeMonth", this.viewDate))
                    : (this.viewDate = this.moveYear(this.viewDate, e), 1 === this.viewMode &&
                    this._trigger("changeYear", this.viewDate)), this.fill());
               b.hasClass("today") && !b.hasClass("day") &&
               (this.showMode(-2), this._setDate(c(), "linked" === this.o.todayBtn ? null : "view"));
               b.hasClass("clear") && this.clearDates();
               !b.hasClass("disabled") &&
               (b.hasClass("day") && (e = parseInt(b.text(), 10) || 1, g = this.viewDate.getUTCFullYear(),
                    k = this.viewDate.getUTCMonth(), b.hasClass("old") &&
               (0 === k ? (k = 11, --g, p = l = !0) : (--k, l = !0)), b.hasClass("new") &&
               (11 === k ? (k = 0, g += 1, p = l = !0) : (k += 1, l = !0)), this._setDate(r(g, k, e)), p &&
               this._trigger("changeYear", this.viewDate), l &&
               this._trigger("changeMonth", this.viewDate)), b.hasClass("month") &&
               (this.viewDate.setUTCDate(1), e = 1, k = b.parent().
                    find("span").
                    index(b), g = this.viewDate.getUTCFullYear(), this.viewDate.setUTCMonth(k), this._trigger("changeMonth", this.viewDate), 1 ===
               this.o.minViewMode ? (this._setDate(r(g, k, e)),
                    this.showMode()) : this.showMode(-1), this.fill()), b.hasClass("year") || b.hasClass("decade") ||
               b.hasClass("century")) && (this.viewDate.setUTCDate(1), e = 1, k = 0, g = parseInt(b.text(), 10) ||
                    0, this.viewDate.setUTCFullYear(g), b.hasClass("year") &&
               (this._trigger("changeYear", this.viewDate), 2 === this.o.minViewMode &&
               this._setDate(r(g, k, e))), b.hasClass("decade") &&
               (this._trigger("changeDecade", this.viewDate), 3 === this.o.minViewMode &&
               this._setDate(r(g, k, e))), b.hasClass("century") && (this._trigger("changeCentury", this.viewDate),
               4 === this.o.minViewMode && this._setDate(r(g, k, e))), this.showMode(-1), this.fill());
               this.picker.is(":visible") && this._focused_from && a(this._focused_from).focus();
               delete this._focused_from;
          }, _toggle_multidate: function(a) {
               var b = this.dates.contains(a);
               a || this.dates.clear();
               -1 !== b ? (!0 === this.o.multidate || 1 < this.o.multidate || this.o.toggleActive) &&
                    this.dates.remove(b) : (!1 === this.o.multidate && this.dates.clear(), this.dates.push(a));
               if ("number" === typeof this.o.multidate) {
                    for (; this.dates.length >
                    this.o.multidate;)
                    {
                         this.dates.remove(0);
                    }
          ...
          _setDate: function(a, b) {
               ...
               var c = new Date(a.valueOf()), e = c.getUTCDate(), g = c.getUTCMonth(), k = Math.abs(b), l;
               b = 0 < b ? 1 : -1;
               if (1 === k) {
                    if (k = -1 === b ? function() {
                    ...
                    }, l = g + b, c.setUTCMonth(l), 0 > l || 11 < l)
                    {
                         l = (l + 12) % 12;
                    }
               } else {
               ...
               return this.weekOfDateIsDisabled(b) || 0 < a.grep(this.o.datesDisabled, function(a) {
                    return b.getUTCFullYear() === a.getUTCFullYear() && b.getUTCMonth() === a.getUTCMonth() &&
          ...
          keydown: function(a) {
               if (this.picker.is(":visible")) {
                    var b = !1, c, e, g = this.focusDate || this.viewDate;
                    switch (a.keyCode) {
                         case 27:
                              this.focusDate ? (this.focusDate = null, this.viewDate = this.dates.get(-1) ||
                                   this.viewDate, this.fill()) : this.hide();
                              a.preventDefault();
                              a.stopPropagation();
                              break;
                         case 37:
                         ...
                         case 40:
                              ...
                              if (0 === this.viewMode) {
                                   a.ctrlKey ? (e = this.moveAvailableDate(g, c, "moveYear")) &&
                                        this._trigger("changeYear",
                                             this.viewDate) : a.shiftKey
                              ...
                              e && (this.focusDate = this.viewDate =
                                   e, this.setValue(), this.fill(), a.preventDefault());
                              break;
                         case 13:
                              ...
                              break;
                         case 9:
                              this.focusDate = null, this.viewDate = this.dates.get(-1) ||
                                   this.viewDate, this.fill(), this.hide();
                    }
                    b &&
                    (this.dates.length ? this._trigger("changeDate") : this._trigger("clearDate"), this.inputField &&
          ...
          updateDates: function() {
               ...
               if (!this.updating) {
                    ...
                    if ("undefined" !== typeof c) {
                         ...
                         var c = b - 1, g = b + 1, k = this.inputs.length;
                         if (-1 !== b) {
     ...
     var k = a.fn.datepicker, s = function(b) {
          var c = Array.apply(null, arguments);
          c.shift();
          var k;
          this.each(function() {
               var l = a(this), q = l.data("datepicker"), s = "object" === typeof b && b;
               if (!q) {
                    var q = e(this, "date"), r = a.extend({}, L, q, s), r = g(r.language), s = a.extend({}, L, r, q, s);
                    l.hasClass("input-daterange") || s.inputs ? (a.extend(s, {
                         inputs: s.inputs || l.find("input").toArray(),
                    }), q = new t(this, s)) : q = new p(this, s);
                    l.data("datepicker", q);
               }
               "string" === typeof b && "function" === typeof q[b] && (k =
                    q[b].apply(q, c));
          });
          ...
          if (1 < this.length) {
               throw Error("Using only allowed for the collection of a single element (" + b +
                    " function)");
          }
          return k;
     };
     ...
     var C =
          ...
          modes: [{clsName: "days", navFnc: "Month", navStep: 1},
               {
                    clsName: "months", navFnc: "FullYear",
                    navStep: 1,
               },
          ...
          getDaysInMonth: function(a, b) {
               return [31, z.isLeapYear(a) ? 29 : 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31][b];
          },
          ...
          parseDate: function(b, e, g, k) {
               ...
               function s() {
                    var a = this.slice(0, T[A].length), b = T[A].slice(0, a.length);
               ...
               var t = /([\-+]\d+)([dmwy])/, T = b.match(/([\-+]\d+)([dmwy])/g),
                    M = {d: "moveDay", m: "moveMonth", w: "moveWeek", y: "moveYear"},
                    N = {yesterday: "-1d", today: "+0d", tomorrow: "+1d"}, A;
               if (/^[\-+]\d+[dmwy]([\s,]+[\-+]\d+[dmwy])*$/.test(b)) {
                    b = new Date;
                    for (A = 0; A <
                    T.length; A++)
                    {
                         e = t.exec(T[A]), g = parseInt(e[1]), e = M[e[2]], b = p.prototype[e](b, g);
                    }
                    return r(b.getUTCFullYear(), b.getUTCMonth(), b.getUTCDate());
               }
               if ("undefined" !== typeof N[b] &&
                    (b = N[b], T = b.match(/([\-+]\d+)([dmwy])/g), /^[\-+]\d+[dmwy]([\s,]+[\-+]\d+[dmwy])*$/.test(b)))
               {
                    b =
                         new Date;
                    for (A = 0; A <
               ...
               b = new Date;
               var t = {}, L = "yyyy yy M MM m mm d dd".split(" "), M = {
                    yyyy: function(a, b) {
               ...
               b = c();
               N = e.parts.slice();
               T.length !== N.length && (N = a(N).filter(function(b, c) {
                         ...
                         if (isNaN(v)) {
                              switch (e) {
                                   case "MM":
                                        ...
                                        break;
                                   case "M":
                                        v = a(C[g].monthsShort).filter(s), v = a.inArray(v[0], C[g].monthsShort) + 1;
                              }
                         }
                         t[e] = v;
                    }
                    for (A = 0; A < L.length; A++) {
                         e = L[A], e in t && !isNaN(t[e]) &&
          ...
          formatDate: function(b, c, e) {
               ...
               e.mm = (10 > e.m ? "0" : "") + e.m;
               b = [];
               for (var g = a.extend([], c.separators),
                    k = 0, l = c.parts.length; k <= l; k++)
               {
     ...
     z.template = '<div class="datepicker"><div class="datepicker-days"><table class="table-condensed">' +
          z.headTemplate + "<tbody></tbody>" + z.footTemplate +
          '</table></div><div class="datepicker-months"><table class="table-condensed">' + z.headTemplate +
          z.contTemplate + z.footTemplate +
          '</table></div><div class="datepicker-years"><table class="table-condensed">' + z.headTemplate +
          z.contTemplate + z.footTemplate +
          '</table></div><div class="datepicker-decades"><table class="table-condensed">' + z.headTemplate +
          z.contTemplate + z.footTemplate +
          '</table></div><div class="datepicker-centuries"><table class="table-condensed">' +
          z.headTemplate + z.contTemplate + z.footTemplate + "</table></div></div>";
...
(function(a) {
     ...
     "function" !== typeof Array.prototype.filter && (Array.prototype.filter = function(a) {
          for (var b = Object(this),
               c = b.length >>> 0, e = [], g = 2 <= arguments.length ? arguments[1] : void 0, h = 0; h <
          c; h++)
          {
               if (h in b) {
                    var k = b[h];
     ...
     Array.prototype.map || (Array.prototype.map = function(a, b) {
          ...
          var h = Object(this), k = h.length >>> 0;
     ...
     var q = "function" ===
          typeof define && define.amd, r = navigator.userAgent, c = /MSIE|Trident/i.test(r), b;
     if (c) {
          var e = /MSIE (\d+[.]\d+)/.exec(r);
          e && (b = parseFloat(e[1]));
          (e = /Trident\/.*rv:([0-9]{1,}[\.0-9]{0,})/.exec(r)) && (b = parseFloat(e[1]));
     }
     var g = {
          ...
          isFontInstalled: function(b) {
               var c =
                    "Comic Sans MS" === b ? "Courier New" : "Comic Sans MS", e = a("<div>").
                    css({position: "absolute", left: "-9999px", top: "-9999px", fontSize: "200px"}).
                    text("mmmmmmmmmwwwwwww").
                    appendTo(document.body), g = e.css("fontFamily", c).width();
          ...
          return {
               head: function(a) {
                    return a[0];
               }, last: b, initial: function(a) {
                    return a.slice(0, a.length - 1);
               }, tail: c, prev: function(b, c) {
                    var e = a.inArray(c, b);
                    ...
                    return a.length ? c(a).reduce(function(a, c) {
                         var g = b(a);
     ...
     }(), t = String.fromCharCode(160), k = function() {
          var b = function(b) {
                    ...
                    var e = b.data("options"), e = e && e.dialogsInBody ? a(document.body) : null;
                    return {
                         editor: function() {
                              return b;
                         },
                    ...
                    a = a.toUpperCase();
                    return function(b) {
                         return b && b.nodeName.toUpperCase() ===
                              a;
                    };
               }, h = function(a) {
               ...
               }, s = e("LI"), r = e("TABLE"), J = function(a) {
                    return !W(a) && !Z(a) && !ca(a) && !q(a) && !r(a) && !D(a);
               }, Z = function(a) {
                    return a && /^UL|^OL/.test(a.nodeName.toUpperCase());
               }, ca = e("HR"), ma = function(a) {
                    return a && /^TD|^TH/.test(a.nodeName.toUpperCase());
               }, D = e("BLOCKQUOTE"), W = function(a) {
                    return ma(a) || D(a) || b(a);
               },
               ka = e("A"), I = e("BODY"), u = e("PRE"), f = e("CODE"),
               z = g.isMSIE && 11 > g.browserVersion ? "&nbsp;" : "<br>", v = function(a) {
                    return h(a) ? a.nodeValue.length : a.childNodes.length;
               }, Q = function(a) {
                    var b = v(a);
                    return 0 === b || !h(a) && 1 === b && a.innerHTML === z || p.all(a.childNodes, h) && "" === a.innerHTML
                         ? !0
                         : !1;
               }, R = function(a, c) {
                    for (; a;) {
                    ...
                    var c = b.nextSibling, f = b.parentNode;
                    ...
                    if (0 === a.offset) {
                         ...
                         K(a.node) ? (f = a.node.childNodes[a.offset - 1], e = v(f)) : (f = a.node, e = c ? 0 : a.offset -
                              1);
                    }
                    ...
                    if (v(a.node) === a.offset) {
                         ...
                         K(a.node) ? (f = a.node.childNodes[a.offset], e = 0) : (f = a.node, e = c ? v(a.node) : a.offset +
                              1);
                    }
                    return {node: f, offset: e};
               }, U = function(a, b) {
                    ...
                    var c = b && b.isSkipPaddingBlankHTML, f = b && b.isNotSplitEdgePoint;
                    if (L(a) && (h(a.node) || f)) {
                         if (N(a)) {
                              return a.node;
                         }
                    ...
                    var e = a.node.childNodes[a.offset], f = A(a.node.cloneNode(!1), a.node);
                    T(f, H(e));
                    c || (c = a.node, m(c) || v(c) || (c.innerHTML = z), m(f) || v(f) || (f.innerHTML = z));
                    return f;
               }, ia = function(a, b, c) {
                    a = V(b.node, l.eq(a));
                    return a.length ?
                         1 === a.length ? da(b, c) : a.reduce(function(a, f) {
                              a === b.node && (a = da(b, c));
          ...
          return {
               ...
               makeLayoutInfo: function(b) {
                    ...
                    b = b.is(".note-editor, .note-air-editor") ? b : a("#note-editor-" +
                         p.last(b.attr("id").split("-")));
                    return c(b);
               },
               isText: h,
               isVoid: m,
               ...
               isClosestSibling: function(a, b) {
                    return a.nextSibling === b || a.previousSibling ===
                         b;
               },
               withClosestSiblings: function(a, b) {
                    b = b || l.ok;
                    var c = [];
                    a.previousSibling && b(a.previousSibling) && c.push(a.previousSibling);
                    c.push(a);
               ...
               isCharPoint: function(a) {
                    return h(a.node) ? (a = a.node.nodeValue.charAt(a.offset - 1)) && " " !== a && a !== t : !1;
               },
               ...
               ancestor: R,
               singleChildAncestor: function(a,
                    c) {
               ...
               splitPoint: function(a, b) {
                    var c = b ? q : W, f = V(a.node,
                         c), e = p.last(f) || a.node;
                    c(e) ? c = f[f.length - 2] : (c = e, e = c.parentNode);
                    (c = c && ia(c, a, {isSkipPaddingBlankHTML: b, isNotSplitEdgePoint: b})) || e !== a.node ||
               ...
               html: function(b, c) {
                    var f = Ba(b);
                    c && (f = f.replace(/<(\/?)(\b(?!!)[^>\s]*)(.*?)(\s*\/?>)/g, function(a, b, c) {
                         c = c.toUpperCase();
          ...
          var b = function(a, b) {
                    var c = a.parentElement(), e, g = document.body.createTextRange(), h, l = p.from(c.childNodes);
                    ...
                    if (0 !== e && k.isText(l[e - 1])) {
                         ...
                         for (h = c.text.replace(/[\r\n]/g, "").length; h > e.nodeValue.length &&
                         e.nextSibling;)
                         {
                              h -= e.nodeValue.length, e = e.nextSibling;
                         }
                         b && e.nextSibling && k.isText(e.nextSibling) && h === e.nodeValue.length &&
                         (h -= e.nodeValue.length, e = e.nextSibling);
                         c = e;
                         e = h;
                    }
               ...
               c = function(a) {
                    ...
                    this.normalize = function() {
                         var a = function(a, b) {
                              if (k.isVisiblePoint(a) && !k.isEdgePoint(a) || k.isVisiblePoint(a) && k.isRightEdgePoint(a) &&
                                   !b || k.isVisiblePoint(a) && k.isLeftEdgePoint(a) && b || k.isVisiblePoint(a) &&
                                   k.isBlock(a.node) && k.isEmpty(a.node))
                              {
                                   return a;
                              }
                              var c = k.ancestor(a.node, k.isBlock);
                              if ((k.isLeftEdgePointOf(a, c) || k.isVoid(k.prevPoint(a).node)) && !b ||
                                   (k.isRightEdgePointOf(a, c) || k.isVoid(k.nextPoint(a).node)) && b)
                              {
                              ...
                              return (b ? k.nextPointUntil(k.nextPoint(a),
                                   k.isVisiblePoint) : k.prevPointUntil(k.prevPoint(a), k.isVisiblePoint)) || a;
                         }, b = a(this.getEndPoint(), !1), a = this.isCollapsed() ? b : a(this.getStartPoint(), !0);
                         return new e(a.node, a.offset, b.node, b.offset);
                    };
                    this.nodes = function(a, b) {
                         a = a || l.ok;
                         var c = b && b.includeAncestor, e = b && b.fullyContains, g = this.getStartPoint(),
                              h = this.getEndPoint(), m = [], u = [];
                         k.walkPoint(g, h, function(b) {
                              if (!k.isEditable(b.node)) {
                                   var g;
                                   e ? (k.isLeftEdgePoint(b) && u.push(b.node), k.isRightEdgePoint(b) &&
                                   p.contains(u, b.node) && (g = b.node)) : g = c ? k.ancestor(b.node,
                                        a) : b.node;
                                   g && a(g) && m.push(g);
                              }
                         }, !0);
                    ...
                    this.splitText = function() {
                         var a = b === m, c = this.getPoints();
                         k.isText(m) && !k.isEdgePoint(this.getEndPoint()) && m.splitText(q);
                         k.isText(b) && !k.isEdgePoint(this.getStartPoint()) &&
                         (c.sc = b.splitText(h), c.so = 0, a && (c.ec = c.sc, c.eo = q - h));
                    ...
                    this.deleteContents = function() {
                         ...
                         return (new e(g.node,
                              g.offset, g.node, g.offset)).normalize();
                    };
                    var t = function(a) {
                         return function() {
                              var c = k.ancestor(b, a);
                    ...
                    this.isLeftEdgeOf = function(a) {
                         return k.isLeftEdgePoint(this.getStartPoint()) ? (a = k.ancestor(this.sc, a)) &&
                              k.isLeftEdgeOf(this.sc, a) : !1;
                    };
                    ...
                    this.wrapBodyInlineWithPara = function() {
                         if (k.isBodyContainer(b) && k.isEmpty(b)) {
                              return b.innerHTML =
                                   k.emptyPara, new e(b.firstChild, 0, b.firstChild, 0);
                         }
                         ...
                         a.length && (c = k.wrap(p.head(a), "p"), k.appendChildNodes(c, p.tail(a)));
                    ...
                    this.insertNode = function(a) {
                         ...
                         b.rightNode ? b.rightNode.parentNode.insertBefore(a, b.rightNode) : b.container.appendChild(a);
                         return a;
                    };
                    ...
                    this.getWordRange = function(a) {
                         ...
                         a && (b = k.nextPointUntil(b, function(a) {
                              return !k.isCharPoint(a);
                         }));
                         return new e(c.node, c.offset, b.node, b.offset);
                    };
                    this.bookmark = function(a) {
                         return {s: {path: k.makeOffsetPath(a, b), offset: h}, e: {path: k.makeOffsetPath(a, m), offset: q}};
                    };
          ...
          return {
               create: function(a, c, h, l) {
                    if (arguments.length) {
                         ...
                         var x = document.selection.createRange(), m = x.duplicate();
                         m.collapse(!1);
                         x.collapse(!0);
                         x = b(x, !0);
                         m = b(m, !1);
                         k.isText(x.node) && k.isLeftEdgePoint(x) && k.isTextNode(m.node) && k.isRightEdgePoint(m) &&
                         m.node.nextSibling === x.node && (x = m);
                         a = x.cont;
                         c = x.offset;
                         h = m.cont;
                         l = m.offset;
                    ...
                    var b = a, c = 0, e = k.nodeLength(a);
                    k.isVoid(b) && (c = k.listPrev(b).length - 1, b = b.parentNode);
                    k.isBR(a) ? (e = k.listPrev(a).length - 1, a = a.parentNode) : k.isVoid(a) &&
                         (e = k.listPrev(a).length, a = a.parentNode);
               ...
               }, createFromBookmark: function(a,
                    b) {
                    var c = k.fromOffsetPath(a, b.s.path), g = b.s.offset, h = k.fromOffsetPath(a, b.e.path);
                    return new e(c, g, h, b.e.offset);
               }, createFromParaBookmark: function(a, b) {
                    var c = a.s.offset, g = a.e.offset, h = k.fromOffsetPath(p.head(b), a.s.path),
          ...
          var b = [], c = -1, e = a[0], g = function() {
               var b = s.create(), c = {s: {path: [], offset: 0}, e: {path: [], offset: 0}};
          ...
          this.fromNode = function(a) {
               a = b(a, ["font-family", "font-size", "text-align", "list-style-type", "line-height"]) || {};
          ...
          this.styleNodes = function(b, c) {
               b = b.splitText();
               var e = c && c.nodeName || "SPAN", g = !(!c || !c.expandClosestSibling),
                    h = !(!c || !c.onlyPartialContains);
               if (b.isCollapsed()) {
                    return [b.insertNode(k.create(e))];
               }
               var m = k.makePredByNodeName(e), q = b.nodes(k.isText, {fullyContains: !0}).map(function(a) {
                    return k.singleChildAncestor(a, m) || k.wrap(a, e);
               });
               if (g) {
                    if (h) {
                         var s = b.nodes(), m = l.and(m, function(a) {
                              return p.contains(s, a);
                         });
                    }
                    return q.map(function(b) {
                         b =
                              k.withClosestSiblings(b, m);
                         var c = p.head(b), e = p.tail(b);
                         a.each(e, function(a, b) {
          ...
          this.current = function(b) {
               var c = a(k.isText(b.sc) ? b.sc.parentNode : b.sc), c = this.fromNode(c);
               c["font-bold"] = document.queryCommandState("bold") ? "bold" : "normal";
               c["font-italic"] = document.queryCommandState("italic") ? "italic" : "normal";
               c["font-underline"] = document.queryCommandState("underline") ? "underline" : "normal";
               c["font-strikethrough"] = document.queryCommandState("strikeThrough") ?
                    "strikethrough" : "normal";
               c["font-superscript"] = document.queryCommandState("superscript") ? "superscript" : "normal";
               c["font-subscript"] = document.queryCommandState("subscript") ? "subscript" : "normal";
               if (b.isOnList()) {
                    var e = -1 < a.inArray(c["list-style-type"], ["circle", "disc", "disc-leading-zero", "square"]);
               ...
               (e = k.ancestor(b.sc, k.isPara)) && e.style["line-height"]
                    ...
                    : (e = parseInt(c["line-height"], 10) / parseInt(c["font-size"],
                    10), c["line-height"] = e.toFixed(1));
          ...
          this.indent = function() {
               var b = this, c = s.create().wrapBodyInlineWithPara(), e = c.nodes(k.isPara, {includeAncestor: !0}),
                    e = p.clusterBy(e, l.peq2("parentNode"));
               a.each(e, function(c, e) {
                    var g = p.head(e);
                    k.isLi(g) ? b.wrapList(e, g.parentNode.nodeName) :
          ...
          this.outdent = function() {
               ...
               a.each(e, function(c, e) {
                    var g = p.head(e);
                    k.isLi(g) ? b.releaseList([e]) : a.each(e, function(b, c) {
                         a(c).css("marginLeft", function(a, b) {
                              b = parseInt(b, 10) || 0;
                              return 25 < b ? b - 25 : "";
                         });
          ...
          this.toggleList = function(b) {
               var c = this, e = s.create().wrapBodyInlineWithPara(),
                    g = e.nodes(k.isPara, {includeAncestor: !0}), h = e.paraBookmark(g),
               ...
               if (p.find(g, k.isPurePara)) {
                    ...
                    }), e.length ? a.each(e, function(a, c) {
                         k.replace(c, b);
          ...
          this.wrapList = function(a, b) {
               var c = p.head(a), e = p.last(a), g = k.isList(c.previousSibling) && c.previousSibling,
                    c = k.isList(e.nextSibling) && e.nextSibling, e = g || k.insertAfter(k.create(b || "UL"), e);
               a = a.map(function(a) {
          ...
          this.releaseList = function(b, c) {
               ...
               a.each(b, function(b, g) {
                    var h = p.head(g), l = p.last(g), m = c ? k.lastAncestor(h, k.isList) : h.parentNode,
                         l = 1 < m.childNodes.length ? k.splitTree(m, {
                              node: l.parentNode,
                              offset: k.position(l) + 1,
                         }, {isSkipPaddingBlankHTML: !0}) : null, h = k.splitTree(m,
                         {node: h.parentNode, offset: k.position(h)}, {isSkipPaddingBlankHTML: !0});
                    g = c ? k.listDescendant(h, k.isLi) : p.from(h.childNodes).filter(k.isLi);
          ...
          this.insertParagraph = function() {
               var c = s.create(), c = c.deleteContents(), c = c.wrapBodyInlineWithPara(),
                    e = k.ancestor(c.sc, k.isPara), g;
               if (e) {
                    ...
                    e = c.sc.childNodes[c.so],
                         g = a(k.emptyPara)[0], e ? c.sc.insertBefore(g, e) : c.sc.appendChild(g);
               }
               s.create(g, 0).normalize().select();
          };
     }, Q = function() {
          this.tab = function(a, b) {
               var c = k.ancestor(a.commonAncestor(), k.isCell), e = k.ancestor(c, k.isTable),
          ...
          this.createTable = function(b, c) {
               ...
               e = g.join("");
               return a('<table class="table table-bordered">' +
                    e + "</table>")[0];
          };
     }, H = function(b) {
          var c = this, e = new z, l = new Q, q = new m, t = new h;
          ...
          this.restoreNode = function(a) {
               a.html("");
               for (var b =
                    a.data("childNodes"), c = 0, e = b.length; c < e; c++)
               {
                    a[0].appendChild(b[c]);
               }
          };
          this.currentStyle = function(a) {
               var b = s.create(), b = b && b.isOnEditable() ? e.current(b.normalize()) : {};
               k.isImg(a) && (b.image = a);
               return b;
          };
          ...
          for (var J = this.beforeCommand = function(a) {
               r(a);
               c.focus(a);
          }, v = this.afterCommand = function(a, b) {
               a.data("NoteHistory").recordUndo();
               b || D(a);
          }, ca = "bold italic underline strikethrough superscript subscript justifyLeft justifyCenter justifyRight justifyFull formatBlock removeFormat backColor foreColor fontName".split(" "), R = 0, V = ca.length; R <
          V; R++)
          {
          ...
          this.tab = function(a, b) {
               ...
               c.isCollapsed() && c.isOnCell() ? l.tab(c) : (J(a), q.insertTab(a, c, b.tabsize), v(a));
          };
          ...
          this.fontSize = function(b, c) {
               var g = s.create();
               if (g.isCollapsed()) {
                    var g = e.styleNodes(g), h = p.head(g);
                    a(g).css({"font-size": c + "px"});
                    h && !k.nodeLength(h) && (h.innerHTML = k.ZERO_WIDTH_NBSP_CHAR, s.createFromNodeAfter(h.firstChild).
                         select(), b.data("bogus", h));
               } else {
          ...
          this.removeBogus = function(a) {
               var b = a.data("bogus");
               if (b) {
                    var c = p.find(p.from(b.childNodes),
                         k.isText), e = c.nodeValue.indexOf(k.ZERO_WIDTH_NBSP_CHAR);
          ...
          this.unlink = function(a) {
               ...
               b.isOnAnchor() &&
               (b = k.ancestor(b.sc, k.isAnchor), b = s.createFromNode(b), b.select(), J(a), document.execCommand("unlink"), v(a));
          };
          this.createLink = function(b, c, g) {
               var h = c.url, f = c.text;
               ...
               g = [];
               l ? (f = c.insertNode(a("<A>" + f + "</A>")[0]), g.push(f)) : g = e.styleNodes(c, {
                    nodeName: "A",
          ...
          this.color = function(a, b) {
               var c = JSON.parse(b), e = c.foreColor, c = c.backColor;
               J(a);
          ...
          this.focus = function(a) {
               a.focus();
               g.isFF && !s.create().isOnEditable() && s.createFromNode(a[0]).normalize().collapse().select();
          };
          ...
          this.update = function(b, c) {
               var e = function(b, c) {
                    b.find(".dropdown-menu li a").each(function() {
                         this.className = a(this).data("value") + "" === c + "" ? "checked" : "";
                    });
               }, h = function(a, c) {
               ...
               if (c.image) {
                    var k = a(c.image);
                    h('button[data-event="imageShape"][data-value="img-rounded"]', function() {
                         return k.hasClass("img-rounded");
                    });
                    h('button[data-event="imageShape"][data-value="img-circle"]', function() {
                         return k.hasClass("img-circle");
                    });
                    h('button[data-event="imageShape"][data-value="img-thumbnail"]', function() {
                    ...
                    if (p.length) {
                         var q =
                              c["font-family"];
                         if (q) {
                              for (var t = q.split(","), s = 0, r = t.length; s < r && (q = t[s].replace(/[\'\"]/g, "").
                                   replace(/\s+$/, "").
                                   replace(/^\s+/, ""), !g.isFontInstalled(q)); s++)
                              {
                                   ;
                              }
                    ...
                    h('button[data-event="justifyCenter"]',
                         function() {
          ...
          var c = function(a) {
               a.preventDefault();
               a.stopPropagation();
               var c = k.makeLayoutInfo(a.target).editable(), e = c.offset().top - b.scrollTop(),
          ...
          var b = new D, c = function(b, c) {
               var e = c && c.isAirMode, g = c && c.isLeftTop, h = a(b), e = e ? h.offset() :
                    h.position(), g = g ? 0 : h.outerHeight(!0);
          ...
          this.update = function(g, h, k) {
               ...
               if (h.anchor) {
                    var q = m.find("a"), s = a(h.anchor).attr("href"), t = a(h.anchor).attr("target");
               ...
               h.image ? e(m, c(h.image, {isAirMode: k, isLeftTop: !0})) :
                    m.hide();
               g = g.find(".note-air-popover");
               if (k && h.range && !h.range.isCollapsed()) {
                    if (h = p.last(h.range.getClientRects())) {
                         h = l.rect2bnd(h), e(g, {
                              left: Math.max(h.left + h.width / 2 - 20, 0), top: h.top + h.height,
                         });
                    }
               } else {
                    g.hide();
          ...
          var c = a(document), e = function(e) {
               if (k.isControlSizing(e.target)) {
                    e.preventDefault();
                    e.stopPropagation();
                    e = k.makeLayoutInfo(e.target);
                    var g = e.handle(), h = e.popover(), l = e.editable();
                    e = e.editor();
                    var m = g.find(".note-control-selection").data("target"), p = a(m), q = p.offset(),
                         s = c.scrollTop(), t = e.data("options").airMode;
          ...
          this.update = function(b, c, e) {
               ...
               if (c.image) {
                    ...
                    var h = g.outerWidth(!0), g = g.outerHeight(!0);
                    b.css({display: "block", left: e.left, top: e.top, width: h, height: g}).data("target", c.image);
                    c = h + "x" + g;
          ...
          var c = a(window), e = a("html, body");
          this.toggle = function(a) {
               var g = a.editor(), h = a.toolbar(), k = a.editable(), l = a.codable(),
                    m = function(a) {
                         k.css("height", a.h);
                         l.css("height", a.h);
               ...
               (a = g.hasClass("fullscreen"))
                    ? (k.data("orgheight", k.css("height")), c.on("resize", function() {
                         m({h: c.height() - h.outerHeight()});
                    }).trigger("resize"), e.css("overflow", "hidden"))
                    : (c.off("resize"), m({h: k.data("orgheight")}), e.css("overflow", "visible"));
               b.invoke("toolbar.updateFullscreen", h, a);
          };
     }, A;
     g.hasCodeMirror && (g.isSupportAmd ? require(["CodeMirror"], function(a) {
          A =
               a;
     }) : A = window.CodeMirror);
     var Y = function(a) {
          this.sync = function(b) {
               a.invoke("codeview.isActivated", b) && g.hasCodeMirror && b.codable().data("cmEditor").save();
          };
          ...
          this.activate = function(b) {
               var c = b.editor(), e = b.toolbar(), h = b.editable(), l = b.codable(), m = b.popover(), p = b.handle();
               b = c.data("options");
               l.val(k.html(h, b.prettifyHtml));
               l.height(h.height());
               a.invoke("toolbar.updateCodeview",
                    e, !0);
          ...
          this.deactivate = function(b) {
               var c = b.holder(), e = b.editor(), h = b.toolbar(), l = b.editable();
               b = b.codable();
               ...
               var p = k.value(b, m.prettifyHtml) || k.emptyPara, q = l.html() !== p;
               l.html(p);
          ...
          this.attachDragAndDropEvent = function(e,
               g) {
               var h = a(), l = e.editor(), m = e.dropzone(), p = m.find(".note-dropzone-message");
               c.on("dragenter", function(a) {
                    var c = b.invoke("codeview.isActivated", e), k = 0 < l.width() && 0 < l.height();
                    c || h.length || !k ||
                    (l.addClass("dragover"), m.width(l.width()), m.height(l.height()), p.text(g.langInfo.image.dragImageHere));
                    h = h.add(a.target);
               ...
               m.on("drop", function(c) {
                    var e = c.originalEvent.dataTransfer, g = k.makeLayoutInfo(c.currentTarget || c.target);
                    if (e && e.files && e.files.length) {
                         c.preventDefault(), g.editable().
                              focus(), b.insertImages(g, e.files);
                    } else {
                         c = function() {
                              g.holder().summernote("insertNode", this);
                         };
                         for (var h = 0, l = e.types.length; h < l; h++) {
                              var m = e.types[h], p = e.getData(m);
                              -1 < m.toLowerCase().indexOf("text") ? g.holder().summernote("pasteHTML",
                                   p) : a(p).each(c);
                         }
                    }
               }).on("dragover", !1);
          ...
          this.attach = function(h) {
               if (g.isMSIE && 10 < g.browserVersion || g.isFF) {
                    c = a("<div />").
                         ...
                         css({position: "absolute", left: -1E5, opacity: 0}), h.editable().on("keydown", function(e) {
                         e.ctrlKey && e.keyCode === E.code.V &&
                         (b.invoke("saveRange", h.editable()), c.focus(), setTimeout(function() {
                              var e = h.editable(), g = c[0].firstChild;
                              if (k.isImg(g)) {
                                   for (var g = atob(g.src.split(",")[1]), l = new Uint8Array(g.length), m = 0; m <
                                   g.length; m++)
                                   {
                                        l[m] = g.charCodeAt(m);
                                   }
          ...
          var e = function(a) {
               ...
               var e = a.editable();
               c && c.items && c.items.length && (c = p.head(c.items), "file" === c.kind &&
               -1 !== c.type.indexOf("image/") &&
               b.insertImages(a, [c.getAsFile()]), b.invoke("editor.afterCommand", e));
          };
     }, da = function(b) {
          var c = function(a, b) {
          ...
          this.showLinkDialog = function(b, g, h) {
               return a.Deferred(function(a) {
                    var b = g.find(".note-link-dialog"), k = b.find(".note-link-text"), l = b.find(".note-link-url"),
                         m = b.find(".note-link-btn"), p = b.find("input[type=checkbox]");
                    b.one("shown.bs.modal",
                         function() {
                              k.val(h.text);
                              k.on("input", function() {
                                   c(m, k.val() && l.val());
          ...
          this.show = function(a) {
               var c = a.editor(), e = a.dialog(), g = a.editable(), h = a.popover();
          ...
          var c = function(a, b) {
               a.on("keypress", function(a) {
                    a.keyCode ===
                    E.code.ENTER && b.trigger("click");
               });
          };
          this.show = function(a) {
               var c = a.dialog(), e = a.editable();
               b.invoke("editor.saveRange", e);
               this.showImageDialog(e, c).then(function(c) {
                    b.invoke("editor.restoreRange", e);
                    "string" === typeof c ? b.invoke("editor.insertImage", e, c) : b.insertImages(a, c);
               }).fail(function() {
                    b.invoke("editor.restoreRange", e);
               });
          };
          this.showImageDialog = function(b, e) {
               return a.Deferred(function(a) {
                    var b = e.find(".note-image-dialog"), g = e.find(".note-image-input"),
                         h = e.find(".note-image-url"), k = e.find(".note-image-btn");
                    b.one("shown.bs.modal", function() {
                         g.replaceWith(g.clone().on("change", function() {
                         ...
                         h.on("keyup paste", function(a) {
                              a = "paste" === a.type ? a.originalEvent.clipboardData.getData("text") : h.val();
     ...
     a.extend(a.summernote, {
          version: "0.6.16", options: {
               ...
               fontNames: "Arial;Arial Black;Comic Sans MS;Courier New;Helvetica Neue;Helvetica;Impact;Lucida Grande;Tahoma;Times New Roman;Verdana".split(";"),
               fontNamesIgnoreCheck: [],
               fontSizes: "8 9 10 11 12 14 18 24 36".split(" "),
               colors: ["#000000 #424242 #636363 #9C9C94 #CEC6CE #EFEFEF #F7F7F7 #FFFFFF".split(" "),
     ...
     var O = new function() {
          var b = function(a, b) {
               var c = b.event, e = b.value, g = b.title, h = b.className, k = b.dropdown, l = b.hide;
               return (k ? '<div class="btn-group' + (h ? " " + h : "") + '">' : "") +
                    '<button type="button" class="btn btn-default btn-sm' + (!k && h ? " " + h : "") +
                    (k ? " dropdown-toggle" : "") + '"' + (k ? ' data-toggle="dropdown"' : "") +
                    (g ? ' title="' + g + '"' : "") + (c ? ' data-event="' + c + '"' : "") +
                    (e ? " data-value='" + e + "'" : "") + (l ? " data-hide='" + l + "'" : "") + ' tabindex="-1">' + a +
               ...
               return '<div class="' + a +
                    ' modal" aria-hidden="false"><div class="modal-dialog"><div class="modal-content">' + (b
                         ? '<div class="modal-header"><button type="button" class="close" aria-hidden="true" tabindex="-1">&times;</button><h4 class="modal-title">' +
                         b + "</h4></div>"
                         : "") + '<form class="note-modal-form"><div class="modal-body">' + c + "</div>" +
                    (e ? '<div class="modal-footer">' + e + "</div>" : "") + "</form></div></div></div>";
          }, m = function(a, b, c) {
               b = "dropdown-menu" + (b ? " " + b : "");
               c = c || "ul";
               ...
               picture: function(a, b) {
                    ...
                    return c(b.iconPrefix + b.icons.link.link, {
                         ...
                         title: a.link.link, hide: !0,
                    });
               }, table: function(a, b) {
                    return c(b.iconPrefix + b.icons.table.table, {
                         title: a.table.table,
                         dropdown: m('<div class="note-dimension-picker">;<div class="note-dimension-picker-mousecatcher" data-event="insertTable" data-value="1x1"></div>;<div class="note-dimension-picker-highlighted"></div>;<div class="note-dimension-picker-unhighlighted"></div>;</div>;<div class="note-dimension-display"> 1 x 1 </div>'.split(";"), "note-table"),
                    });
               }, style: function(a, b) {
                    var f = b.styleTags.reduce(function(b,
                         c) {
                         var f = a.style["p" === c ? "normal" : c];
                         return b + '<li><a data-event="formatBlock" href="#" data-value="' + c + '">' +
                              ("p" === c || "pre" === c ? f : "<" + c + ">" + f + "</" + c + ">") + "</a></li>";
                    }, "");
                    return c(b.iconPrefix + b.icons.style.style, {title: a.style.style, dropdown: m(f)});
               }, fontname: function(a, c) {
                    var f = [], e = c.fontNames.reduce(function(a, b) {
                         if (!g.isFontInstalled(b) && !p.contains(c.fontNamesIgnoreCheck, b)) {
                              return a;
                         }
                         f.push(b);
                         return a + '<li><a data-event="fontName" href="#" data-value="' + b +
                              '" style="font-family:\'' + b + '\'"><i class="' +
                              c.iconPrefix + c.icons.misc.check + '"></i> ' + b + "</a></li>";
                    }, ""), h = '<span class="note-current-fontname">' +
                         (g.isFontInstalled(c.defaultFontName) ? c.defaultFontName : f[0]) + "</span>";
                    return b(h, {title: a.font.name, className: "note-fontname", dropdown: m(e, "note-check")});
               }, fontsize: function(a, c) {
                    var f = c.fontSizes.reduce(function(a, b) {
                         return a + '<li><a data-event="fontSize" href="#" data-value="' + b + '"><i class="' +
                              c.iconPrefix + c.icons.misc.check + '"></i> ' + b + "</a></li>";
                    }, "");
                    return b('<span class="note-current-fontsize">11</span>',
                         {title: a.font.size, className: "note-fontsize", dropdown: m(f, "note-check")});
               }, color: function(a, c) {
                    var f = b('<i class="' + c.iconPrefix + c.icons.color.recent +
                         ...
                         title: a.color.more,
                         dropdown: m(['<li><div class="btn-group">',
                              '<div class="note-palette-title">' + a.color.background + "</div>",
                              '<div class="note-color-reset" data-event="backColor"',
                              ' data-value="inherit" title="' +
                              a.color.transparent + '">' + a.color.setTransparent + "</div>",
                              '<div class="note-color-palette" data-target-event="backColor"></div>',
                              '</div><div class="btn-group">',
                              '<div class="note-palette-title">' + a.color.foreground + "</div>",
               ...
               subscript: function(a, b) {
                    ...
                    var f = c(b.iconPrefix + b.icons.paragraph.left,
                         {title: a.paragraph.left, event: "justifyLeft"}),
                         e = c(b.iconPrefix + b.icons.paragraph.center, {
                              ...
                              event: "justifyFull",
                         }), k = c(b.iconPrefix + b.icons.paragraph.outdent, {title: a.paragraph.outdent, event: "outdent"}),
                         l = c(b.iconPrefix + b.icons.paragraph.indent, {title: a.paragraph.indent, event: "indent"});
                    return c(b.iconPrefix +
                         b.icons.paragraph.paragraph, {
                         title: a.paragraph.paragraph,
                         dropdown: m(['<div class="note-align btn-group">',
                              f + e + g + h,
                    ...
                    var f = b.lineHeights.reduce(function(a, c) {
                         return a + '<li><a data-event="lineHeight" href="#" data-value="' + parseFloat(c) +
                              '"><i class="' + b.iconPrefix + b.icons.misc.check + '"></i> ' + c + "</a></li>";
                    }, "");
                    return c(b.iconPrefix + b.icons.font.height, {title: a.font.height, dropdown: m(f, "note-check")});
               }, help: function(a,
                    b) {
                    ...
                    return c(b.iconPrefix + b.icons.history.redo,
                         {event: "redo", title: a.history.redo});
               }, hr: function(a, b) {
                    return c(b.iconPrefix + b.icons.hr.insert, {event: "insertHorizontalRule", title: a.hr.insert});
               },
          }, s = function(g, h) {
               var f = function() {
                    for (var b = a("<div />"), c = 0, f = h.airPopover.length; c < f; c++) {
                         for (var k = h.airPopover[c], l = a('<div class="note-' + k[0] +
                              ' btn-group">'), m = 0, p = k[1].length; m < p; m++)
                         {
                              var s = a(q[k[1][m]](g, h));
               ...
               k.append(function() {
                    var a =
                              c(h.iconPrefix + h.icons.link.edit, {title: g.link.edit, event: "showLinkDialog", hide: !0}),
                         b = c(h.iconPrefix + h.icons.link.unlink, {title: g.link.unlink, event: "unlink"});
                    return e("note-link-popover", '<a href="http://www.google.com" target="_blank">www.google.com</a>&nbsp;&nbsp;<div class="note-insert btn-group">' +
                         a + b + "</div>");
               }());
               k.append(function() {
                    var a = b('<span class="note-fontsize-10">100%</span>', {
                         ...
                         event: "imageShape", value: "img-rounded",
                    ...
                    return e("note-image-popover", (h.disableResizeImage ?
                         "" : '<div class="btn-group">' + a + f + k + "</div>") + '<div class="btn-group">' + l + m +
                         p + '</div><br><div class="btn-group">' + q + s + t + r + '</div><div class="btn-group">' + D +
                         "</div>");
               }());
               h.airMode && k.append(f());
               return k;
          }, t = function(a) {
               return '<div class="note-handle"><div class="note-control-selection"><div class="note-control-selection-bg"></div><div class="note-control-holder note-control-nw"></div><div class="note-control-holder note-control-ne"></div><div class="note-control-holder note-control-sw"></div><div class="' +
                    (a.disableResizeImage ? "note-control-holder" : "note-control-sizing") +
                    ' note-control-se"></div>' +
                    (a.disableResizeImage ? "" : '<div class="note-control-selection-info"></div>') + "</div></div>";
          }, r = function(a, b) {
               var c = [], e;
               for (e in b) {
                    b.hasOwnProperty(e) &&
                    c.push('<div class="note-shortcut-col col-xs-6 note-shortcut-key">' + b[e].kbd +
                         '</div><div class="note-shortcut-col col-xs-6 note-shortcut-name">' + b[e].text + "</div>");
               }
               return '<div class="note-shortcut-row row"><div class="note-shortcut-col col-xs-6 note-shortcut-title col-xs-offset-6">' +
                    a + '</div></div><div class="note-shortcut-row row">' +
                    c.join('</div><div class="note-shortcut-row row">') + "</div>";
          }, D = function(a, b) {
               var c = b.extraKeys, e = [], g;
               for (g in c) {
                    c.hasOwnProperty(g) && e.push({kbd: g, text: c[g]});
               }
               return r(a.shortcut.extraKeys, e);
          }, v = function(a, b) {
               var c = '<div class="note-shortcut note-shortcut-col col-sm-6 col-xs-12">' +
                    r(a.shortcut.action, [{kbd: "\u2318 + Z", text: a.history.undo},
                    ...
                    '</div><div class="note-shortcut note-shortcut-col col-sm-6 col-xs-12">', e;
               e = r(a.shortcut.textFormatting, [{kbd: "\u2318 + B", text: a.font.bold},
                    {kbd: "\u2318 + I", text: a.font.italic},
                    {kbd: "\u2318 + U", text: a.font.underline},
                    {kbd: "\u2318 + \\", text: a.font.clear}]);
               c = c + e + "</div>";
               e = '<div class="note-shortcut note-shortcut-col col-sm-6 col-xs-12">' +
                    r(a.shortcut.documentStyle, [{kbd: "\u2318 + NUM0", text: a.style.normal},
                         {
                              kbd: "\u2318 + NUM1",
                              text: a.style.h1,
                         },
               ...
               var g;
               g = r(a.shortcut.paragraphFormatting, [{kbd: "\u2318 + \u21e7 + L", text: a.paragraph.left},
               ...
               c = [c, e + g + "</div>"];
               b.extraKeys &&
               c.push('<div class="note-shortcut note-shortcut-col col-sm-6 col-xs-12">' + D(a, b) + "</div>");
               return '<div class="note-shortcut-row row">' + c.join('</div><div class="note-shortcut-row row">') +
                    "</div>";
          }, z = {
               image: function(a, b) {
                    var c = "";
                    b.maximumImageFileSize &&
                    (c = Math.floor(Math.log(b.maximumImageFileSize) / Math.log(1024)), c = 1 *
                         (b.maximumImageFileSize /
                              Math.pow(1024, c)).toFixed(2) + " " + " KMGTP"[c] + "B", c = "<small>" +
                         a.image.maximumFileSize + " : " + c + "</small>");
                    return h("note-image-dialog", a.image.insert, '<div class="form-group row note-group-select-from-files"><label>' +
                         ...
                         c + '</div><div class="form-group row"><label>' + a.image.url +
                         '</label><input class="note-image-url form-control col-md-12" type="text" /></div>',
                         '<button href="#" class="btn btn-primary note-image-btn disabled" disabled>' + a.image.insert +
                         "</button>");
               }, link: function(a, b) {
                    return h("note-link-dialog", a.link.insert, '<div class="form-group row"><label>' +
                         ...
                         (b.disableLinkTarget ? "" : '<div class="checkbox"><label><input type="checkbox" checked> ' +
                              a.link.openInNewWindow +
                              "</label></div>"), '<button href="#" class="btn btn-primary note-link-btn disabled" disabled>' +
                         a.link.insert + "</button>");
               }, help: function(a, b) {
                    var c = '<a class="modal-close pull-right" aria-hidden="true" tabindex="-1">' + a.shortcut.close +
                         '</a><div class="title">' + a.shortcut.shortcuts + "</div>", e;
                    e = g.isMac ? v(a, b) : v(a, b).replace(/\u2318/g, "Ctrl").replace(/\u21e7/g, "Shift");
                    return h("note-help-dialog", "", c + e +
               ...
               b.find("button").each(function(b, c) {
                    var e = a(c), f = h[e.data("event")];
                    f && e.attr("title", function(a, b) {
                         var c;
                         c = f;
                         g.isMac && (c = c.replace("CMD", "\u2318").replace("SHIFT", "\u21e7"));
               ...
               b.find(".note-color-palette").each(function() {
                    for (var b = a(this), c = b.attr("data-target-event"), g = [], h = 0, k = e.length; h < k; h++) {
                         for (var l = e[h], m = [], p = 0, q = l.length; p < q; p++) {
                              var s = l[p];
                              m.push(['<button type="button" class="note-color-btn" style="background-color:',
                                   s,
                                   ';" data-event="',
                                   c,
                                   '" data-value="',
                         ...
                         g.push('<div class="note-color-row">' +
                              m.join("") + "</div>");
                    }
                    b.html(g.join(""));
               });
          ...
          this.createLayoutByFrame = function(b, c) {
               var e = c.langInfo, h = a('<div class="note-editor panel panel-default" />');
               c.width && h.width(c.width);
               0 < c.height && a('<div class="note-statusbar">' + (c.disableResizeEditor
                    ? ""
                    : '<div class="note-resizebar"><div class="note-icon-bar"></div><div class="note-icon-bar"></div><div class="note-icon-bar"></div></div>') +
                    "</div>").prependTo(h);
               var l =
                         a('<div class="note-editing-area" />'), m = !b.is(":disabled"),
                    m = a('<div class="note-editable panel-body" contentEditable="' + m + '"></div>').prependTo(l);
               ...
               for (m = c.toolbar.length; v < m; v++) {
                    for (var p = c.toolbar[v][1], r = a('<div class="note-' + c.toolbar[v][0] +
                         ' btn-group" />'), w = 0, D = p.length; w < D; w++)
                    {
                         var x = q[p[w]];
                         a.isFunction(x) && (x = a(x(e, c)), x.attr("data-name", p[w]), r.append(x));
                    }
                    l.append(r);
               }
               ...
               Q(l, v, "bottom");
               l.prependTo(h);
               a('<div class="note-dropzone"><div class="note-dropzone-message"></div></div>').prependTo(h);
          ...
          this.removeLayout = function(a, b, c) {
               c.airMode ?
                    (a.removeClass("note-air-editor note-editable").removeAttr("id contentEditable"), b.popover().
                         remove(), b.handle().remove(), b.dialog().remove()) : (a.html(b.editable().
                         html()), c.dialogsInBody && b.dialog().remove(), b.editor().remove(), a.show());
          };
          ...
          this.invoke = function() {
               var a = p.head(p.from(arguments)), b = p.tail(p.from(arguments)), c = a.split("."), e = 1 < c.length,
                    a = e && p.head(c), c = e ? p.last(c) : p.head(c), a = this.getModule(a);
          ...
          var e = this.bindCustomEvent = function(a, b, c) {
               return function() {
                    var e =
                         b[l.namespaceToCamel(c, "on")];
                    e && e.apply(a[0], arguments);
                    return a.trigger("summernote." + c, arguments);
               };
          };
          this.insertImages = function(b, g) {
               var h = b.editor(), k = b.editable(), l = b.holder(), m = k.data("callbacks"), p = h.data("options");
               m.onImageUpload ? e(l, m, "image.upload")(g) : a.each(g, function(a, b) {
                    var g = b.name;
                    p.maximumImageFileSize && p.maximumImageFileSize < b.size
                         ? e(l, m, "image.upload.error")(p.langInfo.image.maximumFileSizeError)
                         : L.readFileAsDataURL(b).then(function(a) {
                              c.editor.insertImage(k, a, g);
                         }).fail(function() {
                              e(l,
                                   m, "image.upload.error")(p.langInfo.image.maximumFileSizeError);
                         });
               });
          };
          var h = {
          ...
          this.updateStyleInfo = function(a,
               b) {
               if (a) {
          ...
          var s = function(a) {
               var e = a.target;
               setTimeout(function() {
                    var a = k.makeLayoutInfo(e), g = c.editor.currentStyle(e);
               ...
               var e =
                    a(b.target).closest("[data-event]");
               if (e.length) {
                    var g = e.attr("data-event"), l = e.attr("data-value"), m = e.attr("data-hide"),
                         q = k.makeLayoutInfo(b.target), t;
                    -1 !== a.inArray(g, ["resize", "floatMe", "removeMedia", "imageShape"]) &&
                    (t = q.handle().find(".note-control-selection"), t = a(t.data("target")));
                    m && e.parents(".popover").hide();
                    if (a.isFunction(a.summernote.pluginEvents[g])) {
                         a.summernote.pluginEvents[g](b, c.editor, q, l);
                    } else {
                         c.editor[g]
                              ? (m = q.editable(), m.focus(), c.editor[g](m, l, t), b.preventDefault())
                              : h[g] && (h[g].call(this,
                              q), b.preventDefault());
                    }
                    if (-1 !== a.inArray(g, ["backColor", "foreColor"])) {
                         var f = q.editor().data("options", f);
                         (f.airMode ? c.popover : c.toolbar).updateRecentColor(p.head(e), g, l);
                    }
                    s(b);
               }
          };
          this.bindKeyMap = function(b, e) {
               var g = b.editor(), k = b.editable();
               k.on("keydown", function(l) {
                    ...
                    if (m = e[p]) {
                         ...
                         a.isFunction(p) ? p(l, c.editor, b) : c.editor[m]
          ...
          this.attach = function(b, e) {
               e.shortcuts && !isMobile() && this.bindKeyMap(b, e.keyMap[g.isMac ? "mac" : "pc"]);
               ...
               b.popover().on("mousedown",
                    r);
               c.dragAndDrop.attach(b, e);
               e.airMode || (b.toolbar().on("click", D), b.toolbar().on("mousedown", r), c.statusbar.attach(b, e));
               (e.airMode ? b.popover() : b.toolbar()).find(".note-dimension-picker-mousecatcher").
                    css({width: e.insertTableMaxSize.col + "em", height: e.insertTableMaxSize.row + "em"}).
                    on("mousemove", function(b) {
                         var c, g = a(b.target.parentNode), h = g.next(),
                         ...
                         3 < c && c < e.insertTableMaxSize.col && g.css({width: c + 1 + "em"});
                         3 < b && b < e.insertTableMaxSize.row && g.css({height: b + 1 + "em"});
                         h.html(c + " x " + b);
                    });
               b.editor().data("options", e);
               g.isMSIE || setTimeout(function() {
                    document.execCommand("styleWithCSS", 0, e.styleWithSpan);
               }, 0);
               var h = new C(b.editable());
               b.editable().data("NoteHistory",
                    h);
               b.editable().
                    data("callbacks", {
                         onInit: e.onInit,
          ...
          this.attachCustomEvent = function(b, c) {
               ...
               l.on(g.isMSIE ? "DOMCharacterDataModified DOMSubtreeModified DOMNodeInserted" : "input", function() {
                    e(h, m, "change")(l.html(), l);
               });
               c.airMode || (b.toolbar().click(e(h, m, "toolbar.click")),
                    b.popover().click(e(h, m, "popover.click")));
               k.isTextarea(p.head(h)) && h.closest("form").submit(function(a) {
               ...
               e(h, m, "init")(b);
               for (var q = 0, s = a.summernote.plugins.length; q <
               s; q++)
               {
                    a.isFunction(a.summernote.plugins[q].init) && a.summernote.plugins[q].init(b);
               }
          };
     ...
     a.fn.extend({
          summernote: function() {
               var b = a.type(p.head(arguments)), c = "string" === b, e = (b = "object" === b) ? p.head(arguments) : {},
               ...
               if (!c && b) {
                    for (var b = 0, g = a.summernote.plugins.length; b <
                    g; b++)
                    {
                         var h = a.summernote.plugins[b];
                         e.plugin[h.name] && (a.summernote.plugins[b] = a.extend(!0, h, e.plugin[h.name]));
                    }
               }
               ...
               if (b.length) {
                    ...
                    if (c) {
                         return c = p.head(p.from(arguments)), g = p.tail(p.from(arguments)), c = [c,
                              b.editable()].concat(g), U.invoke.apply(U, c);
                    }
          ...
          code: function(b) {
               if (void 0 === b) {
                    ...
                    var e = O.layoutInfoFromHolder(c), g = e && e.editable();
                    return g && g.length ? (c = U.invoke("codeview.isActivated", e), U.invoke("codeview.sync", e), c
                         ? e.codable().val()
                         : e.editable().html()) : k.value(c);
               }
               ...
               this.each(function(b, c) {
                    ...
                    if (O.hasNoteEditor(e)) {
                         var g = O.layoutInfoFromHolder(e), h = g.editor().data("options");
                         U.detach(g, h);
...
(function(a) {
     a.extend(a.summernote.lang, {
          "ko-KR": {
               ...
               lists: {unordered: "\uae00\uba38\ub9ac \uae30\ud638", ordered: "\ubc88\ud638 \ub9e4\uae30\uae30"},
               options: {
                    help: "\ub3c4\uc6c0\ub9d0",
                    fullscreen: "\uc804\uccb4 \ud654\uba74",
                    codeview: "\ucf54\ub4dc \ubcf4\uae30",
...
(function(a) {
     ...
     var q = a.summernote.renderer.getTemplate(), r = a.summernote.core.range, c = a.summernote.core.dom,
          b = function(a) {
               a.focus();
               a = r.create();
               a.isOnAnchor() && (a = c.ancestor(a.sc, c.isAnchor), a = r.createFromNode(a));
               return a.toString();
          }, e = function(b, c, e) {
               return a.Deferred(function(a) {
                    var b = c.find(".note-video-dialog"), g = b.find(".note-video-url"), q = b.find(".note-video-btn");
                    b.one("shown.bs.modal", function() {
                         g.val(e).on("input",
                              function() {
                                   var a = g.val();
     ...
     a.summernote.addPlugin({
          name: "video", buttons: {
               ...
               video: function(a) {
                    return q.dialog("note-video-dialog",
                         a.video.insert, '<div class="form-group row-fluid"><label>' + a.video.url +
                         ' <small class="text-muted">' + a.video.providers +
                         '</small></label><input class="note-video-url form-control span12" type="text" /></div>', '<button href="#" class="btn btn-primary note-video-btn disabled" disabled>' +
               ...
               showVideoDialog: function(c, l, p) {
                    ...
                    e(q, c, p).then(function(b) {
                         l.restoreRange(q);
                         a:{
                              var c = b.match(/^(?:https?:\/\/)?(?:www\.)?(?:youtu\.be\/|youtube\.com\/(?:embed\/|v\/|watch\?v=|watch\?.+&v=))((\w|-){11})(?:\S+)?$/),
                                   e = b.match(/\/\/instagram.com\/p\/(.[a-zA-Z0-9]*)/),
                                   g = b.match(/\/\/vine.co\/v\/(.[a-zA-Z0-9]*)/),
                                   p = b.match(/\/\/(player.)?vimeo.com\/([a-z]*\/)*([0-9]{6,11})[?]?.*/),
                                   r = b.match(/.+dailymotion.com\/(video|hub)\/([^_]+)[^#]*(#video=([^_&]+))?/),
                                   h = b.match(/\/\/v\.youku\.com\/v_show\/id_(\w+)=*\.html/),
                                   m = b.match(/^.+.(mp4|m4v)$/), Q = b.match(/^.+.(ogg|ogv)$/),
                                   H = b.match(/^.+.(webm)$/);
                              if (c && 11 === c[1].length) {
                                   b = c[1], b = a("<iframe>").
                                        attr("frameborder", 0).
                                   ...
                                   p[3].length)
                              {
                                   b = a("<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>").
                                        attr("frameborder", 0).
                                        attr("src",
                                             "//player.vimeo.com/video/" + p[3]).
                                        attr("width", "640").
                                        attr("height", "360");
                                   ...
                                   h[1].length)
                              {
                                   ...
                                   H)
                              {
                                   b = a("<video controls>").attr("src", b).attr("width",
                                        "640").attr("height", "360");
                              } else {
                                   b = !1;
                                   break a;
               ...
               "id-ID": {
                    video: {
                         video: "Video", videoLink: "Link video", insert: "Sisipkan video",
                         url: "Tautan video", providers: "(YouTube, Vimeo, Vine, Instagram, DailyMotion, atau Youku)",
                    },
               },
               "it-IT": {
                    video: {
...
(function(a) {
     ...
     var q = a.summernote.renderer.getTemplate(), r = a.summernote.core.range, c = a.summernote.core.dom,
          b = function(b, c, e) {
               e = a("<div/>").text(e);
               return a('<pre class="' + (c ? "line-numbers" : "") + '"><code class="language-' + b + '">' + e.html() +
                    "</code></pre>")[0];
          }, e = function(b) {
               b.focus();
               b = r.create().expand(c.isCodeBlock);
               var e = a(b.nodes(c.isPre)[0]), g = a(b.nodes(c.isCode)[0]);
               return {
                    range: b,
                    text: b.toString(),
                    isShowLineNumbers: e.length ?
                         "line-numbers" === e.attr("class") : !0,
                    langType: g.length ? g.attr("class") : "",
                    sourceCode: g.length ? g.text() : "",
               };
          }, g = function(b, c, e) {
               return a.Deferred(function(a) {
                    var b = c.find(".note-codeblock-dialog"), g = b.find(".note-codeblock-type"),
                         l = b.find(".note-codeblock-numbers"), q = b.find(".note-codeblock-source"),
     ...
     a.summernote.addPlugin({
          name: "codeblock", buttons: {
               codeblock: function(a) {
                    return q.button('<i class="fa fa-file-code-o"></i> ' +
                         a.codeblock.codeblock, {event: "showCodeblockDialog", title: a.codeblock.codeblock, hide: !0});
               },
          }, dialogs: {
               codeblock: function(a) {
                    return q.dialog("note-codeblock-dialog",
                         a.codeblock.insert, '<div class="form-group"><label>' + a.codeblock.langType +
                         '</label><select class="note-codeblock-type form-control span12"><option selected="selected" value="markup">HTML / Markup</option><option value="css">CSS</option><option value="sass">Sass</option><option value="javascript">JavaScript</option><option value="java">Java</option><option value="python">Python</option><option value="groovy">Groovy</option><option value="scala">Scala</option><option value="php">PHP</option><option value="bash">Bash</option><option value="coffeescript">CoffeesSript</option><option value="go">Go</option><option value="haskell">Haskell</option><option value="go">Go</option><option value="c">C</option><option value="cpp">C++</option><option value="sql">ALLSQL</option><option value="ruby">Ruby</option><option value="aspnet">ASP.NET</option><option value="csharp">C#</option><option value="swift">Swift</option><option value="objectivec">Objective-C</option></select></div><div class="form-group"><label><input type="checkbox" class="note-codeblock-numbers"> ' +
                         a.codeblock.showLineNumbers + '</label></div><div class="form-group"><label>' +
                         a.codeblock.sourceCode +
                         '</label><textarea rows="10" class="form-control note-codeblock-source"></textarea></div>', '<button href="javascript://" class="btn btn-primary note-codeblock-btn disabled" disabled>' +
                         a.codeblock.insert + "</button>");
               },
          }, events: {
...
(function(a, q) {
     "object" == typeof exports ? module.exports = q() : "function" == typeof define && define.amd
          ? define(q)
          : a.Spinner = q();
})(this, function() {
     function a(a, b) {
          var c = document.createElement(a || "div"), e;
          for (e in b) {
               c[e] = b[e];
          }
          return c;
     ...
     function r(a, b, c, e) {
          ...
          k[g] || (L.insertRule("@" +
               (l && "-" + l + "-" || "") + "keyframes " + g + "{0%{opacity:" + e + "}" + c + "%{opacity:" + a + "}" +
               (c + .01) + "%{opacity:1}" + (c + b) % 100 + "%{opacity:" + a + "}100%{opacity:" + e +
               "}}", L.cssRules.length), k[g] = 1);
          return g;
     }
     ...
     function p() {
          ...
          l.prototype.lines = function(a, e) {
               function k() {
                    return b(c("group", {coordsize: r + " " + r, coordorigin: -p + " " + -p}), {width: r, height: r});
               }
               
               function l(a, h, s) {
                    q(t, q(b(k(), {
                         rotation: 360 / e.lines * a + "deg",
                         left: ~~h,
                    }), q(b(c("roundrect", {arcsize: e.corners}),
                         {
                              width: p,
                              height: e.width,
                              left: e.radius,
                              top: -e.width >> 1,
                              filter: s,
                         }), c("fill", {color: g(e.color, a), opacity: e.opacity}), c("stroke", {opacity: 0}))));
               }
               
               var p = e.length + e.width, r = 2 * p, s = 2 * -(e.width + e.length) + "px",
                    t = b(k(), {position: "absolute", top: s, left: s});
               if (e.shadow) {
                    for (s = 1; s <=
                    e.lines; s++)
                    {
                         l(s, -2, "progid:DXImageTransform.Microsoft.Blur(pixelradius=2,makeshadow=1,shadowopacity=.3)");
                    }
               }
               for (s = 1; s <= e.lines; s++) {
                    l(s);
          ...
          l.prototype.opacity = function(a, b, c, e) {
               ...
               a && b + e < a.childNodes.length &&
               (a = (a = (a = a.childNodes[b + e]) && a.firstChild) && a.firstChild) && (a.opacity = c);
          };
     }
     
     var t = ["webkit", "Moz", "ms", "O"], k = {}, s, L = function() {
     ...
     e(l.prototype, {
          spin: function(c) {
               ...
               var e = this,
                    g = e.opts,
                    k = e.el = b(a(0, {className: g.className}), {position: g.position, width: 0, zIndex: g.zIndex});
               b(k, {left: g.left, top: g.top});
               c && c.insertBefore(k, c.firstChild || null);
               k.setAttribute("role", "progressbar");
               e.lines(k, e.opts);
               if (!s) {
                    var l = 0, p = (g.lines - 1) * (1 - g.direction) / 2, q, r = g.fps, t = r / g.speed,
                         M = (1 - g.opacity) / (t * g.trail / 100), N = t / g.lines;
                    (function Y() {
                         l++;
                         for (var a = 0; a < g.lines; a++) {
                              q = Math.max(1 - (l + (g.lines - a) * N) % t *
                                   M, g.opacity), e.opacity(k, a * g.direction + p, q, g);
                         }
          ...
          stop: function() {
               ...
               function k(c, g) {
                    return b(a(), {
                         ...
                         transform: "rotate(" + ~~(360 / e.lines * l + e.rotate) + "deg) translate(" + e.radius +
                              "px,0)",
                         borderRadius: (e.corners * e.width >> 1) + "px",
                    });
               }
               
               for (var l = 0, p = (e.lines - 1) * (1 - e.direction) / 2, t; l < e.lines; l++) {
                    t = b(a(), {
                         position: "absolute",
                         top: 1 + ~(e.width / 2) + "px",
                         transform: e.hwaccel ? "translate3d(0,0,0)" : "",
                         opacity: e.opacity,
                         animation: s && r(e.opacity, e.trail, p + l * e.direction, e.lines) + " " + 1 / e.speed +
                              "s linear infinite",
                    }), e.shadow &&
                    q(t, b(k("#000", "0 0 4px #000"), {top: "2px"})), q(c, q(t, k(g(e.color, l), "0 0 1px rgba(0,0,0,.1)")));
               }
               return c;
...
(function(a) {
     ...
     a.fn.spin = function(r, c) {
          return this.each(function() {
               var b = a(this), e = b.data();
               e.spinner && (e.spinner.stop(), delete e.spinner);
               !1 !== r && (r = a.extend({color: c || b.css("color")}, a.fn.spin.presets[r] ||
                    r), e.spinner = (new q(r)).spin(this));
          });
     };
     a.fn.spin.presets =
          {
...
(function(a) {
     function q(a, b) {
          "" === a.val() ? a.data("placeholder").removeClass(b.hideClass) : a.data("placeholder").addClass(b.hideClass);
     }
     
     function r(a, b) {
          var c = b.is("textarea"), e = parseFloat(b.css("padding-top")), k = parseFloat(b.css("padding-left")),
               q = b.offset();
          e && (q.top += e);
          k && (q.left += k);
          a.css({
     ...
     function c(a, c) {
          ...
          (function k() {
               ...
               a.val() !== p && (a.data("placeholder").addClass(c.hideClass), window.cancelAnimationFrame &&
               cancelAnimationFrame(e), b(a, c));
          })();
     }
     ...
     a.fn.placeHolder = function(b) {
          ...
          return a(this).each(function(b) {
               ...
               var s = a(this), L = s.attr("placeholder"), E = s.attr("id"), C, z;
               if ("" === L || void 0 === L) {
               ...
               if (C.length || E) {
                    if (C = C.length ? C : a('label[for="' + E + '"]').first(), C.length) {
                         E = a(C).find(".placeholder");
                         if (E.length) {
                              return r(E, s), E.text(L), s;
                         }
                         C.hasClass(l.options.removeLabelClass) &&
                         C.removeClass(l.options.removeLabelClass).addClass(l.options.hiddenOverrideClass);
                         ...
                         s.focusout(function() {
                              q(a(this), l.options);
                              l.options.hideOnFocus || window.cancelAnimationFrame && cancelAnimationFrame(e);
                         });
                         q(s, l.options);
                         a(document).bind("fontresize resize", function() {
                              r(z, s);
                         });
                         a.event.special.resize ? a("textarea").bind("resize", function(b) {
                              a(this).is(":visible") && r(z, s);
                              b.stopPropagation();
                              b.preventDefault();
                         }) : a("textarea").css("resize", "none");
                         b >= p - 1 && "undefined" !== typeof a.attrHooks && (a.attrHooks.placeholder = {
                              get: function(b) {
                                   if ("input" === b.nodeName.toLowerCase() || "textarea" ===
                                        b.nodeName.toLowerCase())
                                   {
                                        return a(b).data("placeholder") ?
                                             a(a(b).data("placeholder")).text() : a(b)[0].placeholder;
                                   }
                              }, set: function(b, c) {
     ...
     a(function() {
          ...
          !1 === b.autoInit || ("placeholder" in a("<input>")[0] || "placeHolder" in a("<input>")[0]) &&
          !b.forceApply || a("input[placeholder], textarea[placeholder]").placeHolder(b);
     });
})(jQuery);
(function(a, q) {
     "object" === typeof exports && exports ? q(exports) : "function" === typeof define && define.amd
          ? define(["exports"], q)
          : q(a.Mustache = {});
})(this, function(a) {
     function q(a) {
          ...
          for (var K = new g(c), ia, O, U, P; !K.eos();) {
               ...
               if (U = K.scanUntil(v)) {
                    ...
                    for (var x = U.length; P < x; ++P) {
                         if (O = U.charAt(P), s.call(L, O)
                              ? H = !0
                              : N.push(t.length), t.push(["text", O, ia, ia + 1]), ia += 1, "\n" === O)
                         {
                              if (A && !H) {
                                   for (; N.length;) {
                                        delete t[N.pop()];
               ...
               O = K.scan(Q) || "name";
               K.scan(C);
               "=" === O ? (U = K.scanUntil(h), K.scan(h), K.scanUntil(E)) : "{" === O
                    ? (U = K.scanUntil(da), K.scan(m), K.scanUntil(E), O = "&")
                    : U = K.scanUntil(E);
               if (!K.scan(E)) {
                    throw Error("Unclosed tag at " +
                         K.pos);
               }
               P = [O, U, ia, K.pos];
               t.push(P);
     ...
     var t = Object.prototype.toString, k = Array.isArray || function(a) {
          return "[object Array]" === t.call(a);
     }, s = RegExp.prototype.test, L = /\S/, E = {
          "&": "&amp;",
          "<": "&lt;", ">": "&gt;", '"': "&quot;", "'": "&#39;", "/": "&#x2F;",
     }, C = /\s*/, z = /\s+/, h = /\s*=/, m = /\s*\}/, Q = /#|\^|\/|>|\{|&|=|!/;
     ...
     l.prototype.lookup = function(a) {
          ...
          if (a in b) {
               ...
               for (var e = this, g, h; e;) {
                    if (0 < a.indexOf(".")) {
                         for (c = e.view, g = a.split("."), h = 0; null != c && h <
                         g.length;)
                         {
                              c = c[g[h++]];
                         }
...
(function(a) {
     ...
     function q() {
          ...
          if (!e.data("timeago")) {
               ...
               var l = a.trim(e.text());
               b.settings.localeTitle ? e.attr("title", e.data("timeago").datetime.toLocaleString()) : !(0 <
                    l.length) || b.isTime(e) && e.attr("title") || e.attr("title", l);
          }
          e = e.data("timeago");
          l = b.settings;
          isNaN(e.datetime) || (0 == l.cutoff || Math.abs(c(e.datetime)) < l.cutoff) && a(this).text(r(e.datetime));
          return this;
     }
     ...
     a.timeago = function(b) {
          return b instanceof Date ? r(b) : "string" === typeof b ? r(a.timeago.parse(b)) : "number" === typeof b
               ? r(new Date(b))
     ...
     a.extend(a.timeago, {
          settings: {
               refreshMillis: 6E4, allowPast: !0, allowFuture: !1, localeTitle: !1, cutoff: 0, strings: {
                    prefixAgo: null,
                    prefixFromNow: null,
                    suffixAgo: "ago",
               ...
               function c(h, k) {
                    return (a.isFunction(h) ? h(k, b) : h).replace(/%d/i, e.numbers && e.numbers[k] || k);
               }
               ...
               var e = this.settings.strings, q = e.prefixAgo, k = e.suffixAgo;
               this.settings.allowFuture && 0 > b && (q = e.prefixFromNow, k = e.suffixFromNow);
               if (!this.settings.allowPast && 0 <= b) {
                    return this.settings.strings.inPast;
               }
               var r = Math.abs(b) / 1E3, L = r / 60, E = L / 60, C = E / 24, z = C / 365,
                    r = 45 > r && c(e.seconds, Math.round(r)) || 90 > r && c(e.minute, 1) || 45 > L &&
                         c(e.minutes, Math.round(L)) || 90 > L && c(e.hour, 1) || 24 > E && c(e.hours, Math.round(E)) ||
                         42 > E && c(e.day, 1) || 30 > C && c(e.days, Math.round(C)) || 45 > C && c(e.month, 1) || 365 >
                         C && c(e.months, Math.round(C / 30)) || 1.5 > z && c(e.year, 1) || c(e.years, Math.round(z)),
                    L = e.wordSeparator ||
                         "";
     ...
     var e = {
          init: function() {
               ...
               c();
               var e = b.settings;
               0 < e.refreshMillis && (this._timeagoInterval = setInterval(c, e.refreshMillis));
          }, update: function(c) {
               c = b.parse(c);
               ...
               a(this).
                    data("timeago", {
                         datetime: b.parse(b.isTime(this) ? a(this).attr("datetime") : a(this).
                              attr("title")),
                    });
               q.apply(this);
          }, dispose: function() {
               this._timeagoInterval && (window.clearInterval(this._timeagoInterval), this._timeagoInterval =
                    null);
          },
     };
...
(function(a) {
     ...
     a.extend(a.fn, {
          validate: function(c) {
               if (this.length) {
                    ...
                    b.settings.onsubmit && (this.on("click.validate", ":submit", function(c) {
                         ...
                         function g() {
                              var g, p;
                              return b.settings.submitHandler ? (b.submitButton && (g = a("<input type='hidden'/>").
                                   attr("name", b.submitButton.name).
                                   val(a(b.submitButton).val()).
                                   appendTo(b.currentForm)), p = b.settings.submitHandler.call(b, b.currentForm, c), b.submitButton &&
                              g.remove(), void 0 !== p ? p : !1) : !0;
                         }
                         ...
                         if (b.form()) {
                              return b.pendingRequest ?
                                   (b.formSubmitted = !0, !1) : g();
                         }
                         b.focusInvalid();
                         return !1;
                    }));
               ...
               var c, b, e;
               a(this[0]).is("form") ? c = this.validate().form() : (e = [], c = !0, b = a(this[0].form).
                    validate(), this.each(function() {
                    (c = b.element(this) && c) || (e = e.concat(b.errorList));
               }), b.errorList = e);
               return c;
          }, rules: function(c, b) {
               var e = this[0], g, l, p, q;
               if (null != e && null != e.form) {
                    if (c) {
                         switch (g = a.data(e.form, "validator").settings, l = g.rules,
                              p = a.validator.staticRules(e), c)
                         {
                              case "add":
                                   a.extend(p, a.validator.normalizeRule(b));
                                   delete p.messages;
                                   l[e.name] = p;
                                   b.messages && (g.messages[e.name] = a.extend(g.messages[e.name], b.messages));
                                   break;
                              case "remove":
                                   if (!b) {
                    ...
                    g = a.validator.normalizeRules(a.extend({}, a.validator.classRules(e), a.validator.attributeRules(e), a.validator.dataRules(e), a.validator.staticRules(e)),
                         e);
                    g.required && (l = g.required, delete g.required, g = a.extend({required: l}, g), a(e).
                         attr("aria-required", "true"));
                    g.remote && (l = g.remote, delete g.remote, g = a.extend(g, {remote: l}));
                    return g;
               }
          },
     });
     ...
     a.extend(a.validator, {
          defaults: {
               ...
               onfocusin: function(a) {
                    this.lastActive = a;
                    this.settings.focusCleanup && (this.settings.unhighlight &&
                    this.settings.unhighlight.call(this, a, this.settings.errorClass, this.settings.validClass), this.hideThese(this.errorsFor(a)));
               },
               ...
               onkeyup: function(c, b) {
                    ...
                    9 === b.which && "" === this.elementValue(c) || -1 !== a.inArray(b.keyCode, e) ||
                    (c.name in this.submitted || c.name in this.invalid) && this.element(c);
               },
               onclick: function(a) {
               ...
               highlight: function(c, b, e) {
                    "radio" === c.type ? this.findByName(c.name).addClass(b).removeClass(e) : a(c).
                         addClass(b).
                         removeClass(e);
               },
               unhighlight: function(c, b, e) {
                    "radio" === c.type ? this.findByName(c.name).removeClass(b).addClass(e) :
               ...
               init: function() {
                    function c(b) {
                         ...
                         var e = "on" + b.type.replace(/^validate/, ""), q = c.settings;
                    ...
                    a(this.currentForm).
                         on("focusin.validate focusout.validate keyup.validate", ":text, [type='password'], [type='file'], select, textarea, [type='number'], [type='search'], [type='tel'], [type='url'], [type='email'], [type='datetime'], [type='date'], [type='month'], [type='week'], [type='time'], [type='datetime-local'], [type='range'], [type='color'], [type='radio'], [type='checkbox'], [contenteditable], [type='button']",
                              c).
                         on("click.validate", "select, option, [type='radio'], [type='checkbox']", c);
               ...
               checkForm: function() {
                    ...
                    var b = this.clean(c), e = this.validationTargetFor(b), g = this, l = !0, p, q;
                    void 0 === e
                         ? delete this.invalid[b.name]
                         : (this.prepareElement(e), this.currentElements = a(e), (q = this.groups[e.name]) &&
                         a.each(this.groups, function(a, c) {
                              c === q && a !== e.name && (b = g.validationTargetFor(g.clean(g.findByName(a)))) && b.name in
                              g.invalid && (g.currentElements.push(b), l = g.check(b) &&
                                   l);
                         }), p = !1 !== this.check(e), l = l && p, this.invalid[e.name] = p
                         ? !1
                         : !0, this.numberOfInvalids() ||
                         (this.toHide = this.toHide.add(this.containers)), this.showErrors(), a(c).attr("aria-invalid", !p));
                    return l
                    ...
                    if (this.settings.unhighlight) {
                         for (b = 0; a[b]; b++) {
                              this.settings.unhighlight.call(this, a[b], this.settings.errorClass, ""), this.findByName(a[b].name).
                                   removeClass(this.settings.validClass);
                         }
                    } else {
                         a.removeClass(this.settings.errorClass).
                              removeClass(this.settings.validClass)
                    }
               },
               ...
               findLastActive: function() {
                    ...
                    return a(this.currentForm).
                         ...
                         filter(function() {
                              ...
                              !e && c.settings.debug && window.console &&
                              console.error("%o has no name assigned", this);
                              this.hasAttribute("contenteditable") && (this.form =
                                   a(this).closest("form")[0]);
                              return e in b || !c.objectLength(a(this).rules()) ? !1 : b[e] = !0
                         })
               }, clean: function(c) {
                    return a(c)[0]
               }, errors: function() {
               ...
               prepareElement: function(a) {
                    ...
                    var b = a(c).rules(), e = a.map(b, function(a, b) {
                         return b
                    }).length, g = !1, l = this.elementValue(c), p, q, k;
                    ...
                    for (q in b) {
                         ...
                         try {
                              if (p = a.validator.methods[q].call(this, l, c, k.parameters), "dependency-mismatch" ===
                              p && 1 === e)
                              {
                                   g = !0;
                              } else {
                              ...
                              console.log("Exception occurred when checking element " + c.id + ", check the '" +
                                   k.method + "' method.", r), r instanceof TypeError &&
                              (r.message += ".  Exception occurred when checking element " + c.id + ", check the '" +
                                   k.method + "' method."), r;
                         }
                    }
                    if (!g) {
               ...
               }, customDataMessage: function(c,
                    b) {
                    return a(c).data("msg" + b.charAt(0).toUpperCase() + b.substring(1).toLowerCase()) ||
                         a(c).data("msg")
                    ...
                    var e = this.findDefined(this.customMessage(c.name, b.method), this.customDataMessage(c, b.method), !this.settings.ignoreTitle &&
                         c.title ||
                         void 0, a.validator.messages[b.method], "<strong>Warning: No message defined for " + c.name +
                         "</strong>"), g = /\$?\{(\d+)\}/g;
                    "function" === typeof e ? e = e.call(this, b.parameters, c) : g.test(e) &&
                    ...
                    for (a = 0; this.errorList[a]; a++) {
                         b = this.errorList[a], this.settings.highlight &&
                    ...
                    var e, g, l, p = this.errorsFor(c), q = this.idOrName(c), k = a(c).attr("aria-describedby");
                    p.length ? (p.removeClass(this.settings.validClass).addClass(this.settings.errorClass),
                         p.html(b)) : (e = p = a("<" + this.settings.errorElement + ">").
                         attr("id", q + "-error").
                         addClass(this.settings.errorClass).
                         html(b || ""), this.settings.wrapper &&
                    (e = p.hide().show().wrap("<" + this.settings.wrapper + "/>").parent()), this.labelContainer.length
                         ? this.labelContainer.append(e)
                         : this.settings.errorPlacement
                              ? this.settings.errorPlacement.call(this, e, a(c))
                              : e.insertAfter(c), p.is("label")) ? p.attr("for", q) : 0 ===
                         p.parents("label[for='" + this.escapeCssMeta(q) + "']").length &&
                         (e = p.attr("id"), k ? k.match(new RegExp("\\b" + this.escapeCssMeta(e) +
                              "\\b")) || (k += " " + e) : k = e, a(c).
                              attr("aria-describedby", k), g = this.groups[c.name]) &&
                         (l = this, a.each(l.groups, function(b, c) {
                              c === g && a("[name='" + l.escapeCssMeta(b) + "']", l.currentForm).
                                   attr("aria-describedby", p.attr("id"))
                         }));
                    !b && this.settings.success && (p.text(""), "string" === typeof this.settings.success
                    ...
                    return a(this.currentForm).find("[name='" +
                         this.escapeCssMeta(c) + "']")
                    ...
                    this.pending[c.name] ||
                    (this.pendingRequest++, a(c).addClass(this.settings.pendingClass), this.pending[c.name] = !0)
               }, stopRequest: function(c, b) {
                    this.pendingRequest--;
                    0 > this.pendingRequest && (this.pendingRequest = 0);
                    delete this.pending[c.name];
                    a(c).removeClass(this.settings.pendingClass);
                    b && 0 === this.pendingRequest && this.formSubmitted && this.form() ? (a(this.currentForm).
                         submit(), this.formSubmitted = !1) : !b && 0 ===
                         this.pendingRequest && this.formSubmitted &&
          ...
          classRuleSettings: {
               ...
               return b
          }, normalizeAttributeRule: function(a,
               b, e, g) {
               /min|max|step/.test(e) && (null === b || /number|range|text/.test(b)) &&
               (g = Number(g), isNaN(g) && (g = void 0));
               g || 0 === g ? a[e] = g : b === e && "range" !== b && (a[e] = !0)
          }, attributeRules: function(c) {
               var b = {}, e = a(c), g = c.getAttribute("type"), l, p;
               for (l in a.validator.methods) {
                    "required" === l
                         ? (p = c.getAttribute(l), "" === p && (p = !0), p = !!p)
                         : p = e.attr(l), this.normalizeAttributeRule(b, g, l, p);
               }
               ...
               for (g in a.validator.methods) {
                    l = e.data("rule" + g.charAt(0).toUpperCase() +
                         g.substring(1).toLowerCase()), this.normalizeAttributeRule(b, c, g, l);
               }
               return b
          }, staticRules: function(c) {
               var b = {}, e = a.data(c.form, "validator");
               e.settings.rules && (b = a.validator.normalizeRule(e.settings.rules[c.name]) || {});
               return b
               ...
               a.each(c, function(e, g) {
                    if (!1 === g) {
                         ...
                         l ? c[e] = void 0 !== g.param ? g.param : !0 : (a.data(b.form, "validator").
                              resetElements(a(b)), delete c[e])
                    }
               });
               a.each(c, function(e, g) {
               ...
               a.each(["rangelength", "range"], function() {
                    var b;
                    c[this] && (a.isArray(c[this]) ? c[this] = [Number(c[this][0]), Number(c[this][1])] : "string" ===
                         typeof c[this] &&
                         (b = c[this].replace(/[\[\]]/g, "").split(/[\s,]+/), c[this] = [Number(b[0]), Number(b[1])]))
               });
               a.validator.autoCreateRanges &&
               (null != c.min && null != c.max && (c.range = [c.min, c.max], delete c.min, delete c.max), null !=
               c.minlength && null != c.maxlength &&
               (c.rangelength = [c.minlength, c.maxlength], delete c.minlength, delete c.maxlength));
               return c
               ...
               3 > b.length && a.validator.addClassRules(c,
                    a.validator.normalizeRule(c))
          }, methods: {
               required: function(c, b, e) {
                    return this.depend(e, b) ? "select" === b.nodeName.toLowerCase()
                         ? (c = a(b).val()) && 0 < c.length
                         : this.checkable(b) ? 0 < this.getLength(c, b) : 0 < c.length : "dependency-mismatch"
               }, email: function(a, b) {
               ...
               date: function(a, b) {
                    ...
                    c =
                         a.isArray(c) ? c.length : this.getLength(c, b);
                    return this.optional(b) || c <= e
                    ...
                    var g = a(b).attr("type"), l = "Step attribute on input type " + g + " is not supported.",
                         p = ["text", "number", "range"], q = new RegExp("\\b" +
                         g + "\\b"), k = function(a) {
                    ...
                    g = k(e);
                    if (k(c) > g || 0 !== Math.round(c * Math.pow(10, g)) % Math.round(e * Math.pow(10, g))) {
                         r = !1;
                    }
                    ...
                    {
                         e.addClass("validate-equalTo-blur").
                    ...
                    var l = this.previousValue(b, g), p, q;
                    this.settings.messages[b.name] || (this.settings.messages[b.name] = {});
                    l.originalMessage = l.originalMessage || this.settings.messages[b.name][g];
                    ...
                    q[b.name] = c;
                    a.ajax(a.extend(!0, {
                         mode: "abort", port: "validate" + b.name, dataType: "json", data: q, context: p.currentForm,
                         success: function(a) {
                              var e = !0 === a || "true" === a, q;
                              p.settings.messages[b.name][g] = l.originalMessage;
                              e
                                   ? (q = p.formSubmitted, p.resetInternals(), p.toHide = p.errorsFor(b), p.formSubmitted = q, p.successList.push(b), p.invalid[b.name] = !1, p.showErrors())
                                   : (q = {}, a = a || p.defaultMessage(b, {
                                        method: g,
                                        parameters: c
                                   }), q[b.name] = l.message = a, p.invalid[b.name] = !0, p.showErrors(q));
                              l.valid = e;
                              p.stopRequest(b, e)
                         }
                    }, e));
     ...
     var q = {}, r;
     a.ajaxPrefilter ? a.ajaxPrefilter(function(a, b, e) {
          b = a.port;
          "abort" === a.mode && (q[b] && q[b].abort(),
               q[b] = e)
     }) : (r = a.ajax, a.ajax = function(c) {
          var b = ("port" in c ? c : a.ajaxSettings).port;
          return "abort" === ("mode" in c ? c : a.ajaxSettings).mode ? (q[b] &&
          q[b].abort(), q[b] = r.apply(this, arguments), q[b]) : r.apply(this, arguments)
     });
     return a
});
(function(a) {
     "function" === typeof define && define.amd ? define(["jquery", "../jquery.validate"], a) : "object" ===
     typeof module && module.exports ? module.exports = a(require("jquery")) : a(jQuery)
})(function(a) {
     a.extend(a.validator.messages, {
          ...
          rangelength: a.validator.format("\ubb38\uc790 \uae38\uc774\uac00 {0} \uc5d0\uc11c {1} \uc0ac\uc774\uc758 \uac12\uc744 \uc785\ub825\ud558\uc138\uc694."),
...
var urlize = function() {
     ...
     function b(a) {
          a = 2 == a.length && "object" == typeof a[1] ? a[1] : {
               nofollow: a[1],
               autoescape: a[2],
               trim_url_limit: a[3],
               target: a[4]
     ...
     function e(e, l) {
          l = b(arguments);
          for (var H = l.django_compatible ? L : E, D = l.django_compatible ? p : t, V = l.django_compatible
               ? k
               : s, R = new RegExp("^www\\.|^(?!http)\\w[^@]+\\.(" + (l.top_level_domains || z).join("|") +
               ")$", "i"), H = g(e, H), T = 0; T < H.length; T++)
          {
               var M = H[T];
               if (-1 != M.indexOf(".") || -1 != M.indexOf("@") || -1 != M.indexOf(":")) {
                    for (var N =
                         "", A = M, Y = "", v = 0; v < D.length; v++)
                    {
                         var aa = D[v];
                         a(A, aa) && (A = A.substr(0, A.length - aa.length), Y = aa + Y)
                    }
                    for (v = 0; v < V.length; v++) {
                         var aa = V[v][0], da = V[v][1], K = aa;
                         A.substr(0, K.length) == K && (A = A.substr(aa.length), N += aa);
                         a(A, da) && q(A, da) == q(A, aa) + 1 && (A = A.substr(0, A.length - da.length), Y = da + Y)
                    }
                    v = void 0;
                    aa = l.nofollow ? ' rel="nofollow"' : "";
                    da = l.target ? ' target="' + l.target + '"' : "";
                    A.match(C) ? v = r(A) : A.match(R) ? v = r("http://" + A) : -1 == A.indexOf(":") && A.match(h) &&
                         (v = "mailto:" + A, aa = "");
                    if (v) {
                         M = A;
                         A = void 0;
                         ...
                         l.autoescape && (N = c(N, l), Y = c(Y, l), v = v.replace(/&/g, "&amp;").
                              replace(/</g, "&lt;").
                              replace(/>/g, "&gt;").
                              replace(/"/g, "&quot;"), M = c(M, l));
                         A = '<a href="' + v + '"' + aa + da + ">" + M + "</a>";
                         0 > v.indexOf("//" + location.hostname + "/") && (A += ' <a href="' + v +
     ...
     var g;
     g = g || function(a) {
          var b = String.prototype.split, c = /()??/.exec("")[1] === a;
          return function(e, g, h) {
               if ("[object RegExp]" !== Object.prototype.toString.call(g)) {
                    return b.call(e, g, h);
               }
               var k = [], l = (g.ignoreCase ? "i" : "") + (g.multiline ? "m" : "") + (g.extended ? "x" : "") +
                    (g.sticky ? "y" : ""), p = 0;
               ...
               for (h = h === a ? 4294967295 : h >>> 0; r = g.exec(e);) {
                    l = r.index +
                         r[0].length;
                    if (l > p && (k.push(e.slice(p, r.index)), !c && 1 < r.length && r[0].replace(q, function() {
                         for (var b = 1; b < arguments.length - 2; b++) {
                              arguments[b] === a && (r[b] = a)
                         }
                    }), 1 < r.length && r.index < e.length &&
                    Array.prototype.push.apply(k, r.slice(1)), s = r[0].length, p = l, k.length >= h))
                    {
                         break;
                    }
                    g.lastIndex === r.index && g.lastIndex++
               }
               p === e.length ? !s && g.test("") || k.push("") : k.push(e.slice(p));
               return k.length > h ? k.slice(0, h) : k
          }
     }();
     var l = /%(?![0-9A-Fa-f]{2})/, p = [".", ",", ":", ";"], t = [".", ",", ":", ";", ".)"],
          k = [["(", ")"], ["<", ">"], ["&lt;",
               "&gt;"]], s = [["(", ")"], ["<", ">"], ["&lt;", "&gt;"], ["\u201c", "\u201d"], ["\u2018", "\u2019"]],
          L = /(\s+)/, E = /([\s<>"]+)/, C = /^https?:\/\/\w/i, z = "com edu gov int mil net org".split(" "),
          h = /^\S+@\S+\.\S+$/;
     e.test = {};
     e.test.split = g;
     ...
     $(a).contents().each(function() {
               ...
               this.TEXT_NODE)
          {
               ...
               var r =
                    $(this).contents();
               1 == r.length && r[0].nodeType == this.TEXT_NODE && !/^[#@]+/.test(r[0].textContent) && 0 >
               a.attr("href").indexOf("//" + location.hostname + "/") &&
               (r = $("<div/>").append($(this).clone()).html(), $(this).
                    replaceWith(r + ' <a href="' + a.attr("href") +
                         '" target="_blank" title="\uc0c8\ucc3d\uc73c\ub85c \uc5f4\uae30"><i class="fa fa-external-link"></i></a>'))
          }
     })
...
var isMobile = function() {
     var a = !1, q = navigator.userAgent || navigator.vendor || window.opera;
     if (/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows ce|xda|xiino|android|ipad|playbook|silk/i.test(q) ||
...
"undefined" !== typeof jQuery && function(a) {
     ...
     a.fn.spin.presets = {
          ...
          small: {lines: 11, length: 0, width: 3, radius: 10, shadow: !0, hwaccel: !0, color: "#56595c"},
     ...
     a(".sidebar-header").click(function() {
          a(".sidebar").is(".open") ? (a(".sidebar").removeClass("open"), a(".sidebar-category-nav").
                    removeClass("open")) :
               (a(".sidebar").addClass("open"), a(".sidebar-category-nav").addClass("open"))
     });
     a("html, body").click(function(q) {
          a(q.target).is(".sidebar-header  *, .nav-main *, .sidebar-category-nav *, #search-google-form *") ||
          (a(".sidebar").removeClass("open"), a(".sidebar-category-nav").removeClass("open"));
          a(q.target).is("#search-google, #search-google *, #search-google-popover *") ||
          a("#search-google").popover("hide");
          a(q.target).is("#user-func, #user-func  *, #user-func-popover *") || a("#user-func").popover("hide");
          a(q.target).is("#user-notification, #user-notification *, #notification-popover *") ||
     ...
     a.onImageUpload = function(q) {
          return function(r) {
               ...
               a('<iframe src="about:blank"  style="display: none;" name="imageUploadHandlerFrame"></iframe>').
                    appendTo("body");
     ...
     a.extend(a.summernote.options, {
          ...
          disableLinkTarget: !0,
          shortcuts: !0,
          toolbar: isMobile() ? [["style", ["style"]],
               ["font", ["bold", "italic", "underline", "strikethrough", "clear"]],
               ["color", ["color"]],
               ["para", ["ul", "ol", "paragraph", "table"]],
               ["insert", ["codeblock", "link", "picture", "video", "hr"]],
               ["view", ["fullscreen", "codeview", "help"]]] : [["style", ["style"]],
               ["font", ["bold", "italic", "underline", "strikethrough", "clear"]],
               ["color", ["color"]],
               ["para", ["ul", "ol", "table"]],
               ["insert", ["codeblock", "link", "picture", "video", "hr"]],
